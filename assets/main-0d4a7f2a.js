import{s as p,t as r,a as Se,j as e,I as ze,u as M,r as a,F as Le,S as ee,P as Te,b as ce,B as y,c as O,n as de,q as Ue,d as ue,e as I,A as Ae,V as qe,H as pe,T as he,f as Ee,C as se,g as W,h as Pe,i as Ve,k as re,D as te,l as be,m as Xe,o as Re,p as Ze,v as He,w as Ie,x as Je,y as ne,z as Be,M as G,E as We,G as Fe,J as Me,O as ve,K as me,L as ie,N as Oe,Q as Ge,R as Ke,U as Ne,W as Ye,X as je,Y as $e,Z as _e,_ as e1,$ as P,a0 as t1,a1 as o1,a2 as s1,a3 as r1,a4 as n1,a5 as i1}from"./vendor-6d9a87e1.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const c of n)if(c.type==="childList")for(const d of c.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function s(n){const c={};return n.integrity&&(c.integrity=n.integrity),n.referrerPolicy&&(c.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?c.credentials="include":n.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(n){if(n.ep)return;n.ep=!0;const c=s(n);fetch(n.href,c)}})();window.global||(window.global=window);const a1=p.main`
  width: 70%;
  display: flex;
...
`,fe=[{label:"Mais recentes",value:"-created_at",color:"#000"},{label:"Mais populares",value:"-rating",color:"#000"},{label:"Mais comentários",value:"-comments_count",color:"#000"}],D=Se.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),ae=async()=>await D.get("categories/"),f1=async t=>await D.post("categories/",t),C1=async t=>await D.delete(`categories/${t}/`),x1=async t=>await D.patch(`categories/${t.id}/`,{...t}),g1=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function R({label:t="",inputType:o="text",placeholder:s,accessibilityLabel:i,size:n="md",fontSize:c="0.9rem",name:d,isRequired:h=!0,isEditing:l=!0,value:A=void 0,backgroundColor:u=null,height:m=null,onChange:f,...x}){return e.jsxs(g1,{children:[t&&e.jsxs(b1,{fontSize:c,children:[t,h&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(ze,{height:m||null,type:o,variant:l?"outline":"filled",size:n,backgroundColor:u||null,isRequired:h,value:A,placeholder:s,editable:l,accessibilityLabel:i,onChangeText:b=>f(d,b),...x})]})}function v1({onChangeCategoriesFilter:t,onChangeOrderBy:o,onChangeSearchInput:s,handleSearch:i}){const n=M("(max-width: 768px)"),[c,d]=a.useState([]),h={control:l=>({...l,backgroundColor:r.colors.white}),option:(l,{data:A,isMulti:u,isDisabled:m,isFocused:f,isSelected:x})=>{const b=O(A.color);return{...l,backgroundColor:m?void 0:x?u?A.color:b.alpha(.2).css():f?b.alpha(.1).css():void 0,color:m?"#ccc":x&&u?O.contrast(b,"white")>2?"white":"black":A.color,cursor:m?"not-allowed":"default",":active":{...l[":active"],backgroundColor:m?void 0:x?A.color:b.alpha(.3).css()}}},multiValue:(l,{data:A})=>{const u=O(A.color);return{...l,backgroundColor:u.alpha(.1).css()}},multiValueLabel:(l,{data:A})=>({...l,color:A.color}),multiValueRemove:(l,{data:A})=>({...l,color:A.color,":hover":{backgroundColor:A.color,color:"white"}}),input:l=>({...l,"input:focus":{boxShadow:"none"}})};return a.useEffect(()=>{ae().then(l=>{d(l.data)})},[]),e.jsxs(A1,{children:[e.jsxs(p1,{children:[e.jsx(Le,{size:20,color:r.colors.tertiary[300]}),e.jsx(ee,{isMulti:!0,closeMenuOnSelect:!1,options:c.map(l=>({value:l.id.toString(),label:l.name,color:l.color})),styles:h,onChange:t,placeholder:"Filtrar por categorias"})]}),e.jsxs(m1,{children:[e.jsx(Te,{size:22,color:r.colors.tertiary[300]}),e.jsx(ee,{isMulti:!1,defaultValue:fe[0],options:fe,placeholder:"Ordenar Tópicos",styles:h,onChange:o})]}),e.jsxs(h1,{children:[e.jsx(ce,{color:r.colors.tertiary[300],size:"22"}),e.jsx(R,{name:"topic-search",height:"2.4rem",size:n?"md":"lg",backgroundColor:r.colors.white,accessibilityLabel:"Buscar tópicos",placeholder:"Buscar tópicos...",inputType:"text",onChange:s,InputRightElement:e.jsx(y,{rounded:"none",w:"1/12",h:"full",onPress:i,children:e.jsx(ce,{color:r.colors.white,size:"22"})})})]})]})}const N1=(t,o)=>t?"0.9rem":o?"1rem":"0.9rem",j1=(t,o)=>t?"0.7rem":o?"0.8rem":"0.7rem",y1=p.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,D1=p.div`
  ...
  & > p {
    ...
    font-size: ${({isComment:t,isInsideTopic:o})=>N1(t,o)};
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:o})=>j1(t,o)};
      line-height: 1.7;
    }
...
`;const L1=async t=>await D.get(`topics/?${Ue.stringify(t,{arrayFormat:"comma"})}`),T1=async t=>await D.get(`topics/${t}`),U1=async t=>await D.post("topics",t),q1=async t=>await D.post(`topics/${t}/upvote`),E1=async t=>await D.post(`topics/${t}/downvote`),ye=a.createContext(null),P1=({children:t})=>{const[o,s]=a.useState(""),[i,n]=a.useState([]),[c,d]=a.useState(""),[h,l]=a.useState("");a.useEffect(()=>{const m=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",m),m){const f=ue(m.split(" ")[1]);D.defaults.headers.common.Authorization=`${m}`,s(m.split(" ")[1]),n(f.scopes),d(f.sub),l(f.name)}},[]);const A=a.useCallback(m=>{localStorage.setItem("@UnBForum:token",`Bearer ${m}`);const f=ue(m);D.defaults.headers.common.Authorization=`Bearer ${m}`,s(m),n(f.scopes),d(f.sub),l(f.name)},[]),u=a.useCallback(()=>{s(""),n([]),d(""),l(""),D.defaults.headers.common.Authorization=null,localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(ye.Provider,{value:{token:o,name:h,email:c,scopes:i,changeToken:A,logoutUser:u,setName:l},children:t})};function F(){const t=a.useContext(ye);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}const Q=({id:t,status:o,variant:s="left-accent",title:i,description:n,isClosable:c=!1,...d})=>{const h=I();return e.jsx(Ae,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:o||"error",variant:s,...d,children:e.jsxs(qe,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(pe,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(pe,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(Ae.Icon,{}),e.jsx(he,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:s==="solid"?"lightText":s!=="outline"?"darkText":null,children:i})]}),c?e.jsx(Ee,{variant:"unstyled",icon:e.jsx(se,{size:"3"}),_icon:{color:s==="solid"?"lightText":"darkText"},onPress:()=>h.close(t)}):null]}),e.jsx(he,{px:"6",color:s==="solid"?"lightText":s!=="outline"?"darkText":null,children:n})]})})},V1=async(t,o)=>await D.post(`topics/${o}/comments/`,{content:t}),X1=async t=>await D.get(`topics/${t}/comments/`),R1=async(t,o)=>await D.post(`topics/${o}/comments/${t}/upvote`),Z1=async(t,o)=>await D.post(`topics/${o}/comments/${t}/downvote`),H1=t=>`https://unbforum-backend-4b05406a8bbf.herokuapp.com/files/download/${t.upload_path}`;function we(t){const o=t.split(" ");if(o.length>=2){const s=o[0],i=o[o.length-1],n=s[0],c=i[0];return n.toUpperCase()+c.toUpperCase()}else return o[0][0].toUpperCase()}function oe({id:t,isInsideTopic:o=!1,isComment:s=!1,title:i="",author:n,content:c,topicId:d=null,currentRating:h=0,rating:l=0,files:A=[],categories:u=[],commentsCount:m=0}){const{token:f}=F(),x=I(),b=W(),g=M("(max-width: 768px)"),[N,S]=a.useState(l),[T,J]=a.useState(!1),[k,L]=a.useState(h);a.useEffect(()=>{L(h),S(l)},[h,l]);function v(){b(`/topic/${t}`)}const C=()=>{x.show({placement:"top-right",render:()=>e.jsx(Q,{id:"user-unlogged-error",title:"Opa!",description:"Para interagir com um tópico ou comentário, você precisa fazer login!",status:""})})};async function w(j,V){if(j.preventDefault(),!f){C();return}if(V>0){const Z=await(s?R1(t,d):q1(t));S(Z.data.rating),L(k>0?0:1)}else{const Z=await(s?Z1(t,d):E1(t));S(Z.data.rating),L(k<0?0:-1)}}function U(j){j.preventDefault(),J(!T)}function z(){switch(T){case!0:return e.jsx(Ze,{size:"30",color:r.colors.darkBlue[400]});case!1:return e.jsx(Re,{size:"30",color:r.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(y1,{children:[e.jsxs(w1,{isInsideTopic:o,isComment:s,children:[e.jsx("button",{id:"reactionButton",onClick:j=>w(j,1),children:e.jsx(Pe,{color:k>0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),e.jsx("p",{children:N}),e.jsx("button",{id:"reactionButton",onClick:j=>w(j,-1),children:e.jsx(Ve,{color:k<0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),!s&&e.jsx("button",{id:"markButton",onClick:j=>U(j),children:z()})]}),e.jsx(Q1,{children:e.jsxs(D1,{isInsideTopic:o,isComment:s,children:[o&&e.jsx("h1",{id:"post-title",children:i}),e.jsxs(k1,{isInsideTopic:o,children:[e.jsx(re,{bg:s?"lime.600":"emerald.600",marginRight:"0.8rem",size:s?"xs":"sm",children:we(n)}),e.jsxs("p",{children:[n,!o&&!s&&` - ${i}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:c.replace(/\n/g,"<br>")}}),A.length>0&&e.jsx(te,{width:"80%"}),A.map((j,V)=>e.jsxs("span",{children:["Para acessar o arquivo ",`${V+1}: `,e.jsx("a",{href:H1(j),target:"_blank",rel:"noreferrer",children:"clique aqui"})]},j.id)),!s&&e.jsx(S1,{children:u.map(j=>e.jsx(be,{variant:"solid",bg:j.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:j.name})},j.id))}),!o&&!s&&e.jsx(z1,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:g?"0.8rem":"1rem"},isInsideTopic:o,onPress:o?()=>{}:()=>v(),rightIcon:e.jsx(Xe,{size:g?"18":"20",color:r.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${m})`})]})})]}),e.jsx(te,{alignSelf:"flex-end",width:s?"95%":"100%",marginTop:o?"0rem":"0.5rem",height:s||!o?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const I1=p.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function F1(){return e.jsxs(I1,{children:[e.jsxs(J1,{children:[e.jsx(re,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(B1,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(W1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,o)=>e.jsx(be,{variant:"solid",bg:r.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},o))})]})]})}const M1=p.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;function Y1(){const t=W(),{token:o}=F();return e.jsxs(G,{w:"190",placement:"bottom right",trigger:s=>e.jsx(y,{variant:"solid",_hover:{shadow:"8"},rightIcon:e.jsx(We,{size:30,color:r.colors.white}),onPress:()=>{},...s}),children:[e.jsx(G.Item,{onPress:()=>t("/"),children:"Feed"}),o&&e.jsx(G.Item,{onPress:()=>t("/profile"),children:"Perfil"}),!o&&e.jsx(G.Item,{onPress:()=>t("/login/logon"),children:"Entrar"}),e.jsx(G.Item,{onPress:()=>t("/categories"),children:"Categorias"})]})}function $1(){const{name:t,token:o}=F(),s=W(),i=M("(max-width: 768px)");function n(d){d.preventDefault(),s("/profile")}function c(d){d.preventDefault(),s("/login/logon")}return e.jsx(K1,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(G1,{}),e.jsxs("div",{className:"user-container",children:[o&&!i&&e.jsx(e.Fragment,{children:e.jsx(y,{onPress:d=>n(d),rightIcon:e.jsx(Fe,{size:"30",color:r.colors.tertiary[300]}),children:i?"":t})}),!o&&!i&&e.jsx(e.Fragment,{children:e.jsx(y,{variant:"solid",bgColor:r.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(Me,{size:30,color:r.colors.white}),onPress:d=>c(d),children:i?"":"Entrar"})}),e.jsx(Y1,{})]})]})})}const _1=p.div`
...
`;function Y(){return e.jsxs(_1,{children:[e.jsx($1,{}),e.jsx("div",{className:"content",children:e.jsx(ve,{})})]})}const et=p.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,st=t=>{let o=!0;const s=[],{email:i,password:n}=t;return(!i||i==="")&&(o=!1,s.push("Email Institucional")),(!n||n==="")&&(o=!1,s.push("Senha")),{isValid:o,fieldErrors:s}},rt=async t=>{const{username:o,password:s}=t,i=new FormData;return i.append("username",o),i.append("password",s),await D.post("auth/login",i)},nt=t=>{const{email:o,password:s}=t;return{username:o,password:s}};function it(){const t=W(),o=I(),{changeToken:s}=F(),[i,n]=a.useState({email:"",password:""}),[c,d]=a.useState(!1),h=a.useCallback((A,u)=>{n({...i,[A]:u})},[i]);function l(A){A.preventDefault();const{isValid:u,fieldErrors:m}=st(i);if(!u){o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${m.reduce((f,x,b)=>b===0?`'${x}'`:b===m.length-1?`${f} e '${x}'`:`${f}, '${x}'`,"")}`,status:""})});return}d(!0),rt(nt(i)).then(f=>{o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário logado com sucesso!
Agora você pode criar tópicos e interagir com eles!`,status:"success"})}),s(f.data.access_token),t("/")}).catch(f=>{o.show({placement:"top-right",render:()=>{let x="";return typeof f.response.data.detail=="object"?x=f.response.data.detail[0].msg.split(", ")[1]:x=f.response.data.detail,e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${x}`,status:""})}})}).finally(()=>{d(!1)})}return e.jsxs(ot,{children:[e.jsx(K,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(R,{name:"email",onChange:h,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(R,{name:"password",onChange:h,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(y,{onPress:A=>l(A),variant:"solid",size:"lg",isLoading:c,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(y,{onPress:A=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const at=p.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,lt="/assets/create-account-24b27e13.png";function ct(){return e.jsxs(at,{children:[e.jsx("img",{className:"create-account-image",src:lt,alt:""}),e.jsx("div",{className:"content",children:e.jsx(ve,{})})]})}const dt=p.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,ut=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],At=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],pt=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:ut},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:At},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],ht=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function mt({label:t,placeholder:o,options:s=[],onChange:i,isRequired:n=!0,fontSize:c="0.9rem",isEditing:d=!0,name:h}){return e.jsxs(ht,{fontSize:c,children:[e.jsxs("label",{className:"create-account-label",children:[t,n&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(me,{variant:"outline",height:9,size:"md",isDisabled:!d,onValueChange:l=>i(h,l),placeholder:o,accessibilityLabel:"Selecione a opção",children:s.map(l=>e.jsx(me.Item,{label:l.label,value:l.value},l.label))})]})}const ft=async t=>await D.post("users",t),Ce=async()=>await D.get("users/me"),Ct=async t=>await D.patch("users/me",t),xt=async t=>await D.post("users/me/change_password",t),gt=async()=>await D.delete("users/me"),bt=t=>{let o=!0;const s=[],{name:i,email:n,profile:c,course:d,password:h,passwordConfirm:l}=t;return(!i||i==="")&&(o=!1,s.push("Nome Completo")),(!n||n==="")&&(o=!1,s.push("Email Institucional")),(!c||c==="")&&(o=!1,s.push("Papel na Instituição")),(!d||d==="")&&(o=!1,s.push("Curso")),(!h||h==="")&&(o=!1,s.push("Senha")),(!l||l===""||l!==h)&&(o=!1,s.push("Confirme a senha")),{isValid:o,fieldErrors:s}},vt=t=>{const{name:o,email:s,profile:i,course:n,password:c}=t;return{name:o,email:s,password:c,tags:[i,n]}};function Nt(){const t=W(),o=I(),s=ie({lg:"lg",base:"md"}),[i,n]=a.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[c,d]=a.useState(!1),h=a.useCallback((u,m)=>{n({...i,[u]:m})},[i]),l=async u=>{u.preventDefault();const{isValid:m,fieldErrors:f}=bt(i);if(console.log(i),!m){o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${f.reduce((x,b,g)=>g===0?`'${b}'`:g===f.length-1?`${x} e '${b}'`:`${x}, '${b}'`,"")}`,status:""})});return}d(!0),ft(vt(i)).then(x=>{o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(x=>{o.show({placement:"top-right",render:()=>{let b="";return typeof x.response.data.detail=="object"?b=x.response.data.detail[0].msg.split(", ")[1]:b=x.response.data.detail,e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${b}`,status:""})}})}).finally(()=>{d(!1)})};function A(u){switch(u.input){case"select":return e.jsx(mt,{label:u.label,placeholder:u.placeholder,options:u.options,name:u.name,onChange:h,accessibilityLabel:u.accessibilityLabel},u.label);default:return e.jsx(R,{label:u.label,placeholder:u.placeholder,inputType:u.type,name:u.name,onChange:h,accessibilityLabel:u.accessibilityLabel},u.label)}}return e.jsxs(dt,{children:[e.jsx(K,{}),e.jsxs("div",{className:"inputs-container",children:[pt.map(u=>A(u)),e.jsx(y,{onPress:u=>l(u),variant:"solid",size:s,isLoading:c,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(y,{onPress:u=>t(-1),variant:"outline",size:s,children:"Voltar"})]})]})}const jt=p.section`
  width: 80%;
...
`,yt=t=>{let o=!0;const s=[];return(!t||t==="")&&(o=!1,s.push("Nome Completo")),{isValid:o,fieldErrors:s}},wt=(t,o)=>{let s=!0;const i=[];let n="";return(!t||t==="")&&(s=!1,i.push("Senha Atual")),(!o||o==="")&&(s=!1,i.push("Nova Senha")),!o&&o===t&&(s=!1,n="Nova senha não pode ser a mesma que a atual"),{isValid:s,fieldErrors:i,specialError:n}},Qt=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function xe({question:t,handleAccept:o,handleClose:s,cancelText:i="Cancelar",acceptText:n,isOpen:c,isLoadingAcceptButton:d=!1,loadingAcceptButtonText:h=""}){const l=ie({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:c&&e.jsx(Qt,{children:e.jsxs(Dt,{children:[e.jsx(kt,{onClick:s,children:e.jsx(se,{size:"21",color:r.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(y,{size:l,variant:"outline",onPress:s,children:i}),e.jsx(y,{size:l,onPress:o,bgColor:r.colors.danger[500],isLoading:d,isLoadingText:h,children:n})]})]})})})}function St(){const t=W(),o=I(),{name:s,email:i,setName:n,logoutUser:c}=F(),d=ie({lg:"lg",base:"md"}),[h,l]=a.useState(!1),[A,u]=a.useState(!1),[m,f]=a.useState(!1),[x,b]=a.useState(!1),[g,N]=a.useState({email:i,id:0,name:s,role:"",tags:[]}),[S,T]=a.useState(!1),[J,k]=a.useState(!1),[L,v]=a.useState(!1),[C,w]=a.useState(""),[U,z]=a.useState("");a.useEffect(()=>{Ce().then(q=>{N(q.data),n(q.data.name)})},[n]);const j=a.useCallback((q,X)=>{N({...g,[q]:X})},[g]),V=a.useCallback(()=>{k(!0),gt().then(()=>{}).finally(()=>{o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"delete-user-success",title:"Usuário deletado!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),c(),k(!1),u(!1),t("/")})},[t,c,o]),Z=q=>{q.preventDefault();const{fieldErrors:X,isValid:_}=yt(g.name);if(!_){o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${X.reduce((B,E,H)=>H===0?`'${E}'`:H===X.length-1?`${B} e '${E}'`:`${B}, '${E}'`,"")}`,status:""})});return}T(!0),Ct({name:g.name}).then(B=>{o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),n(g.name)}).catch(B=>{o.show({placement:"top-right",render:()=>{let E="";return typeof B.response.data.detail=="object"?E=B.response.data.detail[0].msg.split(", ")[1]:E=B.response.data.detail,e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${E}`,status:""})}})}).finally(()=>{T(!1),f(!1)})},De=q=>{q.preventDefault();const{fieldErrors:X,isValid:_,specialError:B}=wt(C,U);if(!_){o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:X.length>0?`Os sequintes campos estão incorretos: ${X.reduce((E,H,le)=>le===0?`'${H}'`:le===X.length-1?`${E} e '${H}'`:`${E}, '${H}'`,"")}`:B,status:""})});return}v(!0),xt({current_password:C,new_password:U}).then(E=>{o.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(E=>{o.show({placement:"top-right",render:()=>{let H="";return typeof E.response.data.detail=="object"?H=E.response.data.detail[0].msg.split(", ")[1]:H=E.response.data.detail,e.jsx(Q,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${H}`,status:""})}})}).finally(()=>{v(!1),b(!1),w(""),z("")})},ke=()=>m?e.jsxs(e.Fragment,{children:[e.jsx(y,{variant:"solid",size:d,onPress:()=>{f(!1),Ce().then(q=>{N(q.data)})},children:"Cancelar"}),e.jsx(y,{variant:"outline",size:d,isLoading:S,isLoadingText:"Atualizando Usuário...",onPress:q=>Z(q),children:"Atualizar Usuário"})]}):x?e.jsxs(e.Fragment,{children:[e.jsx(y,{variant:"solid",size:d,onPress:()=>{b(!1),w(""),z("")},children:"Cancelar"}),e.jsx(y,{variant:"outline",size:d,isLoading:L,isLoadingText:"Atualizando Senha...",onPress:q=>De(q),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(y,{variant:"solid",size:d,onPress:()=>f(!0),children:"Editar Perfil"}),e.jsx(y,{variant:"outline",size:d,onPress:()=>b(!0),children:"Alterar Senha"})]});return e.jsxs(jt,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(K,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(R,{name:"name",onChange:j,isEditing:m,value:g.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(R,{name:"email",onChange:()=>{},isEditing:!1,value:g.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(R,{name:"password",onChange:(q,X)=>w(X),isEditing:x,value:x?C:"valordeteste",label:x?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),x&&e.jsx(R,{name:"passwordConfirm",onChange:(q,X)=>z(X),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),ke(),!m&&!x&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(y,{variant:"subtle",size:"md",onPress:()=>l(!0),children:"Sair"}),e.jsx(y,{variant:"subtle",size:"md",onPress:()=>u(!0),children:"Deletar a Conta"})]})]}),e.jsx(xe,{isOpen:h,handleAccept:()=>{l(!1),c(),t("/")},handleClose:()=>l(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(xe,{isOpen:A,handleAccept:()=>{V()},handleClose:()=>u(!1),question:"Tem certeza que deseja deletar sua conta?",acceptText:"Deletar",isLoadingAcceptButton:J,loadingAcceptButtonText:"Deletando..."})]})}const zt=p.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`;function Qe({label:t="",inputType:o="text",placeholder:s,accessibilityLabel:i,size:n="md",fontSize:c="0.9rem",isRequired:d=!0,isEditing:h=!0,name:l,isComment:A=!1,value:u=void 0,onChange:m,...f}){return e.jsxs(qt,{isComment:A,children:[t&&e.jsxs(Et,{fontSize:c,children:[t,d&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(Oe,{type:o,variant:h?"outline":"filled",size:n,placeholder:s,accessibilityLabel:i,editable:h,onChangeText:x=>m(l,x),autoCompleteType:null,value:u,totalLines:5,maxLength:700,...f})]})}const Pt=t=>{let o=!0;const s=[];return(!t||t==="")&&(o=!1,s.push("Comentário")),{isValid:o,fieldErrors:s}},Vt=({topicId:t,onCommentCreated:o})=>{const{name:s}=F(),i=I(),n=M("(max-width: 768px)"),[c,d]=a.useState(""),[h,l]=a.useState(!1);a.useEffect(()=>console.log({comment:c}),[c]);const A=(m,f)=>{d(f)},u=m=>{m.preventDefault();const{isValid:f}=Pt(c);if(!f){i.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-comment-error",title:"Campos Inválidos",description:"O comentário não pode ser feito sem conteúdo!",status:""})});return}l(!0),V1(c.trim(),t).then(x=>{d(""),o()}).catch(x=>{i.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-topic-error",title:"Opa",description:"Erro ao criar comentário",status:""})})}).finally(()=>{l(!1)})};return e.jsxs(Tt,{children:[e.jsxs(Ut,{children:[e.jsx(re,{bg:"lime.600",marginRight:"0.8rem",size:n?"xs":"sm",children:we(s)}),e.jsx(Qe,{name:"content",onChange:A,fontSize:"1.2rem",size:"lg",value:c,isComment:!0,inputType:"text",accessibilityLabel:"Comentário",label:"",placeholder:"Digite o comentário aqui..."})]}),e.jsx(y,{alignSelf:"flex-end",size:n?"sm":"md",rightIcon:e.jsx(Ge,{size:20,color:r.colors.white}),onPress:m=>u(m),isLoading:h,isLoadingText:"Comentando...",children:"Comentar"}),e.jsx(te,{})]})};function Xt(){const{id:t}=Ke(),{token:o}=F(),[s,i]=a.useState(null),[n,c]=a.useState(!1),[d,h]=a.useState(!1);a.useEffect(()=>window.scrollTo(0,0),[]),a.useEffect(()=>{t&&(c(!0),T1(Number(t)).then(A=>{i(A.data)}).finally(()=>c(!1)))},[t]);const l=a.useCallback(()=>{s&&(h(!0),X1(s.id).then(A=>{i({...s,comments:A.data})}).finally(()=>{h(!1)}))},[s]);return e.jsx(zt,{children:s?e.jsxs(e.Fragment,{children:[e.jsx(oe,{id:Number(s.id),author:s.author.name,title:s.title,categories:s.categories,content:s.content,rating:s.rating,files:s.files,currentRating:s.current_user_rating,isInsideTopic:!0}),e.jsxs(Lt,{children:[o&&e.jsx(Vt,{topicId:s.id,onCommentCreated:l}),d?e.jsx($,{accessibilityLabel:"Carregando os comentários do tópico..."}):e.jsx(e.Fragment,{children:s.comments.map(A=>e.jsx(oe,{id:A.id,isComment:!0,topicId:s.id,author:A.author.name,rating:A.rating,currentRating:A.current_user_rating,content:A.content},A.id))})]})]}):e.jsx($,{accessibilityLabel:"Carregando dados do tópico..."})})}const Rt=p.section`
  position: relative;
  width: 80%;
  height: calc(100vh - 6rem);
  display: flex;
...
`,Zt=p.div`
  ...
  #category-card {
    ...
    padding: 1rem;
    background-color: ${r.colors.muted[100]};
    border: 1px solid ${r.colors.black+"70"};
    border-radius: 8px;
    box-shadow: 0 0 5px ${r.colors.black+"50"};
...
`,Jt=p.button`
  ...
  background-color: ${r.colors.purple[600]};
...
`,Wt=p.div`
  ...
  width: 100%;
  height: 100%;
  background-color: ${r.colors.black+"75"};
  display: flex;
  justify-content: center;
  align-items: center;
...
`,Kt=t=>{let o=!0;const s=[],{name:i,color:n}=t;return(!i||i==="")&&(o=!1,s.push("Nome da Categoria")),(!n||n==="")&&(o=!1,s.push("Cor da Categoria")),{isValid:o,fieldErrors:s}};function Yt({isModalOpen:t,setIsModalOpen:o,title:s=null,selectedCategory:i=null,isEditing:n=!1}){const c=I(),d=M("(max-width: 768px)"),[h,l]=a.useState(!1),[A,u]=a.useState(i||{id:0,color:"#10B981",name:""}),[m,f]=a.useState(!1);a.useEffect(()=>console.log(A),[A]),a.useEffect(()=>{l(t),u(i||{id:0,color:"#10B981",name:""})},[t,i]);const x=a.useCallback((N,S)=>{u({...A,[N]:S})},[A]),b=N=>{N.preventDefault();const{isValid:S,fieldErrors:T}=Kt(A);S||c.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${T.reduce((k,L,v)=>v===0?`'${L}'`:v===T.length-1?`${k} e '${L}'`:`${k}, '${L}'`,"")}`,status:""})}),f(!0),(n?x1:f1)(A).then(k=>{c.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-category-success",title:"Categoria Criada com Sucesso",description:"Agora todos podem utilizar a nova categoria!",status:"success"})}),g(),u({id:0,color:"#10B981",name:""})}).catch(k=>{c.show({placement:"top-right",render:()=>{let L="";return typeof k.response.data.detail=="object"?L=k.response.data.detail[0].msg.split(", ")[1]:L=k.response.data.detail,e.jsx(Q,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${L}`,status:""})}})}).finally(()=>{f(!1)})},g=()=>{l(!1),setTimeout(()=>{o(!1)},300)};return e.jsx(e.Fragment,{children:h&&e.jsx(Wt,{isOpen:h,onClick:g,children:e.jsxs(Ft,{isOpen:h,onClick:N=>N.stopPropagation(),children:[e.jsx(Ot,{onClick:g,children:e.jsx(se,{size:"2rem",color:r.colors.primary[50]})}),e.jsx("h1",{children:s||"Nova categoria"}),e.jsx(R,{name:"name",onChange:x,fontSize:"1.2rem",value:A.name||void 0,size:"lg",inputType:"text",accessibilityLabel:"Nome da Categoria",label:"Nome da Categoria",placeholder:"Digite o nome da categoria..."}),e.jsx(R,{name:"color",onChange:x,fontSize:"1.2rem",value:A.color,size:"lg",inputType:"text",accessibilityLabel:"Cor da Categoria (com #)",label:"Cor da Categoria (com #)",placeholder:"Escolha a cor da categoria #000000..."}),e.jsx(Gt,{color:A.color}),e.jsx(Mt,{children:e.jsx(y,{id:"create-topic-button",onPress:N=>b(N),bgColor:r.colors.success[600],size:d?"xs":"md",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:m,rightIcon:e.jsx(Ne,{}),children:"Criar"})})]})})})}const ge="Nova Categoria";function $t(){const t=I(),[o,s]=a.useState([]),[i,n]=a.useState(null),[c,d]=a.useState(!1),[h,l]=a.useState(ge),[A,u]=a.useState(!1);a.useEffect(()=>{c||m().then()},[c]);const m=async()=>{u(!0),ae().then(g=>{s(g.data)}).finally(()=>{u(!1)})},f=a.useCallback(g=>{d(g),n(null),l(ge)},[]),x=(g,N)=>{g.preventDefault(),u(!0),C1(N).then(S=>{t.show({placement:"top-right",render:()=>e.jsx(Q,{id:"delete-category-success",title:"Categoria Apagada com Sucesso",description:"",status:"success"})}),m().then()}).catch(S=>{t.show({placement:"top-right",render:()=>{let T="";return typeof S.response.data.detail=="object"?T=S.response.data.detail[0].msg.split(", ")[1]:T=S.response.data.detail,e.jsx(Q,{id:"create-category-error",title:"Erro ao apagar categoria",description:`Erro: ${T}`,status:""})}})}).finally(()=>{u(!1)})},b=(g,N)=>{g.preventDefault(),n(N),l("Editar Categoria"),d(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs(Rt,{children:[e.jsx("div",{className:"logo-categories-container",children:e.jsx(K,{})}),e.jsxs("section",{className:"categories-list",children:[e.jsxs("div",{id:"create-category",children:[e.jsx("h1",{className:"categories-page-title",children:"Lista de Categorias"}),e.jsx(y,{size:"lg",rightIcon:e.jsx(ne,{}),onPress:()=>f(!0),children:"Criar categoria"})]}),e.jsx(Zt,{children:A?e.jsx($,{accessibilityLabel:"Carregando os tópicos..."}):e.jsx(e.Fragment,{children:o.map(g=>e.jsxs("div",{id:"category-card",children:[e.jsxs(It,{children:[e.jsx(Jt,{onClick:N=>b(N,g),children:e.jsx(Ye,{color:r.colors.primary[50]})}),e.jsx(Bt,{onClick:N=>x(N,g.id),children:e.jsx(je,{color:r.colors.primary[50]})})]}),e.jsx("p",{id:"category-name",children:g.name}),e.jsx(Ht,{colorIndicator:g.color})]},g.id))})})]})]}),e.jsx(Yt,{isModalOpen:c,setIsModalOpen:f,selectedCategory:i,isEditing:i!==null,title:h})]})}const _t=p.div`
  /* position: fixed;
  top: 0;
  left: 0; */
  width: 100%;
...
`,a3=async t=>{const o=new FormData;return o.append("files",t),console.log(o),await D.post("files/upload/",o,{headers:{"Content-Type":t.type}})};function l3({handleAddFile:t,handleDeleteFile:o,files:s,fileInputRef:i,filesUploadLimit:n=2,setIsAddFileLoading:c}){const d=I(),h=async u=>{const m=u.target.files&&u.target.files[0];m&&s.length+1<=n?(console.log("tentando subir arquivo1"),c(!0),console.log("tentando subir arquivo2"),a3(m).then(f=>{console.log(f.data[0]),t(f.data[0])}).catch(f=>{d.show({placement:"top",render:()=>e.jsx(Q,{id:"files-upload-error",status:"error",title:"Opa!",description:"Erro ao fazer upload do arquivo."})})}).finally(()=>{c(!1)})):d.show({placement:"top",render:()=>e.jsx(Q,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},l=()=>{const u=[];return s.forEach((m,f)=>{u.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>o(m.name),children:e.jsx(je,{size:"1.7rem",color:r.colors.primary[50]})}),e.jsx($e,{size:"38",color:r.colors.gray[500]}),m.name]},f))}),u},A=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(r3,{children:[e.jsx(n3,{fontSize:"1.2rem",children:`Arquivos (${s.length}/${n} arquivos adicionados)`}),e.jsx("input",{ref:i,id:"file-upload",type:"file",style:{display:"none"},onChange:h}),e.jsx(i3,{children:s.length>0?l():A()})]})})}const c3=t=>{let o=!0;const s=[],{title:i,content:n}=t;return(!i||i==="")&&(o=!1,s.push("Título")),(!n||n==="")&&(o=!1,s.push("Conteúdo")),{isValid:o,fieldErrors:s}},d3=t=>{const{title:o,content:s,files:i,categories:n}=t;return{title:o,content:s,categories:n,files:i.map(c=>c.id)}};function u3({isModalOpen:t,setIsModalOpen:o}){const s=I(),i=M("(max-width: 768px)"),n=a.useRef(null),[c,d]=a.useState(!1),[h,l]=a.useState({title:"",content:"",files:[],categories:[]}),[A,u]=a.useState(!1),[m,f]=a.useState(!1),[x,b]=a.useState([]),g={control:C=>({...C,backgroundColor:r.colors.white}),option:(C,{data:w,isMulti:U,isDisabled:z,isFocused:j,isSelected:V})=>{const Z=O(w.color);return{...C,backgroundColor:z?void 0:V?U?w.color:Z.alpha(.2).css():j?Z.alpha(.1).css():void 0,color:z?"#ccc":V&&U?O.contrast(Z,"white")>2?"white":"black":w.color,cursor:z?"not-allowed":"default",":active":{...C[":active"],backgroundColor:z?void 0:V?w.color:Z.alpha(.3).css()}}},multiValue:(C,{data:w})=>{const U=O(w.color);return{...C,backgroundColor:U.alpha(.1).css()}},multiValueLabel:(C,{data:w})=>({...C,color:w.color}),multiValueRemove:(C,{data:w})=>({...C,color:w.color,":hover":{backgroundColor:w.color,color:"white"}}),input:C=>({...C,"input:focus":{boxShadow:"none"}})};a.useEffect(()=>console.log(h),[h]),a.useEffect(()=>{ae().then(C=>{b(C.data)})},[]),a.useEffect(()=>{d(t),l({title:"",content:"",files:[],categories:[]})},[t]);const N=a.useCallback((C,w)=>{Array.isArray(w)?l({...h,[C]:w.map(U=>Number(U.value))}):l({...h,[C]:w})},[h]),S=a.useCallback(C=>{f(C)},[]),T=C=>{C.preventDefault();const{isValid:w,fieldErrors:U}=c3(h);if(!w){s.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${U.reduce((z,j,V)=>V===0?`'${j}'`:V===U.length-1?`${z} e '${j}'`:`${z}, '${j}'`,"")}`,status:""})});return}u(!0),U1(d3(h)).then(z=>{s.show({placement:"top-right",render:()=>e.jsx(Q,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),J(),l({title:"",content:"",files:[],categories:[]})}).catch(z=>{s.show({placement:"top-right",render:()=>{let j="";return typeof z.response.data.detail=="object"?j=z.response.data.detail[0].msg.split(", ")[1]:j=z.response.data.detail,e.jsx(Q,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${j}`,status:""})}})}).finally(()=>{u(!1)})},J=()=>{d(!1),setTimeout(()=>{o(!1)},300)},k=a.useCallback(C=>{l({...h,files:[...h.files,C]})},[h]),L=a.useCallback(C=>{const w=h.files.filter(U=>U.name!==C);l({...h,files:w})},[h]),v=()=>{n&&n.current&&n.current.click()};return e.jsx(e.Fragment,{children:e.jsx(_t,{isOpen:c,children:e.jsxs(e3,{isOpen:c,onClick:C=>C.stopPropagation(),children:[e.jsx(s3,{onClick:J,children:e.jsx(_e,{size:"2rem",color:r.colors.tertiary[400]})}),e.jsx("h1",{children:"Novo Tópico"}),e.jsx(R,{name:"title",onChange:N,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(Qe,{name:"content",onChange:N,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(o3,{children:e.jsx(ee,{isMulti:!0,closeMenuOnSelect:!1,options:x.map(C=>({value:C.id.toString(),label:C.name,color:C.color})),styles:g,onChange:C=>N("categories",C),placeholder:"Adicionar categorias"})}),e.jsx(l3,{filesUploadLimit:2,fileInputRef:n,handleAddFile:k,handleDeleteFile:L,files:h.files,setIsAddFileLoading:S}),e.jsxs(t3,{children:[e.jsx(y,{onPress:()=>v(),size:i?"xs":"md",isLoading:m,isLoadingText:"Adicionando arquivo...",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(ne,{}),children:"Adicionar arquivos"}),e.jsx(y,{id:"create-topic-button",onPress:C=>T(C),bgColor:r.colors.success[600],size:i?"xs":"md",isDisabled:m,borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:A,rightIcon:e.jsx(Ne,{}),children:"Criar"})]})]})})})}function A3(){const t=W();return e.jsx(e.Fragment,{children:e.jsx(u3,{isModalOpen:!0,setIsModalOpen:()=>t("/")})})}function p3(){return e.jsxs(e1,{children:[e.jsxs(P,{path:"/",element:e.jsx(Y,{}),children:[e.jsx(P,{path:"/",element:e.jsx(O1,{})}),e.jsx(P,{path:"/topic/:id",element:e.jsx(Xt,{})})]}),e.jsx(P,{path:"/profile",element:e.jsx(Y,{}),children:e.jsx(P,{path:"/profile",element:e.jsx(St,{})})}),e.jsx(P,{path:"/categories",element:e.jsx(Y,{}),children:e.jsx(P,{path:"/categories",element:e.jsx($t,{})})}),e.jsx(P,{path:"/create-topic",element:e.jsx(Y,{}),children:e.jsx(P,{path:"/create-topic",element:e.jsx(A3,{})})}),e.jsxs(P,{path:"/login",element:e.jsx(ct,{}),children:[e.jsx(P,{path:"/login",element:e.jsx(it,{})}),e.jsx(P,{path:"/login/logon",element:e.jsx(tt,{})}),e.jsx(P,{path:"/login/create-account",element:e.jsx(Nt,{})})]})]})}const h3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},m3=t1`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function f3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(o){return console.log(o),"light"}},set:async o=>{try{localStorage.setItem("@UnBForum:theme",o)}catch(s){console.log(s)}}};return e.jsx(o1,{colorModeManager:t,children:e.jsx(s1,{theme:h3,children:e.jsxs(P1,{children:[e.jsx(r1,{children:e.jsx(p3,{})}),e.jsx(m3,{})]})})})}n1.createRoot(document.getElementById("root")).render(e.jsx(i1.StrictMode,{children:e.jsx(f3,{})}));
