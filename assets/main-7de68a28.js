import{s,t as i,j as e,I as J,F as W,S as b,P as B,n as S,B as h,u as Q,r as u,A as M,a as I,b as P,c as V,d as F,D as G,e as K,f as O,T as Y,g as $,h as _,C as E,i as X,k as e1,l as t1,m as i1,o as n1,O as R,p as r1,q as Z,v as q,V as o1,H as T,w as L,x as s1,y as a1,R as l1,z as N,E as A1,N as c1,X as d1,G as C1,J as u1,K as p1}from"./vendor-9271bbb1.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&l(d)}).observe(document,{childList:!0,subtree:!0});function r(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(o){if(o.ep)return;o.ep=!0;const a=r(o);fetch(o.href,a)}})();const h1=s.div`
  width: 100%;
  display: flex;
...
`;function v({label:t="",inputType:n="text",placeholder:r,accessibilityLabel:l,size:o="md",fontSize:a="0.9rem",name:d,isRequired:c=!0,onChange:C,...A}){return e.jsxs(h1,{children:[t&&e.jsxs(f1,{fontSize:a,children:[t,c&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(J,{type:n,variant:"outline",size:o,isRequired:c,placeholder:r,accessibilityLabel:l,onChangeText:g=>C(d,g),...A})]})}const x1=s.main`
  width: 70%;
  display: flex;
...
`,H=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],z=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],D1=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:H},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:z},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],k1=[{label:"Mais salvos",value:"Mais salvos"},{label:"Menos salvos",value:"Menos salvos"},{label:"Mais comentários",value:"Mais comentários"},{label:"Menos comentários",value:"Menos comentários"},{label:"Mais recentes",value:"Mais recentes"},{label:"Mais antigos",value:"Mais antigos"}];function w1(){return e.jsxs(Q1,{children:[e.jsxs(j1,{children:[e.jsx(W,{}),e.jsx(b,{backgroundColor:i.colors.white,color:i.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione os filtros...",accessibilityLabel:"Selecione a opção",children:z.map(t=>e.jsx(b.Item,{label:t.label,value:t.value},t.label))})]}),e.jsxs(y1,{children:[e.jsx(B,{}),e.jsx(b,{backgroundColor:i.colors.white,color:i.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione a ordenação...",accessibilityLabel:"Selecione a opção",children:k1.map(t=>e.jsx(b.Item,{label:t.label,value:t.value},t.label))})]})]})}const z1=(t,n)=>t?"0.9rem":n?"1rem":"0.9rem",S1=(t,n)=>t?"0.7rem":n?"0.8rem":"0.7rem",q1=s.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,T1=s.div`
  ...
  gap: ${({isInsideTopic:t,isComment:n})=>t&&!n?"1rem":"0.4rem"};
...
`,U1=s.div`
  ...
  & > p {
    ...
    text-align: left;
    font-weight: ${({isComment:t,isInsideTopic:n})=>"400"};
    font-size: ${({isComment:t,isInsideTopic:n})=>z1(t,n)};
    color: ${i.colors.black};
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:n})=>S1(t,n)};
      line-height: 1.7;
    }
...
`;function k({id:t,isInsideTopic:n=!1,isComment:r=!1}){const l=Q(),o="Sandalo Henrique",a="Horários de Atendimento coordenação de Eng. de Software",[d,c]=u.useState(105),[C,A]=u.useState(!1);function g(){l(`/topic/${t}`)}function f(p,y){p.preventDefault(),c(d+y)}function x(p){p.preventDefault(),A(!C)}function m(){switch(C){case!0:return e.jsx(O,{size:"30",color:i.colors.darkBlue[400]});case!1:return e.jsx(K,{size:"30",color:i.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(q1,{children:[e.jsxs(T1,{isInsideTopic:n,isComment:r,children:[e.jsx("button",{id:"reactionButton",onClick:p=>f(p,1),children:e.jsx(M,{color:i.colors.muted[500],size:"18"})}),e.jsx("p",{children:d}),e.jsx("button",{id:"reactionButton",onClick:p=>f(p,-1),children:e.jsx(I,{color:i.colors.muted[500],size:"18"})}),!r&&e.jsx("button",{id:"markButton",onClick:p=>x(p),children:m()})]}),e.jsx(L1,{children:e.jsxs(U1,{isInsideTopic:n,isComment:r,children:[n&&e.jsx("h1",{id:"post-title",children:a}),e.jsxs(P1,{isInsideTopic:n,children:[e.jsx(P,{bg:r?"lime.600":"emerald.600",marginRight:"0.8rem",size:r?"xs":"sm",children:"SH"}),e.jsxs("p",{children:[o,!n&&!r&&` - ${a}`]})]}),e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** AA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),!r&&e.jsx(V1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((p,y)=>e.jsx(V,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:p})},y))}),!n&&!r&&e.jsx(E1,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:"1rem"},isInsideTopic:n,onPress:n?()=>{}:()=>g(),rightIcon:e.jsx(F,{size:"22",color:i.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:"Ver comentários (15)"})]})})]}),e.jsx(G,{alignSelf:"flex-end",width:r?"95%":"100%",marginTop:n?"0rem":"0.5rem",height:r||!n?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const X1=s.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function J1(){return e.jsxs(X1,{children:[e.jsxs(R1,{children:[e.jsx(P,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(Z1,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(H1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,n)=>e.jsx(V,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},n))})]})]})}const W1=s.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function K1({label:t="",inputType:n="text",placeholder:r,accessibilityLabel:l,size:o="md",fontSize:a="0.9rem",...d}){return e.jsxs(F1,{children:[t&&e.jsx(G1,{fontSize:a,children:t}),e.jsx(Y,{type:n,variant:"outline",size:o,placeholder:r,accessibilityLabel:l,autoCompleteType:null,totalLines:5,maxLength:500,...d})]})}const O1=s.div`
  position: relative;
...
`;function o3(){const t=Q();function n(r){r.preventDefault(),t("/login/logon")}return e.jsx(n3,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(i3,{}),e.jsxs("div",{className:"user-container",children:[e.jsx("h3",{className:"user-name",children:"Lucas"}),e.jsx(r3,{onClick:r=>n(r),children:e.jsx(n1,{size:"2.5rem",color:i.colors.tertiary[300]})})]})]})})}const s3=s.div`
...
`;function U(){return e.jsxs(s3,{children:[e.jsx(o3,{}),e.jsx("div",{className:"content",children:e.jsx(R,{})})]})}const a3=s.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function c3(){const t=Q();function n(r){r.preventDefault(),t("/")}return e.jsxs(A3,{children:[e.jsx(j,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(v,{name:"email",onChange:()=>{},accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(v,{name:"password",onChange:()=>{},accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(h,{onPress:r=>n(r),variant:"solid",size:"lg",children:"Entrar"}),e.jsx(h,{onPress:r=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const d3=s.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,C3="/UnBForumFront/assets/create-account-24b27e13.png";function u3(){return e.jsxs(d3,{children:[e.jsx("img",{className:"create-account-image",src:C3,alt:""}),e.jsx("div",{className:"content",children:e.jsx(R,{})})]})}const p3=s.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function w({label:t,placeholder:n,options:r=[],onChange:l,isRequired:o=!0,fontSize:a="0.9rem",name:d}){return e.jsxs(h3,{fontSize:a,children:[e.jsxs("label",{className:"create-account-label",children:[t,o&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(b,{variant:"outline",height:9,size:"md",onValueChange:c=>l(d,c),placeholder:n,accessibilityLabel:"Selecione a opção",children:r.map(c=>e.jsx(b.Item,{label:c.label,value:c.value},c.label))})]})}console.log({}.VITE_API_ENDPOINT);const f3=r1.create({baseURL:{}.VITE_API_ENDPOINT||"http://localhost:8000"}),x3=async t=>{const n=await f3.post("users",t);return console.log(n),n},m3=t=>{let n=!0;const r=[],{name:l,email:o,profile:a,course:d,password:c,passwordConfirm:C}=t;return(!l||l==="")&&(n=!1,r.push("Nome Completo")),(!o||o==="")&&(n=!1,r.push("Email Institucional")),(!a||a==="")&&(n=!1,r.push("Papel na Instituição")),(!d||d==="")&&(n=!1,r.push("Curso")),(!c||c==="")&&(n=!1,r.push("Senha")),(!C||C===""||C!==c)&&(n=!1,r.push("Confirme a senha")),{isValid:n,fieldErrors:r}},D=({id:t,status:n,variant:r="left-accent",title:l,description:o,isClosable:a=!1,...d})=>{const c=Z();return e.jsx(q,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:n||"error",variant:r,...d,children:e.jsxs(o1,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(T,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(T,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(q.Icon,{}),e.jsx(L,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:r==="solid"?"lightText":r!=="outline"?"darkText":null,children:l})]}),a?e.jsx(s1,{variant:"unstyled",icon:e.jsx(E,{size:"3"}),_icon:{color:r==="solid"?"lightText":"darkText"},onPress:()=>c.close(t)}):null]}),e.jsx(L,{px:"6",color:r==="solid"?"lightText":r!=="outline"?"darkText":null,children:o})]})})},g3=t=>{const{name:n,email:r,profile:l,course:o,password:a}=t;return{name:n,email:r,password:a,tags:[l,o]}};function N3(){const t=Q(),n=Z(),[r,l]=u.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[o,a]=u.useState(!1);u.useEffect(()=>{},[r]);const d=u.useCallback((A,g)=>{l({...r,[A]:g})},[r]),c=async A=>{A.preventDefault();const{isValid:g,fieldErrors:f}=m3(r);if(console.log(r),!g){n.show({placement:"top-right",render:()=>e.jsx(D,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${f.reduce((x,m,p)=>p===0?`'${m}'`:p===f.length-1?`${x} e '${m}'`:`${x}, '${m}'`,"")}`,status:""})});return}a(!0),x3(g3(r)).then(x=>{n.show({placement:"top-right",render:()=>e.jsx(D,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário criado com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(x=>{n.show({placement:"top-right",render:()=>{let m="";return typeof x.response.data.detail=="object"?m=x.response.data.detail[0].msg.split(", ")[1]:m=x.response.data.detail,e.jsx(D,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${m}`,status:""})}})}).finally(()=>{a(!1)})};function C(A){switch(A.input){case"select":return e.jsx(w,{label:A.label,placeholder:A.placeholder,options:A.options,name:A.name,onChange:d,accessibilityLabel:A.accessibilityLabel},A.label);default:return e.jsx(v,{label:A.label,placeholder:A.placeholder,inputType:A.type,name:A.name,onChange:d,accessibilityLabel:A.accessibilityLabel},A.label)}}return e.jsxs(p3,{children:[e.jsx(j,{}),e.jsxs("div",{className:"inputs-container",children:[D1.map(A=>C(A)),e.jsx(h,{onPress:A=>c(A),variant:"solid",size:"lg",isLoading:o,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(h,{onPress:A=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const v3=s.section`
  width: 80%;
...
`;function b3(){return e.jsxs(v3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(j,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(v,{name:"name",onChange:()=>{},label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(v,{name:"email",onChange:()=>{},label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(w,{name:"profile",onChange:()=>{},label:"Papel na Instituição",placeholder:"Selecione o seu papel na instituição...",options:H,accessibilityLabel:"Selecione o seu papel na instituição..."}),e.jsx(w,{name:"course",onChange:()=>{},label:"Curso",placeholder:"Selecione seu curso...",options:z,accessibilityLabel:"Selecione seu curso..."}),e.jsx(v,{name:"password",onChange:()=>{},label:"Senha",placeholder:"Digite sua senha",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),e.jsx(h,{variant:"solid",size:"lg",children:"Editar Perfil"}),e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(h,{variant:"subtle",size:"md",children:"Sair"}),e.jsx(h,{variant:"subtle",size:"md",children:"Deletar a Conta"})]})]})]})}const Q3=s.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`;function y3(){const{id:t}=a1();return u.useEffect(()=>window.scrollTo(0,0),[]),e.jsxs(Q3,{children:[e.jsx(k,{id:Number(t),isInsideTopic:!0}),e.jsx(j3,{children:Array.from({length:10},(n,r)=>r).map(n=>e.jsx(k,{id:n,isComment:!0},n))})]})}function D3(){return e.jsxs(l1,{children:[e.jsxs(N,{path:"/",element:e.jsx(U,{}),children:[e.jsx(N,{path:"/",element:e.jsx(t3,{})}),e.jsx(N,{path:"/topic/:id",element:e.jsx(y3,{})})]}),e.jsx(N,{path:"/profile",element:e.jsx(U,{}),children:e.jsx(N,{path:"/profile",element:e.jsx(b3,{})})}),e.jsxs(N,{path:"/login",element:e.jsx(u3,{}),children:[e.jsx(N,{path:"/login",element:e.jsx(c3,{})}),e.jsx(N,{path:"/login/logon",element:e.jsx(l3,{})}),e.jsx(N,{path:"/login/create-account",element:e.jsx(N3,{})})]})]})}const k3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},w3=A1`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function z3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(n){return console.log(n),"light"}},set:async n=>{try{localStorage.setItem("@UnBForum:theme",n)}catch(r){console.log(r)}}};return e.jsx(c1,{colorModeManager:t,children:e.jsxs(d1,{theme:k3,children:[e.jsx(C1,{children:e.jsx(D3,{})}),e.jsx(w3,{})]})})}u1.createRoot(document.getElementById("root")).render(e.jsx(p1.StrictMode,{children:e.jsx(z3,{})}));
