import{s as d,t as r,j as e,I as f1,F as m1,S,P as x1,n as G,B as x,u as U,r as A,A as g1,a as N1,b as s1,c as n1,d as v1,D as b1,e as j1,f as Q1,T as y1,g as D1,h as w1,C as Z,i as r1,k as k1,l as z1,m as S1,o as U1,p as K,q as q1,v as L1,w as T1,O as i1,x as q,y as O,V as P1,H as Y,z as $,E as E1,G as H,J as V1,R as X1,K as w,L as R1,N as Z1,X as H1,M as J1,Q as W1,U as B1}from"./vendor-a051903b.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();const I1=d.div`
  width: 100%;
  display: flex;
...
`;function k({label:t="",inputType:s="text",placeholder:n,accessibilityLabel:i,size:o="md",fontSize:a="0.9rem",name:l,isRequired:p=!0,isEditing:c=!0,value:g=void 0,onChange:u,...C}){return e.jsxs(I1,{children:[t&&e.jsxs(M1,{fontSize:a,children:[t,p&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(f1,{type:s,variant:c?"outline":"filled",size:o,isRequired:p,value:g,placeholder:n,editable:c,accessibilityLabel:i,onChangeText:h=>u(l,h),...C})]})}const F1=d.main`
  width: 70%;
  display: flex;
...
`,se=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],o1=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],ne=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:se},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:o1},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],re=[{label:"Mais salvos",value:"Mais salvos"},{label:"Menos salvos",value:"Menos salvos"},{label:"Mais comentários",value:"Mais comentários"},{label:"Menos comentários",value:"Menos comentários"},{label:"Mais recentes",value:"Mais recentes"},{label:"Mais antigos",value:"Mais antigos"}];function ie(){return e.jsxs(_1,{children:[e.jsxs(ee,{children:[e.jsx(m1,{}),e.jsx(S,{backgroundColor:r.colors.white,color:r.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione os filtros...",accessibilityLabel:"Selecione a opção",children:o1.map(t=>e.jsx(S.Item,{label:t.label,value:t.value},t.label))})]}),e.jsxs(te,{children:[e.jsx(x1,{}),e.jsx(S,{backgroundColor:r.colors.white,color:r.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione a ordenação...",accessibilityLabel:"Selecione a opção",children:re.map(t=>e.jsx(S.Item,{label:t.label,value:t.value},t.label))})]})]})}const oe=(t,s)=>t?"0.9rem":s?"1rem":"0.9rem",ae=(t,s)=>t?"0.7rem":s?"0.8rem":"0.7rem",le=d.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,Ae=d.div`
  ...
  & > p {
    ...
    font-size: ${({isComment:t,isInsideTopic:s})=>oe(t,s)};
    color: ${r.colors.black};
...
`;function R({id:t,isInsideTopic:s=!1,isComment:n=!1}){const i=U(),o="Sandalo Henrique",a="Horários de Atendimento coordenação de Eng. de Software",[l,p]=A.useState(105),[c,g]=A.useState(!1);function u(){i(`/topic/${t}`)}function C(m,b){m.preventDefault(),p(l+b)}function h(m){m.preventDefault(),g(!c)}function f(){switch(c){case!0:return e.jsx(Q1,{size:"30",color:r.colors.darkBlue[400]});case!1:return e.jsx(j1,{size:"30",color:r.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(le,{children:[e.jsxs(de,{isInsideTopic:s,isComment:n,children:[e.jsx("button",{id:"reactionButton",onClick:m=>C(m,1),children:e.jsx(g1,{color:r.colors.muted[500],size:"18"})}),e.jsx("p",{children:l}),e.jsx("button",{id:"reactionButton",onClick:m=>C(m,-1),children:e.jsx(N1,{color:r.colors.muted[500],size:"18"})}),!n&&e.jsx("button",{id:"markButton",onClick:m=>h(m),children:f()})]}),e.jsx(ce,{children:e.jsxs(Ae,{isInsideTopic:s,isComment:n,children:[s&&e.jsx("h1",{id:"post-title",children:a}),e.jsxs(ue,{isInsideTopic:s,children:[e.jsx(s1,{bg:n?"lime.600":"emerald.600",marginRight:"0.8rem",size:n?"xs":"sm",children:"SH"}),e.jsxs("p",{children:[o,!s&&!n&&` - ${a}`]})]}),e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** AA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),!n&&e.jsx(pe,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((m,b)=>e.jsx(n1,{variant:"solid",bg:r.colors.tertiary[500],alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:m})},b))}),!s&&!n&&e.jsx(Ce,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:"1rem"},isInsideTopic:s,onPress:s?()=>{}:()=>u(),rightIcon:e.jsx(v1,{size:"22",color:r.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:"Ver comentários (15)"})]})})]}),e.jsx(b1,{alignSelf:"flex-end",width:n?"95%":"100%",marginTop:s?"0rem":"0.5rem",height:n||!s?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const he=d.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function ge(){return e.jsxs(he,{children:[e.jsxs(fe,{children:[e.jsx(s1,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(me,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(xe,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,s)=>e.jsx(n1,{variant:"solid",bg:r.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},s))})]})]})}const Ne=d.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function De({label:t="",inputType:s="text",placeholder:n,accessibilityLabel:i,size:o="md",fontSize:a="0.9rem",...l}){return e.jsxs(Qe,{children:[t&&e.jsx(ye,{fontSize:a,children:t}),e.jsx(y1,{type:s,variant:"outline",size:o,placeholder:n,accessibilityLabel:i,autoCompleteType:null,totalLines:5,maxLength:500,...l})]})}const we=d.div`
  position: relative;
...
`;const z=U1.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),a1=A.createContext(null),Pe=({children:t})=>{const[s,n]=A.useState(""),[i,o]=A.useState([]),[a,l]=A.useState(""),[p,c]=A.useState("");A.useEffect(()=>{const C=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",C),C){const h=K(C.split(" ")[1]);z.defaults.headers.common.Authorization=`${C}`,n(C.split(" ")[1]),o(h.scopes),l(h.sub),c(h.name)}},[]);const g=A.useCallback(C=>{localStorage.setItem("@UnBForum:token",`Bearer ${C}`);const h=K(C);z.defaults.headers.common.Authorization=`Bearer ${C}`,n(C),o(h.scopes),l(h.sub),c(h.name)},[]),u=A.useCallback(()=>{n(""),o([]),l(""),c(""),localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(a1.Provider,{value:{token:s,name:p,email:a,scopes:i,changeToken:g,logoutUser:u,setName:c},children:t})};function J(){const t=A.useContext(a1);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}function Ee(){const{name:t,token:s}=J(),n=U(),i=q1("(max-width: 768px)");function o(l){l.preventDefault(),n("/profile")}function a(l){l.preventDefault(),n("/login/logon")}return e.jsx(Te,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(Le,{}),e.jsxs("div",{className:"user-container",children:[s&&e.jsx(e.Fragment,{children:e.jsx(x,{onPress:l=>o(l),rightIcon:e.jsx(L1,{size:"30",color:r.colors.tertiary[300]}),children:i?"":t})}),!s&&e.jsx(e.Fragment,{children:e.jsx(x,{variant:"solid",bgColor:r.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(T1,{size:30,color:r.colors.white}),onPress:l=>a(l),children:i?"":"Entrar"})})]})]})})}const Ve=d.div`
...
`;function _(){return e.jsxs(Ve,{children:[e.jsx(Ee,{}),e.jsx("div",{className:"content",children:e.jsx(i1,{})})]})}const Xe=d.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,He=t=>{let s=!0;const n=[],{email:i,password:o}=t;return(!i||i==="")&&(s=!1,n.push("Email Institucional")),(!o||o==="")&&(s=!1,n.push("Senha")),{isValid:s,fieldErrors:n}},j=({id:t,status:s,variant:n="left-accent",title:i,description:o,isClosable:a=!1,...l})=>{const p=q();return e.jsx(O,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:s||"error",variant:n,...l,children:e.jsxs(P1,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(Y,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(Y,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(O.Icon,{}),e.jsx($,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:n==="solid"?"lightText":n!=="outline"?"darkText":null,children:i})]}),a?e.jsx(E1,{variant:"unstyled",icon:e.jsx(Z,{size:"3"}),_icon:{color:n==="solid"?"lightText":"darkText"},onPress:()=>p.close(t)}):null]}),e.jsx($,{px:"6",color:n==="solid"?"lightText":n!=="outline"?"darkText":null,children:o})]})})},Je=async t=>{const{username:s,password:n}=t,i=new FormData;return i.append("username",s),i.append("password",n),await z.post("auth/login",i)},We=t=>{const{email:s,password:n}=t;return{username:s,password:n}};function Be(){const t=U(),s=q(),{changeToken:n}=J(),[i,o]=A.useState({email:"",password:""}),[a,l]=A.useState(!1),p=A.useCallback((g,u)=>{o({...i,[g]:u})},[i]);function c(g){g.preventDefault();const{isValid:u,fieldErrors:C}=He(i);if(!u){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${C.reduce((h,f,m)=>m===0?`'${f}'`:m===C.length-1?`${h} e '${f}'`:`${h}, '${f}'`,"")}`,status:""})});return}l(!0),Je(We(i)).then(h=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:"Usuário logado com sucesso!",status:"success"})}),n(h.data.access_token),t("/")}).catch(h=>{s.show({placement:"top-right",render:()=>{let f="";return typeof h.response.data.detail=="object"?f=h.response.data.detail[0].msg.split(", ")[1]:f=h.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${f}`,status:""})}})}).finally(()=>{l(!1)})}return e.jsxs(Ze,{children:[e.jsx(L,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(k,{name:"email",onChange:p,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(k,{name:"password",onChange:p,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(x,{onPress:g=>c(g),variant:"solid",size:"lg",isLoading:a,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(x,{onPress:g=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const Ie=d.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,Me="/UnBForumFront/assets/create-account-24b27e13.png";function Fe(){return e.jsxs(Ie,{children:[e.jsx("img",{className:"create-account-image",src:Me,alt:""}),e.jsx("div",{className:"content",children:e.jsx(i1,{})})]})}const Ge=d.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function Oe({label:t,placeholder:s,options:n=[],onChange:i,isRequired:o=!0,fontSize:a="0.9rem",isEditing:l=!0,name:p}){return e.jsxs(Ke,{fontSize:a,children:[e.jsxs("label",{className:"create-account-label",children:[t,o&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(S,{variant:"outline",height:9,size:"md",isDisabled:!l,onValueChange:c=>i(p,c),placeholder:s,accessibilityLabel:"Selecione a opção",children:n.map(c=>e.jsx(S.Item,{label:c.label,value:c.value},c.label))})]})}const Ye=async t=>await z.post("users",t),e1=async()=>await z.get("users/me"),$e=async t=>await z.patch("users/me",t),_e=async t=>await z.post("users/me/change_password",t),e3=async()=>await z.delete("users/me"),t3=t=>{let s=!0;const n=[],{name:i,email:o,profile:a,course:l,password:p,passwordConfirm:c}=t;return(!i||i==="")&&(s=!1,n.push("Nome Completo")),(!o||o==="")&&(s=!1,n.push("Email Institucional")),(!a||a==="")&&(s=!1,n.push("Papel na Instituição")),(!l||l==="")&&(s=!1,n.push("Curso")),(!p||p==="")&&(s=!1,n.push("Senha")),(!c||c===""||c!==p)&&(s=!1,n.push("Confirme a senha")),{isValid:s,fieldErrors:n}},s3=t=>{const{name:s,email:n,profile:i,course:o,password:a}=t;return{name:s,email:n,password:a,tags:[i,o]}};function n3(){const t=U(),s=q(),n=H({lg:"lg",base:"md"}),[i,o]=A.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[a,l]=A.useState(!1),p=A.useCallback((u,C)=>{o({...i,[u]:C})},[i]),c=async u=>{u.preventDefault();const{isValid:C,fieldErrors:h}=t3(i);if(console.log(i),!C){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${h.reduce((f,m,b)=>b===0?`'${m}'`:b===h.length-1?`${f} e '${m}'`:`${f}, '${m}'`,"")}`,status:""})});return}l(!0),Ye(s3(i)).then(f=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(f=>{s.show({placement:"top-right",render:()=>{let m="";return typeof f.response.data.detail=="object"?m=f.response.data.detail[0].msg.split(", ")[1]:m=f.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${m}`,status:""})}})}).finally(()=>{l(!1)})};function g(u){switch(u.input){case"select":return e.jsx(Oe,{label:u.label,placeholder:u.placeholder,options:u.options,name:u.name,onChange:p,accessibilityLabel:u.accessibilityLabel},u.label);default:return e.jsx(k,{label:u.label,placeholder:u.placeholder,inputType:u.type,name:u.name,onChange:p,accessibilityLabel:u.accessibilityLabel},u.label)}}return e.jsxs(Ge,{children:[e.jsx(L,{}),e.jsxs("div",{className:"inputs-container",children:[ne.map(u=>g(u)),e.jsx(x,{onPress:u=>c(u),variant:"solid",size:n,isLoading:a,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(x,{onPress:u=>t(-1),variant:"outline",size:n,children:"Voltar"})]})]})}const r3=d.section`
  width: 80%;
...
`,i3=t=>{let s=!0;const n=[];return(!t||t==="")&&(s=!1,n.push("Nome Completo")),{isValid:s,fieldErrors:n}},o3=(t,s)=>{let n=!0;const i=[];let o="";return(!t||t==="")&&(n=!1,i.push("Senha Atual")),(!s||s==="")&&(n=!1,i.push("Nova Senha")),!s&&s===t&&(n=!1,o="Nova senha não pode ser a mesma que a atual"),{isValid:n,fieldErrors:i,specialError:o}},a3=d.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function t1({question:t,handleAccept:s,handleClose:n,cancelText:i="Cancelar",acceptText:o,isOpen:a,isLoadingAcceptButton:l=!1,loadingAcceptButtonText:p=""}){const c=H({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:a&&e.jsx(a3,{children:e.jsxs(l3,{children:[e.jsx(d3,{onClick:n,children:e.jsx(Z,{size:"21",color:r.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(x,{size:c,variant:"outline",onPress:n,children:i}),e.jsx(x,{size:c,onPress:s,bgColor:r.colors.danger[500],isLoading:l,isLoadingText:p,children:o})]})]})})})}function c3(){const t=U(),s=q(),{name:n,email:i,setName:o,logoutUser:a}=J(),l=H({lg:"lg",base:"md"}),[p,c]=A.useState(!1),[g,u]=A.useState(!1),[C,h]=A.useState(!1),[f,m]=A.useState(!1),[b,T]=A.useState({email:i,id:0,name:n,role:"",tags:[]}),[l1,W]=A.useState(!1),[d1,B]=A.useState(!1),[c1,I]=A.useState(!1),[P,E]=A.useState(""),[M,V]=A.useState("");A.useEffect(()=>{e1().then(N=>{T(N.data),o(N.data.name)})},[o]);const A1=A.useCallback((N,Q)=>{T({...b,[N]:Q})},[b]),u1=A.useCallback(()=>{B(!0),e3().then(()=>{}).finally(()=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"delete-user-success",title:"Usuário deletado!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),a(),B(!1),u(!1),t("/")})},[t,a,s]),p1=N=>{N.preventDefault();const{fieldErrors:Q,isValid:X}=i3(b.name);if(!X){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${Q.reduce((D,v,y)=>y===0?`'${v}'`:y===Q.length-1?`${D} e '${v}'`:`${D}, '${v}'`,"")}`,status:""})});return}W(!0),$e({name:b.name}).then(D=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),o(b.name)}).catch(D=>{s.show({placement:"top-right",render:()=>{let v="";return typeof D.response.data.detail=="object"?v=D.response.data.detail[0].msg.split(", ")[1]:v=D.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${v}`,status:""})}})}).finally(()=>{W(!1),h(!1)})},C1=N=>{N.preventDefault();const{fieldErrors:Q,isValid:X,specialError:D}=o3(P,M);if(!X){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:Q.length>0?`Os sequintes campos estão incorretos: ${Q.reduce((v,y,F)=>F===0?`'${y}'`:F===Q.length-1?`${v} e '${y}'`:`${v}, '${y}'`,"")}`:D,status:""})});return}I(!0),_e({current_password:P,new_password:M}).then(v=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(v=>{s.show({placement:"top-right",render:()=>{let y="";return typeof v.response.data.detail=="object"?y=v.response.data.detail[0].msg.split(", ")[1]:y=v.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${y}`,status:""})}})}).finally(()=>{I(!1),m(!1),E(""),V("")})},h1=()=>C?e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:l,onPress:()=>{h(!1),e1().then(N=>{T(N.data)})},children:"Cancelar"}),e.jsx(x,{variant:"outline",size:l,isLoading:l1,isLoadingText:"Atualizando Usuário...",onPress:N=>p1(N),children:"Atualizar Usuário"})]}):f?e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:l,onPress:()=>{m(!1),E(""),V("")},children:"Cancelar"}),e.jsx(x,{variant:"outline",size:l,isLoading:c1,isLoadingText:"Atualizando Senha...",onPress:N=>C1(N),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:l,onPress:()=>h(!0),children:"Editar Perfil"}),e.jsx(x,{variant:"outline",size:l,onPress:()=>m(!0),children:"Alterar Senha"})]});return e.jsxs(r3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(L,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(k,{name:"name",onChange:A1,isEditing:C,value:b.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(k,{name:"email",onChange:()=>{},isEditing:!1,value:b.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(k,{name:"password",onChange:(N,Q)=>E(Q),isEditing:f,value:f?P:"valordeteste",label:f?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),f&&e.jsx(k,{name:"passwordConfirm",onChange:(N,Q)=>V(Q),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),h1(),!C&&!f&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(x,{variant:"subtle",size:"md",onPress:()=>c(!0),children:"Sair"}),e.jsx(x,{variant:"subtle",size:"md",onPress:()=>u(!0),children:"Deletar a Conta"})]})]}),e.jsx(t1,{isOpen:p,handleAccept:()=>{c(!1),a(),t("/")},handleClose:()=>c(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(t1,{isOpen:g,handleAccept:()=>{u1()},handleClose:()=>u(!1),question:"Tem certeza que deseja deletar sua conta?",acceptText:"Deletar",isLoadingAcceptButton:d1,loadingAcceptButtonText:"Deletando..."})]})}const A3=d.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`;function p3(){const{id:t}=V1();return A.useEffect(()=>window.scrollTo(0,0),[]),e.jsxs(A3,{children:[e.jsx(R,{id:Number(t),isInsideTopic:!0}),e.jsx(u3,{children:Array.from({length:10},(s,n)=>n).map(s=>e.jsx(R,{id:s,isComment:!0},s))})]})}function C3(){return e.jsxs(X1,{children:[e.jsxs(w,{path:"/",element:e.jsx(_,{}),children:[e.jsx(w,{path:"/",element:e.jsx(qe,{})}),e.jsx(w,{path:"/topic/:id",element:e.jsx(p3,{})})]}),e.jsx(w,{path:"/profile",element:e.jsx(_,{}),children:e.jsx(w,{path:"/profile",element:e.jsx(c3,{})})}),e.jsxs(w,{path:"/login",element:e.jsx(Fe,{}),children:[e.jsx(w,{path:"/login",element:e.jsx(Be,{})}),e.jsx(w,{path:"/login/logon",element:e.jsx(Re,{})}),e.jsx(w,{path:"/login/create-account",element:e.jsx(n3,{})})]})]})}const h3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},f3=R1`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function m3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(s){return console.log(s),"light"}},set:async s=>{try{localStorage.setItem("@UnBForum:theme",s)}catch(n){console.log(n)}}};return e.jsx(Z1,{colorModeManager:t,children:e.jsx(H1,{theme:h3,children:e.jsxs(Pe,{children:[e.jsx(J1,{children:e.jsx(C3,{})}),e.jsx(f3,{})]})})})}W1.createRoot(document.getElementById("root")).render(e.jsx(B1.StrictMode,{children:e.jsx(m3,{})}));
