import{s as r,t,j as e,I as T,F as L,S as x,P as U,r as u,A as P,a as V,b as j,B as D,c as X,D as E,d as R,e as Z,T as H,f as J,g as W,C as B,h as C,i as y,k as M,l as I,m as F,u as m,n as G,O as k,R as K,o as p,p as O,N as Y,X as $,H as _,q as e1,v as t1}from"./vendor-8165ce07.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function o(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(s){if(s.ep)return;s.ep=!0;const l=o(s);fetch(s.href,l)}})();const i1=r.div`
  width: 100%;
  display: flex;
...
`;function h({label:i="",inputType:a="text",placeholder:o,accessibilityLabel:n,size:s="md",fontSize:l="0.9rem",...c}){return e.jsxs(i1,{children:[i&&e.jsx(n1,{fontSize:l,children:i}),e.jsx(T,{type:a,variant:"outline",size:s,placeholder:o,accessibilityLabel:n,...c})]})}const r1=r.main`
  width: 70%;
  display: flex;
...
`,w=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],b=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],u1=[{input:"normal",type:"text",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:w},{input:"select",type:"text",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:b},{input:"normal",type:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],p1=[{label:"Mais salvos",value:"Mais salvos"},{label:"Menos salvos",value:"Menos salvos"},{label:"Mais comentários",value:"Mais comentários"},{label:"Menos comentários",value:"Menos comentários"},{label:"Mais recentes",value:"Mais recentes"},{label:"Mais antigos",value:"Mais antigos"}];function h1(){return e.jsxs(c1,{children:[e.jsxs(d1,{children:[e.jsx(L,{}),e.jsx(x,{backgroundColor:t.colors.white,color:t.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione os filtros...",accessibilityLabel:"Selecione a opção",children:b.map(i=>e.jsx(x.Item,{label:i.label,value:i.value},i.label))})]}),e.jsxs(C1,{children:[e.jsx(U,{}),e.jsx(x,{backgroundColor:t.colors.white,color:t.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione a ordenação...",accessibilityLabel:"Selecione a opção",children:p1.map(i=>e.jsx(x.Item,{label:i.label,value:i.value},i.label))})]})]})}const x1=r.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`;function Q1(){const[i,a]=u.useState(105),[o,n]=u.useState(!1);function s(A,d){A.preventDefault(),a(i+d)}function l(A){A.preventDefault(),n(!o)}function c(){switch(o){case!0:return e.jsx(Z,{size:"30",color:t.colors.darkBlue[400]});case!1:return e.jsx(R,{size:"30",color:t.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(x1,{children:[e.jsxs(f1,{children:[e.jsx("button",{id:"reactionButton",onClick:A=>s(A,1),children:e.jsx(P,{color:t.colors.muted[500],size:"md"})}),e.jsx("p",{children:i}),e.jsx("button",{id:"reactionButton",onClick:A=>s(A,-1),children:e.jsx(V,{color:t.colors.muted[500],size:"md"})}),e.jsx("button",{id:"markButton",onClick:A=>l(A),children:c()})]}),e.jsx(m1,{children:e.jsxs(N1,{children:[e.jsxs(g1,{children:[e.jsx(j,{bg:"emerald.600",marginRight:"0.8rem",size:"sm",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(v1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((A,d)=>e.jsx(D,{variant:"solid",bg:t.colors.tertiary[500],alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:A})},d))}),e.jsxs(b1,{children:[e.jsx(X,{size:"22"}),e.jsx("p",{children:"15"})]})]})})]}),e.jsx(E,{marginTop:"0.5rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const j1=r.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function w1(){return e.jsxs(j1,{children:[e.jsxs(D1,{children:[e.jsx(j,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(y1,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(k1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((i,a)=>e.jsx(D,{variant:"solid",bg:t.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:i})},a))})]})]})}const z1=r.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,U1=r.label`
  ...
  line-height: 1.5rem;
  color: ${t.colors.text[500]};
`;function P1({label:i="",inputType:a="text",placeholder:o,accessibilityLabel:n,size:s="md",fontSize:l="0.9rem",...c}){return e.jsxs(L1,{children:[i&&e.jsx(U1,{fontSize:l,children:i}),e.jsx(H,{type:a,variant:"outline",size:s,placeholder:o,accessibilityLabel:n,autoCompleteType:null,totalLines:5,maxLength:500,...c})]})}const V1=r.div`
  position: relative;
...
`;function M1(){const i=m();function a(o){o.preventDefault(),i("/login/logon")}return e.jsx(W1,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(J1,{}),e.jsxs("div",{className:"user-container",children:[e.jsx("h3",{className:"user-name",children:"Lucas"}),e.jsx(B1,{onClick:o=>a(o),children:e.jsx(G,{size:"2.5rem",color:t.colors.tertiary[300]})})]})]})})}const I1=r.div`
...
`;function Q(){return e.jsxs(I1,{children:[e.jsx(M1,{}),e.jsx("div",{className:"content",children:e.jsx(k,{})})]})}const F1=r.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function O1(){const i=m();function a(o){o.preventDefault(),i("/")}return e.jsxs(K1,{children:[e.jsx(N,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(h,{accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(h,{accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(C,{onPress:o=>a(o),variant:"solid",size:"lg",children:"Entrar"})]})]})}const Y1=r.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,$1="/UnBForumFront/assets/create-account-24b27e13.png";function _1(){return e.jsxs(Y1,{children:[e.jsx("img",{className:"create-account-image",src:$1,alt:""}),e.jsx("div",{className:"content",children:e.jsx(k,{})})]})}const e3=r.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function v({label:i,placeholder:a,options:o=[]}){return e.jsxs(t3,{children:[e.jsx("label",{className:"create-account-label",children:i}),e.jsx(x,{variant:"outline",height:9,size:"md",placeholder:a,accessibilityLabel:"Selecione a opção",children:o.map(n=>e.jsx(x.Item,{label:n.label,value:n.value},n.label))})]})}function i3(){const i=m();function a(n){n.preventDefault(),i("/login/logon")}function o(n){switch(n.input){case"select":return e.jsx(v,{label:n.label,placeholder:n.placeholder,options:n.options,accessibilityLabel:n.accessibilityLabel},n.label);default:return e.jsx(h,{label:n.label,placeholder:n.placeholder,inputType:n.type,accessibilityLabel:n.accessibilityLabel},n.label)}}return e.jsxs(e3,{children:[e.jsx(N,{}),e.jsxs("div",{className:"inputs-container",children:[u1.map(n=>o(n)),e.jsx(C,{onPress:n=>a(n),variant:"solid",size:"lg",children:"Criar Conta"})]})]})}const n3=r.section`
  width: 80%;
...
`;function r3(){return e.jsxs(n3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(N,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(h,{label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(h,{label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(v,{label:"Papel na Instituição",placeholder:"Selecione o seu papel na instituição...",options:w,accessibilityLabel:"Selecione o seu papel na instituição..."}),e.jsx(v,{label:"Curso",placeholder:"Selecione seu curso...",options:b,accessibilityLabel:"Selecione seu curso..."}),e.jsx(h,{label:"Senha",placeholder:"Digite sua senha",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),e.jsx(C,{variant:"solid",size:"lg",children:"Editar Perfil"}),e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(C,{variant:"subtle",size:"md",children:"Sair"}),e.jsx(C,{variant:"subtle",size:"md",children:"Deletar a Conta"})]})]})]})}function o3(){return e.jsxs(K,{children:[e.jsx(p,{path:"/",element:e.jsx(Q,{}),children:e.jsx(p,{path:"/",element:e.jsx(H1,{})})}),e.jsx(p,{path:"/profile",element:e.jsx(Q,{}),children:e.jsx(p,{path:"/profile",element:e.jsx(r3,{})})}),e.jsxs(p,{path:"/login",element:e.jsx(_1,{}),children:[e.jsx(p,{path:"/login",element:e.jsx(O1,{})}),e.jsx(p,{path:"/login/logon",element:e.jsx(G1,{})}),e.jsx(p,{path:"/login/create-account",element:e.jsx(i3,{})})]})]})}const s3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},a3=O`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function l3(){const i={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(a){return console.log(a),"light"}},set:async a=>{try{localStorage.setItem("@UnBForum:theme",a)}catch(o){console.log(o)}}};return e.jsx(Y,{colorModeManager:i,children:e.jsxs($,{theme:s3,children:[e.jsx(_,{children:e.jsx(o3,{})}),e.jsx(a3,{})]})})}e1.createRoot(document.getElementById("root")).render(e.jsx(t1.StrictMode,{children:e.jsx(l3,{})}));
