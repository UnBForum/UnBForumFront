import{s as A,t as i,j as e,I as x1,F as g1,S as V,P as N1,n as $,B as x,u as P,r as c,A as v1,a as b1,b as o1,c as a1,d as j1,D as y1,e as Q1,f as D1,T as w1,g as X,h as _,V as k1,H as e1,i as t1,k as S1,C as G,l as z1,m as U1,o as L1,p as l1,q as T1,v as q1,w as P1,x as E1,y as V1,z as s1,M as J,E as X1,G as R1,J as Z1,K as H1,O as c1,L as K,N as J1,R as W1,Q as T,U as I1,W as B1,X as M1,Y as F1,Z as G1,_ as K1}from"./vendor-8a6468e5.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(r){if(r.ep)return;r.ep=!0;const l=n(r);fetch(r.href,l)}})();const O1=A.div`
  width: 100%;
  display: flex;
...
`;function q({label:t="",inputType:s="text",placeholder:n,accessibilityLabel:o,size:r="md",fontSize:l="0.9rem",name:a,isRequired:p=!0,isEditing:d=!0,value:f=void 0,onChange:u,...C}){return e.jsxs(O1,{children:[t&&e.jsxs(Y1,{fontSize:l,children:[t,p&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(x1,{type:s,variant:d?"outline":"filled",size:r,isRequired:p,value:f,placeholder:n,editable:d,accessibilityLabel:o,onChangeText:h=>u(a,h),...C})]})}const $1=A.main`
  width: 70%;
  display: flex;
...
`,ae=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],d1=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],le=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:ae},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:d1},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],ce=[{label:"Mais salvos",value:"Mais salvos"},{label:"Menos salvos",value:"Menos salvos"},{label:"Mais comentários",value:"Mais comentários"},{label:"Menos comentários",value:"Menos comentários"},{label:"Mais recentes",value:"Mais recentes"},{label:"Mais antigos",value:"Mais antigos"}];function de(){return e.jsxs(ie,{children:[e.jsxs(re,{children:[e.jsx(g1,{}),e.jsx(V,{backgroundColor:i.colors.white,color:i.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione os filtros...",accessibilityLabel:"Selecione a opção",children:d1.map(t=>e.jsx(V.Item,{label:t.label,value:t.value},t.label))})]}),e.jsxs(oe,{children:[e.jsx(N1,{}),e.jsx(V,{backgroundColor:i.colors.white,color:i.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione a ordenação...",accessibilityLabel:"Selecione a opção",children:ce.map(t=>e.jsx(V.Item,{label:t.label,value:t.value},t.label))})]})]})}const Ae=(t,s)=>t?"0.9rem":s?"1rem":"0.9rem",ue=(t,s)=>t?"0.7rem":s?"0.8rem":"0.7rem",pe=A.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,fe=A.div`
  ...
  & > p {
    ...
    font-size: ${({isComment:t,isInsideTopic:s})=>Ae(t,s)};
    color: ${i.colors.black};
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:s})=>ue(t,s)};
      line-height: 1.7;
    }
...
`;function F({id:t,isInsideTopic:s=!1,isComment:n=!1,title:o,author:r,content:l,categories:a,commentsCount:p=0}){const d=P(),[f,u]=c.useState(105),[C,h]=c.useState(!1);function m(){d(`/topic/${t}`)}function N(g){const b=g.split(" ");if(b.length>=2){const w=b[0],E=b[b.length-1],Z=w[0],R=E[0];return Z.toUpperCase()+R.toUpperCase()}else return b[0][0].toUpperCase()}function Q(g,b){g.preventDefault(),u(f+b)}function v(g){g.preventDefault(),h(!C)}function U(){switch(C){case!0:return e.jsx(D1,{size:"30",color:i.colors.darkBlue[400]});case!1:return e.jsx(Q1,{size:"30",color:i.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(pe,{children:[e.jsxs(he,{isInsideTopic:s,isComment:n,children:[e.jsx("button",{id:"reactionButton",onClick:g=>Q(g,1),children:e.jsx(v1,{color:i.colors.muted[500],size:"18"})}),e.jsx("p",{children:f}),e.jsx("button",{id:"reactionButton",onClick:g=>Q(g,-1),children:e.jsx(b1,{color:i.colors.muted[500],size:"18"})}),!n&&e.jsx("button",{id:"markButton",onClick:g=>v(g),children:U()})]}),e.jsx(Ce,{children:e.jsxs(fe,{isInsideTopic:s,isComment:n,children:[s&&e.jsx("h1",{id:"post-title",children:o}),e.jsxs(me,{isInsideTopic:s,children:[e.jsx(o1,{bg:n?"lime.600":"emerald.600",marginRight:"0.8rem",size:n?"xs":"sm",children:N(r)}),e.jsxs("p",{children:[r,!s&&!n&&` - ${o}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:l.replace(/\n/g,"<br>")}}),!n&&e.jsx(xe,{children:a.map(g=>e.jsx(a1,{variant:"solid",bg:g.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:g.name})},g.id))}),!s&&!n&&e.jsx(ge,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:"1rem"},isInsideTopic:s,onPress:s?()=>{}:()=>m(),rightIcon:e.jsx(j1,{size:"22",color:i.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${p})`})]})})]}),e.jsx(y1,{alignSelf:"flex-end",width:n?"95%":"100%",marginTop:s?"0rem":"0.5rem",height:n||!s?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const Ne=A.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function ye(){return e.jsxs(Ne,{children:[e.jsxs(ve,{children:[e.jsx(o1,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(be,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(je,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,s)=>e.jsx(a1,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},s))})]})]})}const Qe=A.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function Ue({label:t="",inputType:s="text",placeholder:n,accessibilityLabel:o,size:r="md",fontSize:l="0.9rem",isRequired:a=!0,isEditing:p=!0,name:d,value:f=void 0,onChange:u,...C}){return e.jsxs(Se,{children:[t&&e.jsxs(ze,{fontSize:l,children:[t,a&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(w1,{type:s,variant:p?"outline":"filled",size:r,placeholder:n,accessibilityLabel:o,editable:p,onChangeText:h=>u(d,h),autoCompleteType:null,value:f,totalLines:5,maxLength:700,...C})]})}const Le=A.div`
  position: relative;
...
`,j=({id:t,status:s,variant:n="left-accent",title:o,description:r,isClosable:l=!1,...a})=>{const p=X();return e.jsx(_,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:s||"error",variant:n,...a,children:e.jsxs(k1,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(e1,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(e1,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(_.Icon,{}),e.jsx(t1,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:n==="solid"?"lightText":n!=="outline"?"darkText":null,children:o})]}),l?e.jsx(S1,{variant:"unstyled",icon:e.jsx(G,{size:"3"}),_icon:{color:n==="solid"?"lightText":"darkText"},onPress:()=>p.close(t)}):null]}),e.jsx(t1,{px:"6",color:n==="solid"?"lightText":n!=="outline"?"darkText":null,children:r})]})})};function Pe({handleAddFile:t,handleDeleteFile:s,files:n,fileInputRef:o,filesUploadLimit:r=2}){const l=X(),a=f=>{const u=f.target.files&&f.target.files[0];u&&n.length+1<=r?(console.log("Arquivo selecionado:",u.name),console.log("Arquivos:",n),t(u.name)):l.show({placement:"top",render:()=>e.jsx(j,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},p=()=>{const f=[];return n.forEach((u,C)=>{f.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>s(u),children:e.jsx(z1,{size:"1.7rem",color:i.colors.primary[50]})}),e.jsx(U1,{size:"38",color:i.colors.gray[500]}),u]},C))}),f},d=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(Le,{children:[e.jsx(Te,{fontSize:"1.2rem",children:`Arquivos (${n.length}/${r} arquivos adicionados)`}),e.jsx("input",{ref:o,id:"file-upload",type:"file",style:{display:"none"},onChange:a}),e.jsx(qe,{children:n.length>0?p():d()})]})})}const Ee=t=>{let s=!0;const n=[],{title:o,content:r}=t;return(!o||o==="")&&(s=!1,n.push("Título")),(!r||r==="")&&(s=!1,n.push("Conteúdo")),{isValid:s,fieldErrors:n}},S=L1.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),Ve=async()=>await S.get("topics"),Xe=async t=>await S.get(`topics/${t}`),Re=async t=>await S.post("topics",t);function Ze({isModalOpen:t,setIsModalOpen:s}){const n=X(),o=c.useRef(null),[r,l]=c.useState(!1),[a,p]=c.useState({title:"",content:"",files:[]}),[d,f]=c.useState(!1);c.useEffect(()=>console.log(a),[a]),c.useEffect(()=>{l(t)},[t]);const u=c.useCallback((v,U)=>{p({...a,[v]:U})},[a]),C=v=>{v.preventDefault();const{isValid:U,fieldErrors:g}=Ee(a);if(!U){n.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${g.reduce((b,w,E)=>E===0?`'${w}'`:E===g.length-1?`${b} e '${w}'`:`${b}, '${w}'`,"")}`,status:""})});return}f(!0),Re(a).then(b=>{n.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),h(),p({title:"",content:"",files:[]})}).catch(b=>{n.show({placement:"top-right",render:()=>{let w="";return typeof b.response.data.detail=="object"?w=b.response.data.detail[0].msg.split(", ")[1]:w=b.response.data.detail,e.jsx(j,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${w}`,status:""})}})}).finally(()=>{f(!1)})},h=()=>{l(!1),setTimeout(()=>{s(!1)},300)},m=c.useCallback(v=>{p({...a,files:[...a.files,v]})},[a]),N=c.useCallback(v=>{const U=a.files.filter(g=>g!==v);p({...a,files:U})},[a]),Q=()=>{o&&o.current&&o.current.click()};return e.jsx(e.Fragment,{children:r&&e.jsx(Qe,{isOpen:r,onClick:h,children:e.jsxs(De,{isOpen:r,onClick:v=>v.stopPropagation(),children:[e.jsx(ke,{onClick:h,children:e.jsx(G,{size:"2rem",color:i.colors.primary[50]})}),e.jsx("h1",{children:"Novo Tópico"}),e.jsx(q,{name:"title",onChange:u,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(Ue,{name:"content",onChange:u,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(Pe,{filesUploadLimit:2,fileInputRef:o,handleAddFile:m,handleDeleteFile:N,files:a.files}),e.jsxs(we,{children:[e.jsx(x,{onPress:()=>Q(),size:"md",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(l1,{}),children:"Adicionar arquivos"}),e.jsx(x,{id:"create-topic-button",onPress:v=>C(v),bgColor:i.colors.success[600],size:"md",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:d,rightIcon:e.jsx(T1,{}),children:"Criar"})]})]})})})}const He=A.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;const u1=c.createContext(null),Be=({children:t})=>{const[s,n]=c.useState(""),[o,r]=c.useState([]),[l,a]=c.useState(""),[p,d]=c.useState("");c.useEffect(()=>{const C=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",C),C){const h=s1(C.split(" ")[1]);S.defaults.headers.common.Authorization=`${C}`,n(C.split(" ")[1]),r(h.scopes),a(h.sub),d(h.name)}},[]);const f=c.useCallback(C=>{localStorage.setItem("@UnBForum:token",`Bearer ${C}`);const h=s1(C);S.defaults.headers.common.Authorization=`Bearer ${C}`,n(C),r(h.scopes),a(h.sub),d(h.name)},[]),u=c.useCallback(()=>{n(""),r([]),a(""),d(""),localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(u1.Provider,{value:{token:s,name:p,email:l,scopes:o,changeToken:f,logoutUser:u,setName:d},children:t})};function W(){const t=c.useContext(u1);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}function Me(){const t=P(),{token:s}=W();return e.jsxs(J,{w:"190",trigger:n=>e.jsx(x,{variant:"solid",_hover:{shadow:"8"},rightIcon:e.jsx(X1,{size:30,color:i.colors.white}),onPress:()=>{},...n}),children:[e.jsx(J.Item,{_focus:{},onPress:()=>t("/"),children:"Feed"}),s&&e.jsx(J.Item,{onPress:()=>t("/profile"),children:"Perfil"}),!s&&e.jsx(J.Item,{onPress:()=>t("/login/logon"),children:"Entrar"})]})}function Fe(){const{name:t,token:s}=W(),n=P(),o=R1("(max-width: 768px)");function r(a){a.preventDefault(),n("/profile")}function l(a){a.preventDefault(),n("/login/logon")}return e.jsx(Ie,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(We,{}),e.jsxs("div",{className:"user-container",children:[s&&!o&&e.jsx(e.Fragment,{children:e.jsx(x,{onPress:a=>r(a),rightIcon:e.jsx(Z1,{size:"30",color:i.colors.tertiary[300]}),children:o?"":t})}),!s&&!o&&e.jsx(e.Fragment,{children:e.jsx(x,{variant:"solid",bgColor:i.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(H1,{size:30,color:i.colors.white}),onPress:a=>l(a),children:o?"":"Entrar"})}),e.jsx(Me,{})]})]})})}const Ge=A.div`
...
`;function n1(){return e.jsxs(Ge,{children:[e.jsx(Fe,{}),e.jsx("div",{className:"content",children:e.jsx(c1,{})})]})}const Ke=A.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,$e=t=>{let s=!0;const n=[],{email:o,password:r}=t;return(!o||o==="")&&(s=!1,n.push("Email Institucional")),(!r||r==="")&&(s=!1,n.push("Senha")),{isValid:s,fieldErrors:n}},_e=async t=>{const{username:s,password:n}=t,o=new FormData;return o.append("username",s),o.append("password",n),await S.post("auth/login",o)},e3=t=>{const{email:s,password:n}=t;return{username:s,password:n}};function t3(){const t=P(),s=X(),{changeToken:n}=W(),[o,r]=c.useState({email:"",password:""}),[l,a]=c.useState(!1),p=c.useCallback((f,u)=>{r({...o,[f]:u})},[o]);function d(f){f.preventDefault();const{isValid:u,fieldErrors:C}=$e(o);if(!u){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${C.reduce((h,m,N)=>N===0?`'${m}'`:N===C.length-1?`${h} e '${m}'`:`${h}, '${m}'`,"")}`,status:""})});return}a(!0),_e(e3(o)).then(h=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:"Usuário logado com sucesso!",status:"success"})}),n(h.data.access_token),t("/")}).catch(h=>{s.show({placement:"top-right",render:()=>{let m="";return typeof h.response.data.detail=="object"?m=h.response.data.detail[0].msg.split(", ")[1]:m=h.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${m}`,status:""})}})}).finally(()=>{a(!1)})}return e.jsxs(Ye,{children:[e.jsx(I,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(q,{name:"email",onChange:p,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(q,{name:"password",onChange:p,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(x,{onPress:f=>d(f),variant:"solid",size:"lg",isLoading:l,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(x,{onPress:f=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const s3=A.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`;function a3({label:t,placeholder:s,options:n=[],onChange:o,isRequired:r=!0,fontSize:l="0.9rem",isEditing:a=!0,name:p}){return e.jsxs(o3,{fontSize:l,children:[e.jsxs("label",{className:"create-account-label",children:[t,r&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(V,{variant:"outline",height:9,size:"md",isDisabled:!a,onValueChange:d=>o(p,d),placeholder:s,accessibilityLabel:"Selecione a opção",children:n.map(d=>e.jsx(V.Item,{label:d.label,value:d.value},d.label))})]})}const l3=async t=>await S.post("users",t),i1=async()=>await S.get("users/me"),c3=async t=>await S.patch("users/me",t),d3=async t=>await S.post("users/me/change_password",t),A3=async()=>await S.delete("users/me"),u3=t=>{let s=!0;const n=[],{name:o,email:r,profile:l,course:a,password:p,passwordConfirm:d}=t;return(!o||o==="")&&(s=!1,n.push("Nome Completo")),(!r||r==="")&&(s=!1,n.push("Email Institucional")),(!l||l==="")&&(s=!1,n.push("Papel na Instituição")),(!a||a==="")&&(s=!1,n.push("Curso")),(!p||p==="")&&(s=!1,n.push("Senha")),(!d||d===""||d!==p)&&(s=!1,n.push("Confirme a senha")),{isValid:s,fieldErrors:n}},p3=t=>{const{name:s,email:n,profile:o,course:r,password:l}=t;return{name:s,email:n,password:l,tags:[o,r]}};function h3(){const t=P(),s=X(),n=K({lg:"lg",base:"md"}),[o,r]=c.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[l,a]=c.useState(!1),p=c.useCallback((u,C)=>{r({...o,[u]:C})},[o]),d=async u=>{u.preventDefault();const{isValid:C,fieldErrors:h}=u3(o);if(console.log(o),!C){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${h.reduce((m,N,Q)=>Q===0?`'${N}'`:Q===h.length-1?`${m} e '${N}'`:`${m}, '${N}'`,"")}`,status:""})});return}a(!0),l3(p3(o)).then(m=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(m=>{s.show({placement:"top-right",render:()=>{let N="";return typeof m.response.data.detail=="object"?N=m.response.data.detail[0].msg.split(", ")[1]:N=m.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${N}`,status:""})}})}).finally(()=>{a(!1)})};function f(u){switch(u.input){case"select":return e.jsx(a3,{label:u.label,placeholder:u.placeholder,options:u.options,name:u.name,onChange:p,accessibilityLabel:u.accessibilityLabel},u.label);default:return e.jsx(q,{label:u.label,placeholder:u.placeholder,inputType:u.type,name:u.name,onChange:p,accessibilityLabel:u.accessibilityLabel},u.label)}}return e.jsxs(r3,{children:[e.jsx(I,{}),e.jsxs("div",{className:"inputs-container",children:[le.map(u=>f(u)),e.jsx(x,{onPress:u=>d(u),variant:"solid",size:n,isLoading:l,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(x,{onPress:u=>t(-1),variant:"outline",size:n,children:"Voltar"})]})]})}const C3=A.section`
  width: 80%;
...
`,f3=t=>{let s=!0;const n=[];return(!t||t==="")&&(s=!1,n.push("Nome Completo")),{isValid:s,fieldErrors:n}},m3=(t,s)=>{let n=!0;const o=[];let r="";return(!t||t==="")&&(n=!1,o.push("Senha Atual")),(!s||s==="")&&(n=!1,o.push("Nova Senha")),!s&&s===t&&(n=!1,r="Nova senha não pode ser a mesma que a atual"),{isValid:n,fieldErrors:o,specialError:r}},x3=A.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function r1({question:t,handleAccept:s,handleClose:n,cancelText:o="Cancelar",acceptText:r,isOpen:l,isLoadingAcceptButton:a=!1,loadingAcceptButtonText:p=""}){const d=K({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:l&&e.jsx(x3,{children:e.jsxs(g3,{children:[e.jsx(N3,{onClick:n,children:e.jsx(G,{size:"21",color:i.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(x,{size:d,variant:"outline",onPress:n,children:o}),e.jsx(x,{size:d,onPress:s,bgColor:i.colors.danger[500],isLoading:a,isLoadingText:p,children:r})]})]})})})}function v3(){const t=P(),s=X(),{name:n,email:o,setName:r,logoutUser:l}=W(),a=K({lg:"lg",base:"md"}),[p,d]=c.useState(!1),[f,u]=c.useState(!1),[C,h]=c.useState(!1),[m,N]=c.useState(!1),[Q,v]=c.useState({email:o,id:0,name:n,role:"",tags:[]}),[U,g]=c.useState(!1),[b,w]=c.useState(!1),[E,Z]=c.useState(!1),[R,H]=c.useState(""),[O,B]=c.useState("");c.useEffect(()=>{i1().then(y=>{v(y.data),r(y.data.name)})},[r]);const p1=c.useCallback((y,k)=>{v({...Q,[y]:k})},[Q]),h1=c.useCallback(()=>{w(!0),A3().then(()=>{}).finally(()=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"delete-user-success",title:"Usuário deletado!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),l(),w(!1),u(!1),t("/")})},[t,l,s]),C1=y=>{y.preventDefault();const{fieldErrors:k,isValid:M}=f3(Q.name);if(!M){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${k.reduce((L,D,z)=>z===0?`'${D}'`:z===k.length-1?`${L} e '${D}'`:`${L}, '${D}'`,"")}`,status:""})});return}g(!0),c3({name:Q.name}).then(L=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),r(Q.name)}).catch(L=>{s.show({placement:"top-right",render:()=>{let D="";return typeof L.response.data.detail=="object"?D=L.response.data.detail[0].msg.split(", ")[1]:D=L.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${D}`,status:""})}})}).finally(()=>{g(!1),h(!1)})},f1=y=>{y.preventDefault();const{fieldErrors:k,isValid:M,specialError:L}=m3(R,O);if(!M){s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:k.length>0?`Os sequintes campos estão incorretos: ${k.reduce((D,z,Y)=>Y===0?`'${z}'`:Y===k.length-1?`${D} e '${z}'`:`${D}, '${z}'`,"")}`:L,status:""})});return}Z(!0),d3({current_password:R,new_password:O}).then(D=>{s.show({placement:"top-right",render:()=>e.jsx(j,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(D=>{s.show({placement:"top-right",render:()=>{let z="";return typeof D.response.data.detail=="object"?z=D.response.data.detail[0].msg.split(", ")[1]:z=D.response.data.detail,e.jsx(j,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${z}`,status:""})}})}).finally(()=>{Z(!1),N(!1),H(""),B("")})},m1=()=>C?e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:a,onPress:()=>{h(!1),i1().then(y=>{v(y.data)})},children:"Cancelar"}),e.jsx(x,{variant:"outline",size:a,isLoading:U,isLoadingText:"Atualizando Usuário...",onPress:y=>C1(y),children:"Atualizar Usuário"})]}):m?e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:a,onPress:()=>{N(!1),H(""),B("")},children:"Cancelar"}),e.jsx(x,{variant:"outline",size:a,isLoading:E,isLoadingText:"Atualizando Senha...",onPress:y=>f1(y),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:a,onPress:()=>h(!0),children:"Editar Perfil"}),e.jsx(x,{variant:"outline",size:a,onPress:()=>N(!0),children:"Alterar Senha"})]});return e.jsxs(C3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(I,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(q,{name:"name",onChange:p1,isEditing:C,value:Q.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(q,{name:"email",onChange:()=>{},isEditing:!1,value:Q.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(q,{name:"password",onChange:(y,k)=>H(k),isEditing:m,value:m?R:"valordeteste",label:m?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),m&&e.jsx(q,{name:"passwordConfirm",onChange:(y,k)=>B(k),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),m1(),!C&&!m&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(x,{variant:"subtle",size:"md",onPress:()=>d(!0),children:"Sair"}),e.jsx(x,{variant:"subtle",size:"md",onPress:()=>u(!0),children:"Deletar a Conta"})]})]}),e.jsx(r1,{isOpen:p,handleAccept:()=>{d(!1),l(),t("/")},handleClose:()=>d(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(r1,{isOpen:f,handleAccept:()=>{h1()},handleClose:()=>u(!1),question:"Tem certeza que deseja deletar sua conta?",acceptText:"Deletar",isLoadingAcceptButton:b,loadingAcceptButtonText:"Deletando..."})]})}const b3=A.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`;function y3(){const{id:t}=J1(),[s,n]=c.useState(null),[o,r]=c.useState(!1);return c.useEffect(()=>window.scrollTo(0,0),[]),c.useEffect(()=>{t&&(r(!0),Xe(Number(t)).then(l=>{n(l.data)}).finally(()=>r(!1)))},[t]),e.jsx(b3,{children:s?e.jsxs(e.Fragment,{children:[e.jsx(F,{id:Number(s.id),author:s.author.name,title:s.title,categories:s.categories,content:s.content,isInsideTopic:!0}),e.jsx(j3,{children:Array.from({length:10},(l,a)=>a).map(l=>e.jsx(F,{id:l,isComment:!0,author:"Lucas",title:"",content:"",categories:[]},l))})]}):e.jsx(A1,{accessibilityLabel:"Carregando dados do tópico..."})})}function Q3(){return e.jsxs(W1,{children:[e.jsxs(T,{path:"/",element:e.jsx(n1,{}),children:[e.jsx(T,{path:"/",element:e.jsx(Je,{})}),e.jsx(T,{path:"/topic/:id",element:e.jsx(y3,{})})]}),e.jsx(T,{path:"/profile",element:e.jsx(n1,{}),children:e.jsx(T,{path:"/profile",element:e.jsx(v3,{})})}),e.jsxs(T,{path:"/login",element:e.jsx(i3,{}),children:[e.jsx(T,{path:"/login",element:e.jsx(t3,{})}),e.jsx(T,{path:"/login/logon",element:e.jsx(Oe,{})}),e.jsx(T,{path:"/login/create-account",element:e.jsx(h3,{})})]})]})}const D3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},w3=I1`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function k3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(s){return console.log(s),"light"}},set:async s=>{try{localStorage.setItem("@UnBForum:theme",s)}catch(n){console.log(n)}}};return e.jsx(B1,{colorModeManager:t,children:e.jsx(M1,{theme:D3,children:e.jsxs(Be,{children:[e.jsx(F1,{children:e.jsx(Q3,{})}),e.jsx(w3,{})]})})})}G1.createRoot(document.getElementById("root")).render(e.jsx(K1.StrictMode,{children:e.jsx(k3,{})}));
