import{s as A,t as r,j as e,I as b1,u as M,F as j1,S as I,P as y1,n as o1,B as x,a as Q1,r as d,b as i1,c as V,A as a1,V as w1,H as l1,T as c1,d as D1,C as t1,e as J,f as k1,g as z1,h as s1,D as $,i as p1,k as S1,l as U1,m as L1,o as T1,p as q1,q as P1,v as h1,w as E1,x as V1,y as X1,z as R1,E as Z1,G as H1,M as G,J as J1,K as I1,L as W1,O as m1,N as n1,Q as B1,R as F1,U as M1,W as P,X as O1,Y as G1,Z as K1,_ as Y1,$ as $1,a0 as _1}from"./vendor-5e3041ef.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const a of c.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(o){if(o.ep)return;o.ep=!0;const c=n(o);fetch(o.href,c)}})();const ee=A.div`
  width: 100%;
  display: flex;
...
`;function E({label:t="",inputType:s="text",placeholder:n,accessibilityLabel:i,size:o="md",fontSize:c="0.9rem",name:a,isRequired:u=!0,isEditing:p=!0,value:f=void 0,onChange:l,...h}){return e.jsxs(ee,{children:[t&&e.jsxs(te,{fontSize:c,children:[t,u&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(b1,{type:s,variant:p?"outline":"filled",size:o,isRequired:u,value:f,placeholder:n,editable:p,accessibilityLabel:i,onChangeText:m=>l(a,m),...h})]})}const se=A.main`
  width: 70%;
  display: flex;
...
`,Ae=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],f1=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],ue=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:Ae},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:f1},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],pe=[{label:"Mais salvos",value:"Mais salvos"},{label:"Menos salvos",value:"Menos salvos"},{label:"Mais comentários",value:"Mais comentários"},{label:"Menos comentários",value:"Menos comentários"},{label:"Mais recentes",value:"Mais recentes"},{label:"Mais antigos",value:"Mais antigos"}];function he(){const t=M("(max-width: 768px)");return e.jsxs(le,{children:[e.jsxs(ce,{children:[e.jsx(j1,{size:20,color:r.colors.tertiary[300]}),e.jsx(I,{backgroundColor:r.colors.white,color:r.colors.black,variant:"outline",height:9,size:t?"sm":"lg",placeholder:"Selecione os filtros...",accessibilityLabel:"Selecione a opção",children:f1.map(s=>e.jsx(I.Item,{label:s.label,value:s.value},s.label))})]}),e.jsxs(de,{children:[e.jsx(y1,{size:22,color:r.colors.tertiary[300]}),e.jsx(I,{backgroundColor:r.colors.white,color:r.colors.black,variant:"outline",height:9,size:t?"sm":"lg",placeholder:"Selecione a ordenação...",accessibilityLabel:"Selecione a opção",children:pe.map(s=>e.jsx(I.Item,{label:s.label,value:s.value},s.label))})]})]})}const me=(t,s)=>t?"0.9rem":s?"1rem":"0.9rem",fe=(t,s)=>t?"0.7rem":s?"0.8rem":"0.7rem",Ce=A.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,Ne=A.div`
  ...
  & > p {
    ...
    font-size: ${({isComment:t,isInsideTopic:s})=>me(t,s)};
    color: ${r.colors.black};
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:s})=>fe(t,s)};
      line-height: 1.7;
    }
...
`;const N=Q1.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),ye=async()=>await N.get("topics"),Qe=async t=>await N.get(`topics/${t}`),we=async t=>await N.post("topics",t),De=async t=>await N.post(`topics/${t}/upvote`),ke=async t=>await N.post(`topics/${t}/downvote`),C1=d.createContext(null),ze=({children:t})=>{const[s,n]=d.useState(""),[i,o]=d.useState([]),[c,a]=d.useState(""),[u,p]=d.useState("");d.useEffect(()=>{const h=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",h),h){const m=i1(h.split(" ")[1]);N.defaults.headers.common.Authorization=`${h}`,n(h.split(" ")[1]),o(m.scopes),a(m.sub),p(m.name)}},[]);const f=d.useCallback(h=>{localStorage.setItem("@UnBForum:token",`Bearer ${h}`);const m=i1(h);N.defaults.headers.common.Authorization=`Bearer ${h}`,n(h),o(m.scopes),a(m.sub),p(m.name)},[]),l=d.useCallback(()=>{n(""),o([]),a(""),p(""),N.defaults.headers.common.Authorization=null,localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(C1.Provider,{value:{token:s,name:u,email:c,scopes:i,changeToken:f,logoutUser:l,setName:p},children:t})};function X(){const t=d.useContext(C1);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}const g=({id:t,status:s,variant:n="left-accent",title:i,description:o,isClosable:c=!1,...a})=>{const u=V();return e.jsx(a1,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:s||"error",variant:n,...a,children:e.jsxs(w1,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(l1,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(l1,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(a1.Icon,{}),e.jsx(c1,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:n==="solid"?"lightText":n!=="outline"?"darkText":null,children:i})]}),c?e.jsx(D1,{variant:"unstyled",icon:e.jsx(t1,{size:"3"}),_icon:{color:n==="solid"?"lightText":"darkText"},onPress:()=>u.close(t)}):null]}),e.jsx(c1,{px:"6",color:n==="solid"?"lightText":n!=="outline"?"darkText":null,children:o})]})})},Se=async(t,s)=>await N.post(`topics/${s}/comments/`,{content:t}),Ue=async t=>await N.get(`topics/${t}/comments/`),Le=async(t,s)=>await N.post(`topics/${s}/comments/${t}/upvote`),Te=async(t,s)=>await N.post(`topics/${s}/comments/${t}/downvote`),qe=t=>`https://unbforum-backend-4b05406a8bbf.herokuapp.com/files/download/${t.upload_path}`;function x1(t){const s=t.split(" ");if(s.length>=2){const n=s[0],i=s[s.length-1],o=n[0],c=i[0];return o.toUpperCase()+c.toUpperCase()}else return s[0][0].toUpperCase()}function _({id:t,isInsideTopic:s=!1,isComment:n=!1,title:i="",author:o,content:c,topicId:a=null,currentRating:u=0,rating:p=0,files:f=[],categories:l=[],commentsCount:h=0}){const{token:m}=X(),C=V(),v=J(),j=M("(max-width: 768px)"),[R,Z]=d.useState(p),[H,y]=d.useState(!1),[D,U]=d.useState(u);d.useEffect(()=>{U(u),Z(p)},[u,p]);function z(){v(`/topic/${t}`)}const k=()=>{C.show({placement:"top-right",render:()=>e.jsx(g,{id:"user-unlogged-error",title:"Opa!",description:"Para interagir com um tópico ou comentário, você precisa fazer login!",status:""})})};async function T(b,B){if(b.preventDefault(),!m){k();return}if(B>0){const F=await(n?Le(t,a):De(t));Z(F.data.rating),U(D>0?0:1)}else{const F=await(n?Te(t,a):ke(t));Z(F.data.rating),U(D<0?0:-1)}}function O(b){b.preventDefault(),y(!H)}function W(){switch(H){case!0:return e.jsx(L1,{size:"30",color:r.colors.darkBlue[400]});case!1:return e.jsx(U1,{size:"30",color:r.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(Ce,{children:[e.jsxs(xe,{isInsideTopic:s,isComment:n,children:[e.jsx("button",{id:"reactionButton",onClick:b=>T(b,1),children:e.jsx(k1,{color:D>0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),e.jsx("p",{children:R}),e.jsx("button",{id:"reactionButton",onClick:b=>T(b,-1),children:e.jsx(z1,{color:D<0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),!n&&e.jsx("button",{id:"markButton",onClick:b=>O(b),children:W()})]}),e.jsx(ge,{children:e.jsxs(Ne,{isInsideTopic:s,isComment:n,children:[s&&e.jsx("h1",{id:"post-title",children:i}),e.jsxs(ve,{isInsideTopic:s,children:[e.jsx(s1,{bg:n?"lime.600":"emerald.600",marginRight:"0.8rem",size:n?"xs":"sm",children:x1(o)}),e.jsxs("p",{children:[o,!s&&!n&&` - ${i}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:c.replace(/\n/g,"<br>")}}),f.length>0&&e.jsx($,{width:"80%"}),f.map((b,B)=>e.jsxs("span",{children:["Para acessar o arquivo ",`${B+1}: `,e.jsx("a",{href:qe(b),target:"_blank",rel:"noreferrer",children:"clique aqui"})]},b.id)),!n&&e.jsx(be,{children:l.map(b=>e.jsx(p1,{variant:"solid",bg:b.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:b.name})},b.id))}),!s&&!n&&e.jsx(je,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:j?"0.8rem":"1rem"},isInsideTopic:s,onPress:s?()=>{}:()=>z(),rightIcon:e.jsx(S1,{size:j?"18":"20",color:r.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${h})`})]})})]}),e.jsx($,{alignSelf:"flex-end",width:n?"95%":"100%",marginTop:s?"0rem":"0.5rem",height:n||!s?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const Pe=A.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function Re(){return e.jsxs(Pe,{children:[e.jsxs(Ee,{children:[e.jsx(s1,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(Ve,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(Xe,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,s)=>e.jsx(p1,{variant:"solid",bg:r.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},s))})]})]})}const Ze=A.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function g1({label:t="",inputType:s="text",placeholder:n,accessibilityLabel:i,size:o="md",fontSize:c="0.9rem",isRequired:a=!0,isEditing:u=!0,name:p,isComment:f=!1,value:l=void 0,onChange:h,...m}){return e.jsxs(We,{isComment:f,children:[t&&e.jsxs(Be,{fontSize:c,children:[t,a&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(T1,{type:s,variant:u?"outline":"filled",size:o,placeholder:n,accessibilityLabel:i,editable:u,onChangeText:C=>h(p,C),autoCompleteType:null,value:l,totalLines:5,maxLength:700,...m})]})}const Fe=A.div`
  position: relative;
...
`,Ge=async t=>{const s=new FormData;return s.append("files",t),console.log(s),await N.post("files/upload/",s,{headers:{"Content-Type":t.type}})};function Ke({handleAddFile:t,handleDeleteFile:s,files:n,fileInputRef:i,filesUploadLimit:o=2,setIsAddFileLoading:c}){const a=V(),u=async l=>{const h=l.target.files&&l.target.files[0];h&&n.length+1<=o?(console.log("tentando subir arquivo1"),c(!0),console.log("tentando subir arquivo2"),Ge(h).then(m=>{console.log(m.data[0]),t(m.data[0])}).catch(m=>{a.show({placement:"top",render:()=>e.jsx(g,{id:"files-upload-error",status:"error",title:"Opa!",description:"Erro ao fazer upload do arquivo."})})}).finally(()=>{c(!1)})):a.show({placement:"top",render:()=>e.jsx(g,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},p=()=>{const l=[];return n.forEach((h,m)=>{l.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>s(h.name),children:e.jsx(q1,{size:"1.7rem",color:r.colors.primary[50]})}),e.jsx(P1,{size:"38",color:r.colors.gray[500]}),h.name]},m))}),l},f=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(Fe,{children:[e.jsx(Me,{fontSize:"1.2rem",children:`Arquivos (${n.length}/${o} arquivos adicionados)`}),e.jsx("input",{ref:i,id:"file-upload",type:"file",style:{display:"none"},onChange:u}),e.jsx(Oe,{children:n.length>0?p():f()})]})})}const Ye=t=>{let s=!0;const n=[],{title:i,content:o}=t;return(!i||i==="")&&(s=!1,n.push("Título")),(!o||o==="")&&(s=!1,n.push("Conteúdo")),{isValid:s,fieldErrors:n}},$e=t=>{const{title:s,content:n,files:i}=t;return{title:s,content:n,files:i.map(o=>o.id)}};function _e({isModalOpen:t,setIsModalOpen:s}){const n=V(),i=d.useRef(null),[o,c]=d.useState(!1),[a,u]=d.useState({title:"",content:"",files:[]}),[p,f]=d.useState(!1),[l,h]=d.useState(!1);d.useEffect(()=>console.log(a),[a]),d.useEffect(()=>{c(t),u({title:"",content:"",files:[]})},[t]);const m=d.useCallback((y,D)=>{u({...a,[y]:D})},[a]),C=d.useCallback(y=>{h(y)},[]),v=y=>{y.preventDefault();const{isValid:D,fieldErrors:U}=Ye(a);if(!D){n.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${U.reduce((z,k,T)=>T===0?`'${k}'`:T===U.length-1?`${z} e '${k}'`:`${z}, '${k}'`,"")}`,status:""})});return}f(!0),we($e(a)).then(z=>{n.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),j(),u({title:"",content:"",files:[]})}).catch(z=>{n.show({placement:"top-right",render:()=>{let k="";return typeof z.response.data.detail=="object"?k=z.response.data.detail[0].msg.split(", ")[1]:k=z.response.data.detail,e.jsx(g,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${k}`,status:""})}})}).finally(()=>{f(!1)})},j=()=>{c(!1),setTimeout(()=>{s(!1)},300)},R=d.useCallback(y=>{u({...a,files:[...a.files,y]})},[a]),Z=d.useCallback(y=>{const D=a.files.filter(U=>U.name!==y);u({...a,files:D})},[a]),H=()=>{i&&i.current&&i.current.click()};return e.jsx(e.Fragment,{children:o&&e.jsx(Ze,{isOpen:o,onClick:j,children:e.jsxs(He,{isOpen:o,onClick:y=>y.stopPropagation(),children:[e.jsx(Ie,{onClick:j,children:e.jsx(t1,{size:"2rem",color:r.colors.primary[50]})}),e.jsx("h1",{children:"Novo Tópico"}),e.jsx(E,{name:"title",onChange:m,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(g1,{name:"content",onChange:m,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(Ke,{filesUploadLimit:2,fileInputRef:i,handleAddFile:R,handleDeleteFile:Z,files:a.files,setIsAddFileLoading:C}),e.jsxs(Je,{children:[e.jsx(x,{onPress:()=>H(),size:"md",isLoading:l,isLoadingText:"Adicionando arquivo...",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(h1,{}),children:"Adicionar arquivos"}),e.jsx(x,{id:"create-topic-button",onPress:y=>v(y),bgColor:r.colors.success[600],size:"md",isDisabled:l,borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:p,rightIcon:e.jsx(E1,{}),children:"Criar"})]})]})})})}const e3=A.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;function r3(){const t=J(),{token:s}=X();return e.jsxs(G,{w:"190",placement:"bottom right",trigger:n=>e.jsx(x,{variant:"solid",_hover:{shadow:"8"},rightIcon:e.jsx(J1,{size:30,color:r.colors.white}),onPress:()=>{},...n}),children:[e.jsx(G.Item,{onPress:()=>t("/"),children:"Feed"}),s&&e.jsx(G.Item,{onPress:()=>t("/profile"),children:"Perfil"}),!s&&e.jsx(G.Item,{onPress:()=>t("/login/logon"),children:"Entrar"})]})}function o3(){const{name:t,token:s}=X(),n=J(),i=M("(max-width: 768px)");function o(a){a.preventDefault(),n("/profile")}function c(a){a.preventDefault(),n("/login/logon")}return e.jsx(n3,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(s3,{}),e.jsxs("div",{className:"user-container",children:[s&&!i&&e.jsx(e.Fragment,{children:e.jsx(x,{onPress:a=>o(a),rightIcon:e.jsx(I1,{size:"30",color:r.colors.tertiary[300]}),children:i?"":t})}),!s&&!i&&e.jsx(e.Fragment,{children:e.jsx(x,{variant:"solid",bgColor:r.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(W1,{size:30,color:r.colors.white}),onPress:a=>c(a),children:i?"":"Entrar"})}),e.jsx(r3,{})]})]})})}const i3=A.div`
...
`;function d1(){return e.jsxs(i3,{children:[e.jsx(o3,{}),e.jsx("div",{className:"content",children:e.jsx(m1,{})})]})}const a3=A.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,d3=t=>{let s=!0;const n=[],{email:i,password:o}=t;return(!i||i==="")&&(s=!1,n.push("Email Institucional")),(!o||o==="")&&(s=!1,n.push("Senha")),{isValid:s,fieldErrors:n}},A3=async t=>{const{username:s,password:n}=t,i=new FormData;return i.append("username",s),i.append("password",n),await N.post("auth/login",i)},u3=t=>{const{email:s,password:n}=t;return{username:s,password:n}};function p3(){const t=J(),s=V(),{changeToken:n}=X(),[i,o]=d.useState({email:"",password:""}),[c,a]=d.useState(!1),u=d.useCallback((f,l)=>{o({...i,[f]:l})},[i]);function p(f){f.preventDefault();const{isValid:l,fieldErrors:h}=d3(i);if(!l){s.show({placement:"top-right",render:()=>e.jsx(g,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${h.reduce((m,C,v)=>v===0?`'${C}'`:v===h.length-1?`${m} e '${C}'`:`${m}, '${C}'`,"")}`,status:""})});return}a(!0),A3(u3(i)).then(m=>{s.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário logado com sucesso!
Agora você pode criar tópicos e interagir com eles!`,status:"success"})}),n(m.data.access_token),t("/")}).catch(m=>{s.show({placement:"top-right",render:()=>{let C="";return typeof m.response.data.detail=="object"?C=m.response.data.detail[0].msg.split(", ")[1]:C=m.response.data.detail,e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${C}`,status:""})}})}).finally(()=>{a(!1)})}return e.jsxs(c3,{children:[e.jsx(K,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(E,{name:"email",onChange:u,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(E,{name:"password",onChange:u,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(x,{onPress:f=>p(f),variant:"solid",size:"lg",isLoading:c,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(x,{onPress:f=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const h3=A.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,m3="/assets/create-account-24b27e13.png";function f3(){return e.jsxs(h3,{children:[e.jsx("img",{className:"create-account-image",src:m3,alt:""}),e.jsx("div",{className:"content",children:e.jsx(m1,{})})]})}const C3=A.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function g3({label:t,placeholder:s,options:n=[],onChange:i,isRequired:o=!0,fontSize:c="0.9rem",isEditing:a=!0,name:u}){return e.jsxs(x3,{fontSize:c,children:[e.jsxs("label",{className:"create-account-label",children:[t,o&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(I,{variant:"outline",height:9,size:"md",isDisabled:!a,onValueChange:p=>i(u,p),placeholder:s,accessibilityLabel:"Selecione a opção",children:n.map(p=>e.jsx(I.Item,{label:p.label,value:p.value},p.label))})]})}const N3=async t=>await N.post("users",t),A1=async()=>await N.get("users/me"),v3=async t=>await N.patch("users/me",t),b3=async t=>await N.post("users/me/change_password",t),j3=async()=>await N.delete("users/me"),y3=t=>{let s=!0;const n=[],{name:i,email:o,profile:c,course:a,password:u,passwordConfirm:p}=t;return(!i||i==="")&&(s=!1,n.push("Nome Completo")),(!o||o==="")&&(s=!1,n.push("Email Institucional")),(!c||c==="")&&(s=!1,n.push("Papel na Instituição")),(!a||a==="")&&(s=!1,n.push("Curso")),(!u||u==="")&&(s=!1,n.push("Senha")),(!p||p===""||p!==u)&&(s=!1,n.push("Confirme a senha")),{isValid:s,fieldErrors:n}},Q3=t=>{const{name:s,email:n,profile:i,course:o,password:c}=t;return{name:s,email:n,password:c,tags:[i,o]}};function w3(){const t=J(),s=V(),n=n1({lg:"lg",base:"md"}),[i,o]=d.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[c,a]=d.useState(!1),u=d.useCallback((l,h)=>{o({...i,[l]:h})},[i]),p=async l=>{l.preventDefault();const{isValid:h,fieldErrors:m}=y3(i);if(console.log(i),!h){s.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${m.reduce((C,v,j)=>j===0?`'${v}'`:j===m.length-1?`${C} e '${v}'`:`${C}, '${v}'`,"")}`,status:""})});return}a(!0),N3(Q3(i)).then(C=>{s.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(C=>{s.show({placement:"top-right",render:()=>{let v="";return typeof C.response.data.detail=="object"?v=C.response.data.detail[0].msg.split(", ")[1]:v=C.response.data.detail,e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${v}`,status:""})}})}).finally(()=>{a(!1)})};function f(l){switch(l.input){case"select":return e.jsx(g3,{label:l.label,placeholder:l.placeholder,options:l.options,name:l.name,onChange:u,accessibilityLabel:l.accessibilityLabel},l.label);default:return e.jsx(E,{label:l.label,placeholder:l.placeholder,inputType:l.type,name:l.name,onChange:u,accessibilityLabel:l.accessibilityLabel},l.label)}}return e.jsxs(C3,{children:[e.jsx(K,{}),e.jsxs("div",{className:"inputs-container",children:[ue.map(l=>f(l)),e.jsx(x,{onPress:l=>p(l),variant:"solid",size:n,isLoading:c,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(x,{onPress:l=>t(-1),variant:"outline",size:n,children:"Voltar"})]})]})}const D3=A.section`
  width: 80%;
...
`,k3=t=>{let s=!0;const n=[];return(!t||t==="")&&(s=!1,n.push("Nome Completo")),{isValid:s,fieldErrors:n}},z3=(t,s)=>{let n=!0;const i=[];let o="";return(!t||t==="")&&(n=!1,i.push("Senha Atual")),(!s||s==="")&&(n=!1,i.push("Nova Senha")),!s&&s===t&&(n=!1,o="Nova senha não pode ser a mesma que a atual"),{isValid:n,fieldErrors:i,specialError:o}},S3=A.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function u1({question:t,handleAccept:s,handleClose:n,cancelText:i="Cancelar",acceptText:o,isOpen:c,isLoadingAcceptButton:a=!1,loadingAcceptButtonText:u=""}){const p=n1({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:c&&e.jsx(S3,{children:e.jsxs(U3,{children:[e.jsx(L3,{onClick:n,children:e.jsx(t1,{size:"21",color:r.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(x,{size:p,variant:"outline",onPress:n,children:i}),e.jsx(x,{size:p,onPress:s,bgColor:r.colors.danger[500],isLoading:a,isLoadingText:u,children:o})]})]})})})}function T3(){const t=J(),s=V(),{name:n,email:i,setName:o,logoutUser:c}=X(),a=n1({lg:"lg",base:"md"}),[u,p]=d.useState(!1),[f,l]=d.useState(!1),[h,m]=d.useState(!1),[C,v]=d.useState(!1),[j,R]=d.useState({email:i,id:0,name:n,role:"",tags:[]}),[Z,H]=d.useState(!1),[y,D]=d.useState(!1),[U,z]=d.useState(!1),[k,T]=d.useState(""),[O,W]=d.useState("");d.useEffect(()=>{A1().then(Q=>{R(Q.data),o(Q.data.name)})},[o]);const b=d.useCallback((Q,S)=>{R({...j,[Q]:S})},[j]),B=d.useCallback(()=>{D(!0),j3().then(()=>{}).finally(()=>{s.show({placement:"top-right",render:()=>e.jsx(g,{id:"delete-user-success",title:"Usuário deletado!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),c(),D(!1),l(!1),t("/")})},[t,c,s]),F=Q=>{Q.preventDefault();const{fieldErrors:S,isValid:Y}=k3(j.name);if(!Y){s.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${S.reduce((q,w,L)=>L===0?`'${w}'`:L===S.length-1?`${q} e '${w}'`:`${q}, '${w}'`,"")}`,status:""})});return}H(!0),v3({name:j.name}).then(q=>{s.show({placement:"top-right",render:()=>e.jsx(g,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),o(j.name)}).catch(q=>{s.show({placement:"top-right",render:()=>{let w="";return typeof q.response.data.detail=="object"?w=q.response.data.detail[0].msg.split(", ")[1]:w=q.response.data.detail,e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${w}`,status:""})}})}).finally(()=>{H(!1),m(!1)})},N1=Q=>{Q.preventDefault();const{fieldErrors:S,isValid:Y,specialError:q}=z3(k,O);if(!Y){s.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:S.length>0?`Os sequintes campos estão incorretos: ${S.reduce((w,L,r1)=>r1===0?`'${L}'`:r1===S.length-1?`${w} e '${L}'`:`${w}, '${L}'`,"")}`:q,status:""})});return}z(!0),b3({current_password:k,new_password:O}).then(w=>{s.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(w=>{s.show({placement:"top-right",render:()=>{let L="";return typeof w.response.data.detail=="object"?L=w.response.data.detail[0].msg.split(", ")[1]:L=w.response.data.detail,e.jsx(g,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${L}`,status:""})}})}).finally(()=>{z(!1),v(!1),T(""),W("")})},v1=()=>h?e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:a,onPress:()=>{m(!1),A1().then(Q=>{R(Q.data)})},children:"Cancelar"}),e.jsx(x,{variant:"outline",size:a,isLoading:Z,isLoadingText:"Atualizando Usuário...",onPress:Q=>F(Q),children:"Atualizar Usuário"})]}):C?e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:a,onPress:()=>{v(!1),T(""),W("")},children:"Cancelar"}),e.jsx(x,{variant:"outline",size:a,isLoading:U,isLoadingText:"Atualizando Senha...",onPress:Q=>N1(Q),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"solid",size:a,onPress:()=>m(!0),children:"Editar Perfil"}),e.jsx(x,{variant:"outline",size:a,onPress:()=>v(!0),children:"Alterar Senha"})]});return e.jsxs(D3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(K,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(E,{name:"name",onChange:b,isEditing:h,value:j.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(E,{name:"email",onChange:()=>{},isEditing:!1,value:j.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(E,{name:"password",onChange:(Q,S)=>T(S),isEditing:C,value:C?k:"valordeteste",label:C?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),C&&e.jsx(E,{name:"passwordConfirm",onChange:(Q,S)=>W(S),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),v1(),!h&&!C&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(x,{variant:"subtle",size:"md",onPress:()=>p(!0),children:"Sair"}),e.jsx(x,{variant:"subtle",size:"md",onPress:()=>l(!0),children:"Deletar a Conta"})]})]}),e.jsx(u1,{isOpen:u,handleAccept:()=>{p(!1),c(),t("/")},handleClose:()=>p(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(u1,{isOpen:f,handleAccept:()=>{B()},handleClose:()=>l(!1),question:"Tem certeza que deseja deletar sua conta?",acceptText:"Deletar",isLoadingAcceptButton:y,loadingAcceptButtonText:"Deletando..."})]})}const q3=A.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,V3=A.div`
  ...
  align-items: flex-start;
  justify-content: flex-start;
`,X3=t=>{let s=!0;const n=[];return(!t||t==="")&&(s=!1,n.push("Comentário")),{isValid:s,fieldErrors:n}},R3=({topicId:t,onCommentCreated:s})=>{const{name:n}=X(),i=V(),o=M("(max-width: 768px)"),[c,a]=d.useState(""),[u,p]=d.useState(!1);d.useEffect(()=>console.log({comment:c}),[c]);const f=(h,m)=>{a(m)},l=h=>{h.preventDefault();const{isValid:m}=X3(c);if(!m){i.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-comment-error",title:"Campos Inválidos",description:"O comentário não pode ser feito sem conteúdo!",status:""})});return}p(!0),Se(c.trim(),t).then(C=>{a(""),s()}).catch(C=>{i.show({placement:"top-right",render:()=>e.jsx(g,{id:"create-topic-error",title:"Opa",description:"Erro ao criar comentário",status:""})})}).finally(()=>{p(!1)})};return e.jsxs(E3,{children:[e.jsxs(V3,{children:[e.jsx(s1,{bg:"lime.600",marginRight:"0.8rem",size:o?"xs":"sm",children:x1(n)}),e.jsx(g1,{name:"content",onChange:f,fontSize:"1.2rem",size:"lg",value:c,isComment:!0,inputType:"text",accessibilityLabel:"Comentário",label:"",placeholder:"Digite o comentário aqui..."})]}),e.jsx(x,{alignSelf:"flex-end",size:o?"sm":"md",rightIcon:e.jsx(B1,{size:20,color:r.colors.white}),onPress:h=>l(h),isLoading:u,isLoadingText:"Comentando...",children:"Comentar"}),e.jsx($,{})]})};function Z3(){const{id:t}=F1(),{token:s}=X(),[n,i]=d.useState(null),[o,c]=d.useState(!1),[a,u]=d.useState(!1);d.useEffect(()=>window.scrollTo(0,0),[]),d.useEffect(()=>{t&&(c(!0),Qe(Number(t)).then(f=>{i(f.data)}).finally(()=>c(!1)))},[t]);const p=d.useCallback(()=>{n&&(u(!0),Ue(n.id).then(f=>{i({...n,comments:f.data})}).finally(()=>{u(!1)}))},[n]);return e.jsx(q3,{children:n?e.jsxs(e.Fragment,{children:[e.jsx(_,{id:Number(n.id),author:n.author.name,title:n.title,categories:n.categories,content:n.content,rating:n.rating,files:n.files,currentRating:n.current_user_rating,isInsideTopic:!0}),e.jsxs(P3,{children:[s&&e.jsx(R3,{topicId:n.id,onCommentCreated:p}),a?e.jsx(e1,{accessibilityLabel:"Carregando os comentários do tópico..."}):e.jsx(e.Fragment,{children:n.comments.map(f=>e.jsx(_,{id:f.id,isComment:!0,topicId:n.id,author:f.author.name,rating:f.rating,currentRating:f.current_user_rating,content:f.content},f.id))})]})]}):e.jsx(e1,{accessibilityLabel:"Carregando dados do tópico..."})})}function H3(){return e.jsxs(M1,{children:[e.jsxs(P,{path:"/",element:e.jsx(d1,{}),children:[e.jsx(P,{path:"/",element:e.jsx(t3,{})}),e.jsx(P,{path:"/topic/:id",element:e.jsx(Z3,{})})]}),e.jsx(P,{path:"/profile",element:e.jsx(d1,{}),children:e.jsx(P,{path:"/profile",element:e.jsx(T3,{})})}),e.jsxs(P,{path:"/login",element:e.jsx(f3,{}),children:[e.jsx(P,{path:"/login",element:e.jsx(p3,{})}),e.jsx(P,{path:"/login/logon",element:e.jsx(l3,{})}),e.jsx(P,{path:"/login/create-account",element:e.jsx(w3,{})})]})]})}const J3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},I3=O1`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function W3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(s){return console.log(s),"light"}},set:async s=>{try{localStorage.setItem("@UnBForum:theme",s)}catch(n){console.log(n)}}};return e.jsx(G1,{colorModeManager:t,children:e.jsx(K1,{theme:J3,children:e.jsxs(ze,{children:[e.jsx(Y1,{children:e.jsx(H3,{})}),e.jsx(I3,{})]})})})}$1.createRoot(document.getElementById("root")).render(e.jsx(_1.StrictMode,{children:e.jsx(W3,{})}));
