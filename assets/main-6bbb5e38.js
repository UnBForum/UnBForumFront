import{s as p,t as i,a as qe,j as e,I as Be,u as Z,r,F as Fe,S as ce,P as Ve,b as Ce,B as N,c as te,n as we,q as Re,d as je,e as X,A as be,V as Oe,H as ye,T as ve,f as Ze,C as ne,g as pe,h as Xe,D as he,i as He,k as me,l as Te,m as W,o as Je,p as Ge,M as Ke,v as ge,w as de,x as Ae,y as Ye,z as We,E as $e,G as _e,J as et,K as tt,L as ot,N as Y,O as st,Q as Ne,R as Le,U as ke,W as it,X as nt,Y as rt,Z as Ie,_ as at,$ as M,a0 as lt,a1 as ct,a2 as dt,a3 as ut,a4 as pt,a5 as ht}from"./vendor-519cc561.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const d of n)if(d.type==="childList")for(const l of d.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const d={};return n.integrity&&(d.integrity=n.integrity),n.referrerPolicy&&(d.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?d.credentials="include":n.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function a(n){if(n.ep)return;n.ep=!0;const d=s(n);fetch(n.href,d)}})();window.global||(window.global=window);const mt=p.main`
  width: 70%;
  display: flex;
...
`,De=[{label:"Mais recentes",value:"-created_at",color:"#000"},{label:"Mais populares",value:"-rating",color:"#000"},{label:"Mais comentários",value:"-comments_count",color:"#000"}],k=qe.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),xe=async()=>await k.get("categories/"),vt=async t=>await k.post("categories/",t),Nt=async t=>await k.delete(`categories/${t}/`),kt=async t=>await k.patch(`categories/${t.id}/`,{...t}),Dt=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function R({label:t="",inputType:o="text",placeholder:s,accessibilityLabel:a,size:n="md",fontSize:d="0.9rem",name:l,isRequired:x=!0,isEditing:c=!0,value:h=void 0,backgroundColor:u=null,height:f=null,onChange:m,...g}){return e.jsxs(Dt,{children:[t&&e.jsxs(St,{fontSize:d,children:[t,x&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(Be,{height:f||null,type:o,variant:c?"outline":"filled",size:n,backgroundColor:u||null,isRequired:x,value:h,placeholder:s,editable:c,accessibilityLabel:a,onChangeText:b=>m(l,b),...g})]})}function Qt({onChangeCategoriesFilter:t,onChangeOrderBy:o,onChangeSearchInput:s,handleSearch:a}){const n=Z("(max-width: 768px)"),[d,l]=r.useState([]),x={control:c=>({...c,backgroundColor:i.colors.white}),option:(c,{data:h,isMulti:u,isDisabled:f,isFocused:m,isSelected:g})=>{const b=te(h.color);return{...c,backgroundColor:f?void 0:g?u?h.color:b.alpha(.2).css():m?b.alpha(.1).css():void 0,color:f?"#ccc":g&&u?te.contrast(b,"white")>2?"white":"black":h.color,cursor:f?"not-allowed":"default",":active":{...c[":active"],backgroundColor:f?void 0:g?h.color:b.alpha(.3).css()}}},multiValue:(c,{data:h})=>{const u=te(h.color);return{...c,backgroundColor:u.alpha(.1).css()}},multiValueLabel:(c,{data:h})=>({...c,color:h.color}),multiValueRemove:(c,{data:h})=>({...c,color:h.color,":hover":{backgroundColor:h.color,color:"white"}}),input:c=>({...c,"input:focus":{boxShadow:"none"}})};return r.useEffect(()=>{xe().then(c=>{l(c.data)})},[]),e.jsxs(wt,{children:[e.jsxs(jt,{children:[e.jsx(Fe,{size:20,color:i.colors.tertiary[300]}),e.jsx(ce,{isMulti:!0,closeMenuOnSelect:!1,options:d.map(c=>({value:c.id.toString(),label:c.name,color:c.color})),styles:x,onChange:t,placeholder:"Filtrar por categorias"})]}),e.jsxs(yt,{children:[e.jsx(Ve,{size:22,color:i.colors.tertiary[300]}),e.jsx(ce,{isMulti:!1,defaultValue:De[0],options:De,placeholder:"Ordenar Tópicos",styles:x,onChange:o})]}),e.jsxs(bt,{children:[e.jsx(Ce,{color:i.colors.tertiary[300],size:"22"}),e.jsx(R,{name:"topic-search",height:"2.4rem",size:n?"md":"lg",backgroundColor:i.colors.white,accessibilityLabel:"Buscar tópicos",placeholder:"Buscar tópicos...",inputType:"text",onChange:s,InputRightElement:e.jsx(N,{rounded:"none",w:"1/12",h:"full",onPress:a,children:e.jsx(Ce,{color:i.colors.white,size:"22"})})})]})]})}const zt=(t,o)=>t?"0.9rem":o?"1rem":"0.9rem",Et=(t,o)=>t?"0.7rem":o?"0.8rem":"0.7rem",Tt=p.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,It=p.div`
  ...
  & > p {
    ...
    font-size: ${({isComment:t,isInsideTopic:o})=>zt(t,o)};
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:o})=>Et(t,o)};
      line-height: 1.7;
    }
...
`;const qt=async t=>await k.get(`topics/?${Re.stringify(t,{arrayFormat:"comma"})}`),Bt=async t=>await k.get(`topics/${t}`),Ft=async t=>await k.post("topics",t),Vt=async(t,o)=>await k.put(`topics/${o}`,t),Rt=async t=>await k.post(`topics/${t}/upvote`),Ot=async t=>await k.post(`topics/${t}/downvote`),Zt=async t=>await k.post(`topics/${t}/save`),Xt=async t=>await k.post(`topics/${t}/unsave`),Ht=async()=>await k.get("users/me/saved_topics/"),Jt=async()=>await k.get("users/me/topics/"),Gt=async t=>await k.delete(`topics/${t}/`),ae="moderator",le="administrator",Ue=r.createContext(null),Kt=({children:t})=>{const[o,s]=r.useState(""),[a,n]=r.useState([]),[d,l]=r.useState(""),[x,c]=r.useState("");r.useEffect(()=>{const m=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",m),m){const g=je(m.split(" ")[1]);k.defaults.headers.common.Authorization=`${m}`,s(m.split(" ")[1]),n(g.scopes),l(g.sub),c(g.name)}},[]);const h=r.useCallback(m=>{localStorage.setItem("@UnBForum:token",`Bearer ${m}`);const g=je(m);k.defaults.headers.common.Authorization=`Bearer ${m}`,s(m),n(g.scopes),l(g.sub),c(g.name)},[]),u=r.useCallback(m=>a.some(g=>g===m),[a]),f=r.useCallback(()=>{s(""),n([]),l(""),c(""),k.defaults.headers.common.Authorization=null,localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(Ue.Provider,{value:{token:o,name:x,email:d,scopes:a,changeToken:h,checkScopePermissions:u,logoutUser:f,setName:c},children:t})};function G(){const t=r.useContext(Ue);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}const v=({id:t,status:o,variant:s="left-accent",title:a,description:n,isClosable:d=!1,...l})=>{const x=X();return e.jsx(be,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:o||"error",variant:s,...l,children:e.jsxs(Oe,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(ye,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(ye,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(be.Icon,{}),e.jsx(ve,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:s==="solid"?"lightText":s!=="outline"?"darkText":null,children:a})]}),d?e.jsx(Ze,{variant:"unstyled",icon:e.jsx(ne,{size:"3"}),_icon:{color:s==="solid"?"lightText":"darkText"},onPress:()=>x.close(t)}):null]}),e.jsx(ve,{px:"6",color:s==="solid"?"lightText":s!=="outline"?"darkText":null,children:n})]})})},Yt=async(t,o)=>await k.post(`topics/${o}/comments/`,{content:t}),Wt=async t=>await k.get(`topics/${t}/comments/`),$t=async(t,o)=>await k.post(`topics/${o}/comments/${t}/upvote`),_t=async(t,o)=>await k.post(`topics/${o}/comments/${t}/downvote`),eo=t=>`https://unbforum-backend-4b05406a8bbf.herokuapp.com/files/download/${t.upload_path}`;function Pe(t){const o=t.split(" ");if(o.length>=2){const s=o[0],a=o[o.length-1],n=s[0],d=a[0];return n.toUpperCase()+d.toUpperCase()}else return o[0][0].toUpperCase()}const to=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function ue({question:t,handleAccept:o,handleClose:s,cancelText:a="Cancelar",acceptText:n,isOpen:d,isLoadingAcceptButton:l=!1,loadingAcceptButtonText:x=""}){const c=pe({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:d&&e.jsx(to,{children:e.jsxs(oo,{children:[e.jsx(so,{onClick:s,children:e.jsx(ne,{size:"21",color:i.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(N,{size:c,variant:"outline",onPress:s,children:a}),e.jsx(N,{size:c,onPress:o,bgColor:i.colors.danger[500],isLoading:l,isLoadingText:x,children:n})]})]})})})}const io=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function Me({label:t="",inputType:o="text",placeholder:s,accessibilityLabel:a,size:n="md",fontSize:d="0.9rem",isRequired:l=!0,isEditing:x=!0,name:c,isComment:h=!1,value:u=void 0,onChange:f,...m}){return e.jsxs(co,{isComment:h,children:[t&&e.jsxs(uo,{fontSize:d,children:[t,l&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(Xe,{type:o,variant:x?"outline":"filled",size:n,placeholder:s,accessibilityLabel:a,editable:x,onChangeText:g=>f(c,g),autoCompleteType:null,value:u,totalLines:5,maxLength:700,...m})]})}const po=p.div`
  position: relative;
...
`,go=async t=>{const o=new FormData;return o.append("files",t),console.log(o),await k.post("files/upload/",o,{headers:{"Content-Type":t.type}})};function xo({handleAddFile:t,handleDeleteFile:o,files:s,fileInputRef:a,filesUploadLimit:n=2,setIsAddFileLoading:d}){const l=X(),x=async u=>{const f=u.target.files&&u.target.files[0];f&&s.length+1<=n?(console.log("tentando subir arquivo1"),d(!0),console.log("tentando subir arquivo2"),go(f).then(m=>{console.log(m.data[0]),t(m.data[0])}).catch(m=>{l.show({placement:"top",render:()=>e.jsx(v,{id:"files-upload-error",status:"error",title:"Opa!",description:"Erro ao fazer upload do arquivo."})})}).finally(()=>{d(!1)})):l.show({placement:"top",render:()=>e.jsx(v,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},c=()=>{const u=[];return s.forEach((f,m)=>{u.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>o(f.name),children:e.jsx(he,{size:"1.7rem",color:i.colors.primary[50]})}),e.jsx(He,{size:"38",color:i.colors.gray[500]}),f.name]},m))}),u},h=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(po,{children:[e.jsx(ho,{fontSize:"1.2rem",children:`Arquivos (${s.length}/${n} arquivos adicionados)`}),e.jsx("input",{ref:a,id:"file-upload",type:"file",style:{display:"none"},onChange:x}),e.jsx(mo,{children:s.length>0?c():h()})]})})}const Se=t=>{let o=!0;const s=[],{title:a,content:n}=t;return(!a||a==="")&&(o=!1,s.push("Título")),(!n||n==="")&&(o=!1,s.push("Conteúdo")),{isValid:o,fieldErrors:s}},Qe=t=>{const{title:o,content:s,files:a,categories:n}=t;return{title:o,content:s,categories:n,files:a.map(d=>d.id)}};function fe({isModalOpen:t,setIsModalOpen:o,isEditing:s=!1,topic:a=null,id:n=null}){const d=X(),l=Z("(max-width: 768px)"),x=r.useRef(null),[c,h]=r.useState(!1),[u,f]=r.useState(a||{title:"",content:"",files:[],categories:[]}),[m,g]=r.useState(!1),[b,D]=r.useState(!1),[T,z]=r.useState([]),A={control:C=>({...C,backgroundColor:i.colors.white}),option:(C,{data:S,isMulti:I,isDisabled:y,isFocused:w,isSelected:E})=>{const O=te(S.color);return{...C,backgroundColor:y?void 0:E?I?S.color:O.alpha(.2).css():w?O.alpha(.1).css():void 0,color:y?"#ccc":E&&I?te.contrast(O,"white")>2?"white":"black":S.color,cursor:y?"not-allowed":"default",":active":{...C[":active"],backgroundColor:y?void 0:E?S.color:O.alpha(.3).css()}}},multiValue:(C,{data:S})=>{const I=te(S.color);return{...C,backgroundColor:I.alpha(.1).css()}},multiValueLabel:(C,{data:S})=>({...C,color:S.color}),multiValueRemove:(C,{data:S})=>({...C,color:S.color,":hover":{backgroundColor:S.color,color:"white"}}),input:C=>({...C,"input:focus":{boxShadow:"none"}})};r.useEffect(()=>console.log(u),[u]),r.useEffect(()=>{xe().then(C=>{z(C.data)})},[]),r.useEffect(()=>{h(t),f(a||{title:"",content:"",files:[],categories:[]})},[t,a]);const q=r.useCallback((C,S)=>{Array.isArray(S)?f({...u,[C]:S.map(I=>Number(I.value))}):f({...u,[C]:S})},[u]),L=r.useCallback(C=>{D(C)},[]),j=C=>{C.preventDefault();const{isValid:S,fieldErrors:I}=Se(u);if(!S){d.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${I.reduce((y,w,E)=>E===0?`'${w}'`:E===I.length-1?`${y} e '${w}'`:`${y}, '${w}'`,"")}`,status:""})});return}g(!0),Ft(Qe(u)).then(y=>{d.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),B(),f({title:"",content:"",files:[],categories:[]})}).catch(y=>{d.show({placement:"top-right",render:()=>{let w="";return typeof y.response.data.detail=="object"?w=y.response.data.detail[0].msg.split(", ")[1]:w=y.response.data.detail,e.jsx(v,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${w}`,status:""})}})}).finally(()=>{g(!1)})},P=C=>{C.preventDefault();const{isValid:S,fieldErrors:I}=Se(u);if(!S||n===null){d.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${I.reduce((y,w,E)=>E===0?`'${w}'`:E===I.length-1?`${y} e '${w}'`:`${y}, '${w}'`,"")}`,status:""})});return}g(!0),Vt(Qe(u),n).then(y=>{d.show({placement:"top-right",render:()=>e.jsx(v,{id:"edit-topic-success",title:"Tópico Editado com Sucesso",description:"Agora todos podem ver seu tópico com as edições!",status:"success"})}),B(),f({title:"",content:"",files:[],categories:[]})}).catch(y=>{d.show({placement:"top-right",render:()=>{let w="";return typeof y.response.data.detail=="object"?w=y.response.data.detail[0].msg.split(", ")[1]:w=y.response.data.detail,e.jsx(v,{id:"edit-topic-error",title:"Campos Inválidos",description:`Erro: ${w}`,status:""})}})}).finally(()=>{g(!1)})},B=()=>{h(!1),setTimeout(()=>{o(!1)},300)},H=r.useCallback(C=>{f({...u,files:[...u.files,C]})},[u]),_=r.useCallback(C=>{const S=u.files.filter(I=>I.name!==C);f({...u,files:S})},[u]),J=()=>{x&&x.current&&x.current.click()},se=()=>{const C=y=>T.filter(w=>w.id===y)[0],I=u.categories.map(y=>C(y)).map(y=>({value:y.id.toString(),label:y.name,color:y.color}));return console.log(I),I};return e.jsx(e.Fragment,{children:c&&e.jsx(io,{isOpen:c,onClick:B,children:e.jsxs(no,{isOpen:c,onClick:C=>C.stopPropagation(),children:[e.jsx(lo,{onClick:B,children:e.jsx(ne,{size:"2rem",color:i.colors.white})}),e.jsx("h1",{children:s?"Editar Tópico":"Novo Tópico"}),e.jsx(R,{name:"title",onChange:q,value:u.title||void 0,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(Me,{name:"content",onChange:q,value:u.content||void 0,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(ao,{children:e.jsx(ce,{isMulti:!0,closeMenuOnSelect:!1,value:se(),options:T.map(C=>({value:C.id.toString(),label:C.name,color:C.color})),styles:A,onChange:C=>q("categories",C),placeholder:"Adicionar categorias"})}),e.jsx(xo,{filesUploadLimit:2,fileInputRef:x,handleAddFile:H,handleDeleteFile:_,files:u.files,setIsAddFileLoading:L}),e.jsxs(ro,{children:[e.jsx(N,{onPress:()=>J(),size:l?"xs":"md",isLoading:b,isLoadingText:"Adicionando arquivo...",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(me,{}),children:"Adicionar arquivos"}),e.jsx(N,{id:"create-topic-button",onPress:s?C=>P(C):C=>j(C),bgColor:i.colors.success[600],size:l?"xs":"md",isDisabled:b,borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:s?"Editando...":"Criando...",isLoading:m,rightIcon:e.jsx(Te,{}),children:s?"Editar":"Criar"})]})]})})})}function ie({id:t,isInsideTopic:o=!1,isComment:s=!1,title:a="",author:n,content:d,topicId:l=null,currentRating:x=0,rating:c=0,files:h=[],categories:u=[],commentsCount:f=0,isSave:m=!1,isMyTopicScreen:g=!1,deleteTopicCallback:b=D=>new Promise(()=>null)}){const{token:D}=G(),T=X(),z=W(),A=Z("(max-width: 768px)"),[q,L]=r.useState(c),[j,P]=r.useState(m),[B,H]=r.useState(x),[_,J]=r.useState(!1),[se,C]=r.useState(!1),[S,I]=r.useState(!1);r.useEffect(()=>{H(x),L(c),P(m)},[x,c,m]);function y(){z(`/topic/${t}`)}const w=()=>{T.show({placement:"top-right",render:()=>e.jsx(v,{id:"user-unlogged-error",title:"Opa!",description:"Para interagir com um tópico ou comentário, você precisa fazer login!",status:""})})};async function E(Q,K){if(Q.preventDefault(),!D){w();return}if(K>0){const re=await(s?$t(t,l):Rt(t));L(re.data.rating),H(B>0?0:1)}else{const re=await(s?_t(t,l):Ot(t));L(re.data.rating),H(B<0?0:-1)}}function O(Q){if(Q.preventDefault(),!D){w();return}j?Xt(t).then(K=>{P(!1)}).catch(K=>{}):Zt(t).then(K=>{P(!0)}).catch(K=>{})}function V(){if(!D){w();return}C(!0),Gt(t).then(Q=>{C(!1),J(!1),b(t).then(),T.show({placement:"top-right",render:()=>e.jsx(v,{id:"delete-topic-success",title:"Tópico removido!",description:"Tópico removido com sucesso!",status:"success"})})}).catch(Q=>{})}const U=r.useCallback(Q=>{I(Q),Q||b(t).then()},[b,t]);function F(){switch(j){case!0:return e.jsx($e,{size:"30",color:i.colors.darkBlue[400]});case!1:return e.jsx(We,{size:"30",color:i.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(Tt,{children:[e.jsxs(At,{isInsideTopic:o,isComment:s,children:[e.jsxs("div",{id:"common-reactions",children:[e.jsx("button",{id:"reactionButton",onClick:Q=>E(Q,1),children:e.jsx(Je,{color:B>0?i.colors.tertiary[500]:i.colors.muted[500],size:"18"})}),e.jsx("p",{children:q}),e.jsx("button",{id:"reactionButton",onClick:Q=>E(Q,-1),children:e.jsx(Ge,{color:B<0?i.colors.tertiary[500]:i.colors.muted[500],size:"18"})}),!s&&e.jsx("button",{id:"markButton",onClick:Q=>O(Q),children:F()})]}),D&&g&&e.jsxs("div",{id:"user-buttons",style:{display:"flex",flexDirection:"column",gap:".2rem"},children:[e.jsx("button",{id:"deleteButton",onClick:()=>J(!0),children:e.jsx(he,{color:i.colors.white,size:A?"22":"30"})}),e.jsx("button",{id:"editButton",onClick:()=>U(!0),children:e.jsx(Ke,{color:i.colors.white,size:A?"22":"30"})})]})]}),e.jsx(Lt,{children:e.jsxs(It,{isInsideTopic:o,isComment:s,children:[o&&e.jsx("h1",{id:"post-title",children:a}),e.jsxs(Ut,{isInsideTopic:o,children:[e.jsx(ge,{bg:s?"lime.600":"emerald.600",marginRight:"0.8rem",size:s?"xs":"sm",children:Pe(n)}),e.jsxs("p",{children:[n,!o&&!s&&` - ${a}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:d.replace(/\n/g,"<br>")}}),h.length>0&&e.jsx(de,{width:"80%"}),h.map((Q,K)=>e.jsxs("span",{children:["Para acessar o arquivo ",`${K+1}: `,e.jsx("a",{href:eo(Q),target:"_blank",rel:"noreferrer",children:"clique aqui"})]},Q.id)),!s&&e.jsx(Pt,{children:u.map(Q=>e.jsx(Ae,{variant:"solid",bg:Q.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:Q.name})},Q.id))}),!o&&!s&&e.jsx(Mt,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:A?"0.8rem":"1rem"},isInsideTopic:o,onPress:o?()=>{}:()=>y(),rightIcon:e.jsx(Ye,{size:A?"18":"20",color:i.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${f})`})]})})]}),e.jsx(de,{alignSelf:"flex-end",width:s?"95%":"100%",marginTop:o?"0rem":"0.5rem",height:s||!o?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}}),e.jsx(ue,{isOpen:_,handleAccept:V,handleClose:()=>J(!1),question:"Tem certeza que deseja remover seu tópico?",acceptText:"Remover",isLoadingAcceptButton:se,loadingAcceptButtonText:"Removendo..."}),e.jsx(fe,{isModalOpen:S,setIsModalOpen:U,isEditing:!0,topic:{title:a,categories:u.map(Q=>Q.id),files:h,content:d},id:t})]})}const fo=p.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function bo(){return e.jsxs(fo,{children:[e.jsxs(Co,{children:[e.jsx(ge,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(wo,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(jo,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,o)=>e.jsx(Ae,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},o))})]})]})}const yo=p.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;function oe({accessibilityLabel:t}){return e.jsxs(yo,{children:[e.jsx(_e,{size:"lg",color:i.colors.primary[700],accessibilityLabel:t}),e.jsx(et,{color:"primary.700",fontSize:"md",children:"Carregando..."})]})}function vo(){const{token:t}=G(),o=Z("(max-width: 768px)"),[s,a]=r.useState(!1),[n,d]=r.useState([]),[l,x]=r.useState([]),[c,h]=r.useState("-created_at"),[u,f]=r.useState(""),[m,g]=r.useState(""),[b,D]=r.useState(!1);r.useEffect(()=>window.scrollTo(0,0),[]),r.useEffect(()=>console.log(n),[n]),r.useEffect(()=>{s||(D(!0),qt({search:m,order_by:c,category__id__in:l}).then(j=>{d(j.data)}).finally(()=>D(!1)))},[s,m,c,l]);const T=r.useCallback(j=>{a(j)},[]),z=r.useCallback(j=>{x(j.map(P=>P.value))},[]),A=r.useCallback(j=>{h(j.value)},[]),q=r.useCallback((j,P)=>{f(P)},[]),L=r.useCallback(()=>{g(u)},[u]);return e.jsxs(e.Fragment,{children:[e.jsxs(mt,{children:[e.jsxs(gt,{children:[e.jsx(tt,{isDisabled:t,label:t?null:"Para criar um tópico é necessário estar logado",children:e.jsx(N,{isDisabled:!t,bgColor:i.colors.success[600],size:o?"xs":"lg",borderRadius:"4px",rightIcon:e.jsx(me,{}),onPress:()=>T(!0),children:e.jsx("p",{children:"Criar Tópico"})})}),e.jsx(Qt,{onChangeCategoriesFilter:z,onChangeOrderBy:A,onChangeSearchInput:q,handleSearch:L}),b?e.jsx(oe,{accessibilityLabel:"Carregando os tópicos..."}):e.jsx(e.Fragment,{children:e.jsx(xt,{children:n.map(j=>e.jsx(ie,{id:j.id,title:j.title,rating:j.rating,files:j.files,currentRating:j.current_user_rating,content:j.content,author:j.author.name,commentsCount:j.comments_count,categories:j.categories,isSave:j.current_user_has_saved},j.id))})})]}),e.jsx(ft,{children:e.jsxs(Ct,{children:[e.jsxs("div",{id:"favorite-title-container",children:[e.jsx("h1",{id:"title-favorites",children:"Tópicos Fixados"}),e.jsx(ot,{color:i.colors.rose[600],size:"22"})]}),Array.from({length:10}).map((j,P)=>e.jsx(bo,{},P))]})})]}),e.jsx(fe,{isModalOpen:s,setIsModalOpen:T})]})}const No="/assets/InlineLogo-bd32ea4c.png",ko=p.header`
  width: 100%;
  height: 6rem;
  display: flex;
  align-items: center;
...
`;function Do(){const{name:t,token:o}=G(),s=W(),a=Z("(max-width: 768px)");function n(c){c.preventDefault(),s("/")}function d(c){c.preventDefault(),s("/login/logon")}function l(){return o?a?"":t:a?"":"Entrar"}function x(){return e.jsxs(e.Fragment,{children:[!o&&e.jsx(Y.Item,{onPress:()=>s("/login/logon"),children:"Entrar"}),e.jsx(Y.Item,{onPress:()=>s("/"),children:"Feed"}),o&&e.jsx(Y.Item,{onPress:()=>s("/profile"),children:"Perfil"}),o&&e.jsx(Y.Item,{onPress:()=>s("/my-topics"),children:"Meus Tópicos"}),o&&e.jsx(Y.Item,{onPress:()=>s("/saved-topics"),children:"Tópicos Salvos"}),e.jsx(Y.Item,{onPress:()=>s("/categories"),children:"Categorias"})]})}return e.jsx(ko,{children:e.jsxs("section",{className:"header-container",children:[e.jsx("button",{onClick:c=>n(c),children:e.jsx("img",{src:No,alt:"Logo UnBFórum em linha"})}),e.jsx("div",{className:"user-container",children:o?e.jsx(Y,{w:"190",placement:"bottom right",trigger:c=>e.jsx(N,{rightIcon:o?e.jsx(st,{size:"30",color:i.colors.tertiary[300]}):e.jsx(Ne,{size:30,color:i.colors.white}),...c,children:l()}),children:x()}):e.jsx(N,{variant:"solid",bgColor:i.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(Ne,{size:30,color:i.colors.white}),onPress:c=>d(c),children:a?"":"Entrar"})})]})})}const So=p.div`
...
`;function ee(){return e.jsxs(So,{children:[e.jsx(Do,{}),e.jsx("div",{className:"content",children:e.jsx(Le,{})})]})}const Qo=p.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,To=t=>{let o=!0;const s=[],{email:a,password:n}=t;return(!a||a==="")&&(o=!1,s.push("Email Institucional")),(!n||n==="")&&(o=!1,s.push("Senha")),{isValid:o,fieldErrors:s}},Ao=async t=>{const{username:o,password:s}=t,a=new FormData;return a.append("username",o),a.append("password",s),await k.post("auth/login",a)},Lo=t=>{const{email:o,password:s}=t;return{username:o,password:s}};function Io(){const t=W(),o=X(),{changeToken:s}=G(),[a,n]=r.useState({email:"",password:""}),[d,l]=r.useState(!1),x=r.useCallback((h,u)=>{n({...a,[h]:u})},[a]);function c(h){h.preventDefault();const{isValid:u,fieldErrors:f}=To(a);if(!u){o.show({placement:"top-right",render:()=>e.jsx(v,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${f.reduce((m,g,b)=>b===0?`'${g}'`:b===f.length-1?`${m} e '${g}'`:`${m}, '${g}'`,"")}`,status:""})});return}l(!0),Ao(Lo(a)).then(m=>{o.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário logado com sucesso!
Agora você pode criar tópicos e interagir com eles!`,status:"success"})}),s(m.data.access_token),t("/")}).catch(m=>{o.show({placement:"top-right",render:()=>{let g="";return typeof m.response.data.detail=="object"?g=m.response.data.detail[0].msg.split(", ")[1]:g=m.response.data.detail,e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${g}`,status:""})}})}).finally(()=>{l(!1)})}return e.jsxs(Eo,{children:[e.jsx($,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(R,{name:"email",onChange:x,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(R,{name:"password",onChange:x,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(N,{onPress:h=>c(h),variant:"solid",size:"lg",isLoading:d,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(N,{onPress:h=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const Uo=p.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,Po="/assets/create-account-24b27e13.png";function Mo(){return e.jsxs(Uo,{children:[e.jsx("img",{className:"create-account-image",src:Po,alt:""}),e.jsx("div",{className:"content",children:e.jsx(Le,{})})]})}const qo=p.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,Bo=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],Fo=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],Vo=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:Bo},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:Fo},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],Ro=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function Oo({label:t,placeholder:o,options:s=[],onChange:a,isRequired:n=!0,fontSize:d="0.9rem",isEditing:l=!0,name:x}){return e.jsxs(Ro,{fontSize:d,children:[e.jsxs("label",{className:"create-account-label",children:[t,n&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(ke,{variant:"outline",height:9,size:"md",isDisabled:!l,onValueChange:c=>a(x,c),placeholder:o,accessibilityLabel:"Selecione a opção",children:s.map(c=>e.jsx(ke.Item,{label:c.label,value:c.value},c.label))})]})}const Zo=async t=>await k.post("users",t),ze=async()=>await k.get("users/me"),Xo=async t=>await k.patch("users/me",t),Ho=async t=>await k.post("users/me/change_password",t),Jo=async()=>await k.delete("users/me"),Go=t=>{let o=!0;const s=[],{name:a,email:n,profile:d,course:l,password:x,passwordConfirm:c}=t;return(!a||a==="")&&(o=!1,s.push("Nome Completo")),(!n||n==="")&&(o=!1,s.push("Email Institucional")),(!d||d==="")&&(o=!1,s.push("Papel na Instituição")),(!l||l==="")&&(o=!1,s.push("Curso")),(!x||x==="")&&(o=!1,s.push("Senha")),(!c||c===""||c!==x)&&(o=!1,s.push("Confirme a senha")),{isValid:o,fieldErrors:s}},Ko=t=>{const{name:o,email:s,profile:a,course:n,password:d}=t;return{name:o,email:s,password:d,tags:[a,n]}};function Yo(){const t=W(),o=X(),s=pe({lg:"lg",base:"md"}),[a,n]=r.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[d,l]=r.useState(!1),x=r.useCallback((u,f)=>{n({...a,[u]:f})},[a]),c=async u=>{u.preventDefault();const{isValid:f,fieldErrors:m}=Go(a);if(console.log(a),!f){o.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${m.reduce((g,b,D)=>D===0?`'${b}'`:D===m.length-1?`${g} e '${b}'`:`${g}, '${b}'`,"")}`,status:""})});return}l(!0),Zo(Ko(a)).then(g=>{o.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(g=>{o.show({placement:"top-right",render:()=>{let b="";return typeof g.response.data.detail=="object"?b=g.response.data.detail[0].msg.split(", ")[1]:b=g.response.data.detail,e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${b}`,status:""})}})}).finally(()=>{l(!1)})};function h(u){switch(u.input){case"select":return e.jsx(Oo,{label:u.label,placeholder:u.placeholder,options:u.options,name:u.name,onChange:x,accessibilityLabel:u.accessibilityLabel},u.label);default:return e.jsx(R,{label:u.label,placeholder:u.placeholder,inputType:u.type,name:u.name,onChange:x,accessibilityLabel:u.accessibilityLabel},u.label)}}return e.jsxs(qo,{children:[e.jsx($,{}),e.jsxs("div",{className:"inputs-container",children:[Vo.map(u=>h(u)),e.jsx(N,{onPress:u=>c(u),variant:"solid",size:s,isLoading:d,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(N,{onPress:u=>t(-1),variant:"outline",size:s,children:"Voltar"})]})]})}const Wo=p.section`
  width: 80%;
...
`,$o=t=>{let o=!0;const s=[];return(!t||t==="")&&(o=!1,s.push("Nome Completo")),{isValid:o,fieldErrors:s}},_o=(t,o)=>{let s=!0;const a=[];let n="";return(!t||t==="")&&(s=!1,a.push("Senha Atual")),(!o||o==="")&&(s=!1,a.push("Nova Senha")),!o&&o===t&&(s=!1,n="Nova senha não pode ser a mesma que a atual"),{isValid:s,fieldErrors:a,specialError:n}};function es(){const t=W(),o=X(),{name:s,email:a,setName:n,logoutUser:d}=G(),l=pe({lg:"lg",base:"md"}),[x,c]=r.useState(!1),[h,u]=r.useState(!1),[f,m]=r.useState(!1),[g,b]=r.useState(!1),[D,T]=r.useState({email:a,id:0,name:s,role:"",tags:[]}),[z,A]=r.useState(!1),[q,L]=r.useState(!1),[j,P]=r.useState(!1),[B,H]=r.useState(""),[_,J]=r.useState("");r.useEffect(()=>{ze().then(w=>{T(w.data),n(w.data.name)})},[n]);const se=r.useCallback((w,E)=>{T({...D,[w]:E})},[D]),C=r.useCallback(()=>{L(!0),Jo().then(()=>{}).finally(()=>{o.show({placement:"top-right",render:()=>e.jsx(v,{id:"delete-user-success",title:"Usuário excluído!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),d(),L(!1),u(!1),t("/")})},[t,d,o]),S=w=>{w.preventDefault();const{fieldErrors:E,isValid:O}=$o(D.name);if(!O){o.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${E.reduce((V,U,F)=>F===0?`'${U}'`:F===E.length-1?`${V} e '${U}'`:`${V}, '${U}'`,"")}`,status:""})});return}A(!0),Xo({name:D.name}).then(V=>{o.show({placement:"top-right",render:()=>e.jsx(v,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),n(D.name)}).catch(V=>{o.show({placement:"top-right",render:()=>{let U="";return typeof V.response.data.detail=="object"?U=V.response.data.detail[0].msg.split(", ")[1]:U=V.response.data.detail,e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${U}`,status:""})}})}).finally(()=>{A(!1),m(!1)})},I=w=>{w.preventDefault();const{fieldErrors:E,isValid:O,specialError:V}=_o(B,_);if(!O){o.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:E.length>0?`Os sequintes campos estão incorretos: ${E.reduce((U,F,Q)=>Q===0?`'${F}'`:Q===E.length-1?`${U} e '${F}'`:`${U}, '${F}'`,"")}`:V,status:""})});return}P(!0),Ho({current_password:B,new_password:_}).then(U=>{o.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(U=>{o.show({placement:"top-right",render:()=>{let F="";return typeof U.response.data.detail=="object"?F=U.response.data.detail[0].msg.split(", ")[1]:F=U.response.data.detail,e.jsx(v,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${F}`,status:""})}})}).finally(()=>{P(!1),b(!1),H(""),J("")})},y=()=>f?e.jsxs(e.Fragment,{children:[e.jsx(N,{variant:"solid",size:l,onPress:()=>{m(!1),ze().then(w=>{T(w.data)})},children:"Cancelar"}),e.jsx(N,{variant:"outline",size:l,isLoading:z,isLoadingText:"Atualizando Usuário...",onPress:w=>S(w),children:"Atualizar Usuário"})]}):g?e.jsxs(e.Fragment,{children:[e.jsx(N,{variant:"solid",size:l,onPress:()=>{b(!1),H(""),J("")},children:"Cancelar"}),e.jsx(N,{variant:"outline",size:l,isLoading:j,isLoadingText:"Atualizando Senha...",onPress:w=>I(w),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(N,{variant:"solid",size:l,onPress:()=>m(!0),children:"Editar Perfil"}),e.jsx(N,{variant:"outline",size:l,onPress:()=>b(!0),children:"Alterar Senha"})]});return e.jsxs(Wo,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx($,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(R,{name:"name",onChange:se,isEditing:f,value:D.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(R,{name:"email",onChange:()=>{},isEditing:!1,value:D.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(R,{name:"password",onChange:(w,E)=>H(E),isEditing:g,value:g?B:"valordeteste",label:g?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),g&&e.jsx(R,{name:"passwordConfirm",onChange:(w,E)=>J(E),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),y(),!f&&!g&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(N,{variant:"subtle",size:"md",onPress:()=>c(!0),children:"Sair"}),e.jsx(N,{variant:"subtle",size:"md",onPress:()=>u(!0),children:"Remover a Conta"})]})]}),e.jsx(ue,{isOpen:x,handleAccept:()=>{c(!1),d(),t("/")},handleClose:()=>c(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(ue,{isOpen:h,handleAccept:()=>{C()},handleClose:()=>u(!1),question:"Tem certeza que deseja remover sua conta?",acceptText:"Remover",isLoadingAcceptButton:q,loadingAcceptButtonText:"Deletando..."})]})}const ts=p.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,is=p.div`
  ...
  align-items: flex-start;
  justify-content: flex-start;
`,ns=t=>{let o=!0;const s=[];return(!t||t==="")&&(o=!1,s.push("Comentário")),{isValid:o,fieldErrors:s}},rs=({topicId:t,onCommentCreated:o})=>{const{name:s}=G(),a=X(),n=Z("(max-width: 768px)"),[d,l]=r.useState(""),[x,c]=r.useState(!1);r.useEffect(()=>console.log({comment:d}),[d]);const h=(f,m)=>{l(m)},u=f=>{f.preventDefault();const{isValid:m}=ns(d);if(!m){a.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-comment-error",title:"Campos Inválidos",description:"O comentário não pode ser feito sem conteúdo!",status:""})});return}c(!0),Yt(d.trim(),t).then(g=>{l(""),o()}).catch(g=>{a.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-topic-error",title:"Opa",description:"Erro ao criar comentário",status:""})})}).finally(()=>{c(!1)})};return e.jsxs(ss,{children:[e.jsxs(is,{children:[e.jsx(ge,{bg:"lime.600",marginRight:"0.8rem",size:n?"xs":"sm",children:Pe(s)}),e.jsx(Me,{name:"content",onChange:h,fontSize:"1.2rem",size:"lg",value:d,isComment:!0,inputType:"text",accessibilityLabel:"Comentário",label:"",placeholder:"Digite o comentário aqui..."})]}),e.jsx(N,{alignSelf:"flex-end",size:n?"sm":"md",rightIcon:e.jsx(it,{size:20,color:i.colors.white}),onPress:f=>u(f),isLoading:x,isLoadingText:"Comentando...",children:"Comentar"}),e.jsx(de,{})]})};function as(){const{id:t}=nt(),{token:o}=G(),[s,a]=r.useState(null),[n,d]=r.useState(!1),[l,x]=r.useState(!1);r.useEffect(()=>window.scrollTo(0,0),[]),r.useEffect(()=>{t&&(d(!0),Bt(Number(t)).then(h=>{a(h.data)}).finally(()=>d(!1)))},[t]);const c=r.useCallback(()=>{s&&(x(!0),Wt(s.id).then(h=>{a({...s,comments:h.data})}).finally(()=>{x(!1)}))},[s]);return e.jsx(ts,{children:s?e.jsxs(e.Fragment,{children:[e.jsx(ie,{id:Number(s.id),author:s.author.name,title:s.title,categories:s.categories,content:s.content,rating:s.rating,files:s.files,currentRating:s.current_user_rating,isSave:s.current_user_has_saved,isInsideTopic:!0}),e.jsxs(os,{children:[o&&e.jsx(rs,{topicId:s.id,onCommentCreated:c}),l?e.jsx(oe,{accessibilityLabel:"Carregando os comentários do tópico..."}):e.jsx(e.Fragment,{children:s.comments.map(h=>e.jsx(ie,{id:h.id,isComment:!0,topicId:s.id,author:h.author.name,rating:h.rating,currentRating:h.current_user_rating,content:h.content},h.id))})]})]}):e.jsx(oe,{accessibilityLabel:"Carregando dados do tópico..."})})}const ls=p.section`
  position: relative;
  width: 80%;
  height: calc(100vh - 6rem);
  display: flex;
...
`,ws=t=>{let o=!0;const s=[],{name:a,color:n}=t;return(!a||a==="")&&(o=!1,s.push("Nome da Categoria")),(!n||n==="")&&(o=!1,s.push("Cor da Categoria")),{isValid:o,fieldErrors:s}};function js({isModalOpen:t,setIsModalOpen:o,title:s=null,selectedCategory:a=null,isEditing:n=!1}){const d=X(),l=Z("(max-width: 768px)"),[x,c]=r.useState(!1),[h,u]=r.useState(a||{id:0,color:"#10B981",name:""}),[f,m]=r.useState(!1);r.useEffect(()=>console.log(h),[h]),r.useEffect(()=>{c(t),u(a||{id:0,color:"#10B981",name:""})},[t,a]);const g=r.useCallback((T,z)=>{u({...h,[T]:z})},[h]),b=T=>{T.preventDefault();const{isValid:z,fieldErrors:A}=ws(h);z||d.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${A.reduce((L,j,P)=>P===0?`'${j}'`:P===A.length-1?`${L} e '${j}'`:`${L}, '${j}'`,"")}`,status:""})}),m(!0),(n?kt:vt)(h).then(L=>{d.show({placement:"top-right",render:()=>e.jsx(v,{id:"create-category-success",title:"Categoria Criada com Sucesso",description:"Agora todos podem utilizar a nova categoria!",status:"success"})}),D(),u({id:0,color:"#10B981",name:""})}).catch(L=>{d.show({placement:"top-right",render:()=>{let j="";return typeof L.response.data.detail=="object"?j=L.response.data.detail[0].msg.split(", ")[1]:j=L.response.data.detail,e.jsx(v,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${j}`,status:""})}})}).finally(()=>{m(!1)})},D=()=>{c(!1),setTimeout(()=>{o(!1)},300)};return e.jsx(e.Fragment,{children:x&&e.jsx(ms,{isOpen:x,onClick:D,children:e.jsxs(gs,{isOpen:x,onClick:T=>T.stopPropagation(),children:[e.jsx(fs,{onClick:D,children:e.jsx(ne,{size:"2rem",color:i.colors.primary[50]})}),e.jsx("h1",{children:s||"Nova categoria"}),e.jsx(R,{name:"name",onChange:g,fontSize:"1.2rem",value:h.name||void 0,size:"lg",inputType:"text",accessibilityLabel:"Nome da Categoria",label:"Nome da Categoria",placeholder:"Digite o nome da categoria..."}),e.jsx(R,{name:"color",onChange:g,fontSize:"1.2rem",value:h.color,size:"lg",inputType:"text",accessibilityLabel:"Cor da Categoria (com #)",label:"Cor da Categoria (com #)",placeholder:"Escolha a cor da categoria #000000..."}),e.jsx(Cs,{color:h.color}),e.jsx(xs,{children:e.jsx(N,{id:"create-topic-button",onPress:T=>b(T),bgColor:i.colors.success[600],size:l?"xs":"md",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:f,rightIcon:e.jsx(Te,{}),children:"Criar"})})]})})})}const Ee="Nova Categoria";function bs(){const t=X(),{checkScopePermissions:o}=G(),s=Z("(max-width: 768px)"),[a,n]=r.useState([]),[d,l]=r.useState(null),[x,c]=r.useState(!1),[h,u]=r.useState(Ee),[f,m]=r.useState(!1);r.useEffect(()=>{x||g().then()},[x]);const g=async()=>{m(!0),xe().then(z=>{n(z.data)}).finally(()=>{m(!1)})},b=r.useCallback(z=>{c(z),l(null),u(Ee)},[]),D=(z,A)=>{z.preventDefault(),m(!0),Nt(A).then(q=>{t.show({placement:"top-right",render:()=>e.jsx(v,{id:"delete-category-success",title:"Categoria Apagada com Sucesso",description:"",status:"success"})}),g().then()}).catch(q=>{t.show({placement:"top-right",render:()=>{let L="";return typeof q.response.data.detail=="object"?L=q.response.data.detail[0].msg.split(", ")[1]:L=q.response.data.detail,e.jsx(v,{id:"create-category-error",title:"Erro ao apagar categoria",description:`Erro: ${L}`,status:""})}})}).finally(()=>{m(!1)})},T=(z,A)=>{z.preventDefault(),l(A),u("Editar Categoria"),c(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs(ls,{children:[e.jsx("div",{className:"logo-categories-container",children:e.jsx($,{})}),e.jsxs("section",{className:"categories-list",children:[e.jsxs("div",{id:"create-category",children:[e.jsx("h1",{className:"categories-page-title",children:"Lista de Categorias"}),(o(le)||o(ae))&&e.jsx(N,{size:s?"sm":"lg",rightIcon:e.jsx(me,{}),onPress:()=>b(!0),children:"Criar categoria"})]}),e.jsx(cs,{children:f?e.jsx(oe,{accessibilityLabel:"Carregando os tópicos..."}):e.jsx(e.Fragment,{children:a.map(z=>e.jsxs("div",{id:"category-card",children:[(o(le)||o(ae))&&e.jsxs(us,{children:[e.jsx(ps,{onClick:A=>T(A,z),children:e.jsx(rt,{color:i.colors.primary[50]})}),e.jsx(hs,{onClick:A=>D(A,z.id),children:e.jsx(he,{color:i.colors.primary[50]})})]}),e.jsx("p",{id:"category-name",children:z.name}),e.jsx(ds,{colorIndicator:z.color})]},z.id))})})]})]}),(o(le)||o(ae))&&e.jsx(js,{isModalOpen:x,setIsModalOpen:b,selectedCategory:d,isEditing:d!==null,title:h})]})}function ys(){const t=W();return e.jsx(e.Fragment,{children:e.jsx(fe,{isModalOpen:!0,setIsModalOpen:()=>t("/")})})}const vs=p.section`
  position: relative;
  width: 80%;
  height: calc(100vh - 6rem);
  display: flex;
...
`;function ks(){const t=Z("(max-width: 768px)"),[o,s]=r.useState(!1),[a,n]=r.useState([]);r.useEffect(()=>{d().then()},[]);const d=async()=>{s(!0),Ht().then(l=>{n(l.data)}).finally(()=>{s(!1)})};return e.jsx(e.Fragment,{children:e.jsxs(vs,{children:[e.jsx("div",{className:"logo-saved-topics-container",children:e.jsx($,{})}),e.jsxs("section",{className:"saved-topics-list",children:[e.jsxs("div",{className:"reload-saved-topics",children:[e.jsx("h1",{className:"saved-topics-title",children:"Meus Tópicos Salvos"}),e.jsx(N,{size:t?"sm":"lg",rightIcon:e.jsx(Ie,{size:22,color:i.colors.white}),onPress:d,children:"Recarregar"})]}),e.jsx(Ns,{children:o?e.jsx(oe,{accessibilityLabel:"Carregando os tópicos salvos..."}):e.jsx(e.Fragment,{children:a.map(l=>e.jsx(ie,{id:l.id,title:l.title,rating:l.rating,files:l.files,currentRating:l.current_user_rating,content:l.content,author:l.author.name,commentsCount:l.comments_count,categories:l.categories,isSave:l.current_user_has_saved||!0},l.id))})})]})]})})}const Ds=p.section`
  position: relative;
  width: 80%;
  height: calc(100vh - 6rem);
  display: flex;
...
`;function Qs(){const t=Z("(max-width: 768px)"),[o,s]=r.useState(!1),[a,n]=r.useState([]);r.useEffect(()=>{d().then()},[]);const d=async()=>{s(!0),Jt().then(l=>{n(l.data)}).finally(()=>{s(!1)})};return e.jsx(e.Fragment,{children:e.jsxs(Ds,{children:[e.jsx("div",{className:"logo-my-topics-container",children:e.jsx($,{})}),e.jsxs("section",{className:"my-topics-list",children:[e.jsxs("div",{className:"reload-my-topics",children:[e.jsx("h1",{className:"my-topics-title",children:"Meus Tópicos Criados"}),e.jsx(N,{size:t?"sm":"lg",rightIcon:e.jsx(Ie,{size:22,color:i.colors.white}),onPress:d,children:"Recarregar"})]}),e.jsx(Ss,{children:o?e.jsx(oe,{accessibilityLabel:"Carregando os meus tópicos..."}):e.jsx(e.Fragment,{children:a.map(l=>e.jsx(ie,{id:l.id,title:l.title,rating:l.rating,files:l.files,currentRating:l.current_user_rating,content:l.content,author:l.author.name,commentsCount:l.comments_count,categories:l.categories,isSave:l.current_user_has_saved||!1,deleteTopicCallback:d,isMyTopicScreen:!0},l.id))})})]})]})})}function zs(){return e.jsxs(at,{children:[e.jsxs(M,{path:"/",element:e.jsx(ee,{}),children:[e.jsx(M,{path:"/",element:e.jsx(vo,{})}),e.jsx(M,{path:"/topic/:id",element:e.jsx(as,{})})]}),e.jsx(M,{path:"/profile",element:e.jsx(ee,{}),children:e.jsx(M,{path:"/profile",element:e.jsx(es,{})})}),e.jsx(M,{path:"/categories",element:e.jsx(ee,{}),children:e.jsx(M,{path:"/categories",element:e.jsx(bs,{})})}),e.jsx(M,{path:"/create-topic",element:e.jsx(ee,{}),children:e.jsx(M,{path:"/create-topic",element:e.jsx(ys,{})})}),e.jsx(M,{path:"/saved-topics",element:e.jsx(ee,{}),children:e.jsx(M,{path:"/saved-topics",element:e.jsx(ks,{})})}),e.jsx(M,{path:"/my-topics",element:e.jsx(ee,{}),children:e.jsx(M,{path:"/my-topics",element:e.jsx(Qs,{})})}),e.jsxs(M,{path:"/login",element:e.jsx(Mo,{}),children:[e.jsx(M,{path:"/login",element:e.jsx(Io,{})}),e.jsx(M,{path:"/login/logon",element:e.jsx(zo,{})}),e.jsx(M,{path:"/login/create-account",element:e.jsx(Yo,{})})]})]})}const Es={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},Ts=lt`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function As(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(o){return console.log(o),"light"}},set:async o=>{try{localStorage.setItem("@UnBForum:theme",o)}catch(s){console.log(s)}}};return e.jsx(ct,{colorModeManager:t,children:e.jsx(dt,{theme:Es,children:e.jsxs(Kt,{children:[e.jsx(ut,{children:e.jsx(zs,{})}),e.jsx(Ts,{})]})})})}pt.createRoot(document.getElementById("root")).render(e.jsx(ht.StrictMode,{children:e.jsx(As,{})}));
