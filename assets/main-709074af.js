...
`,Ee=[{label:"Mais recentes",value:"-created_at",color:"#000"},{label:"Mais populares",value:"-rating",color:"#000"},{label:"Mais comentários",value:"-comments_count",color:"#000"}],D=Je.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),we=async()=>await D.get("categories/"),Lt=async t=>await D.post("categories/",t),It=async t=>await D.delete(`categories/${t}/`),Ut=async t=>await D.patch(`categories/${t.id}/`,{...t}),Pt=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;const ce=async t=>await D.get(`topics/?${We.stringify(t,{arrayFormat:"comma"})}`),Gt=async t=>await D.get(`topics/${t}`),Kt=async t=>await D.post("topics",t),Yt=async(t,s)=>await D.put(`topics/${s}`,t),Wt=async t=>await D.post(`topics/${t}/upvote`),$t=async t=>await D.post(`topics/${t}/downvote`),_t=async t=>await D.post(`topics/${t}/save`),es=async t=>await D.post(`topics/${t}/unsave`),ts=async()=>await D.get("users/me/saved_topics/"),ss=async()=>await D.get("users/me/topics/"),os=async t=>await D.delete(`topics/${t}/`),is=async t=>await D.post(`topics/${t}/fix/`),ie="moderator",ne="administrator",Re=r.createContext(null),ns=({children:t})=>{const[s,o]=r.useState(""),[a,n]=r.useState([]),[u,l]=r.useState(""),[g,c]=r.useState("");r.useEffect(()=>{const m=localStorage.getItem("@UnBForum:token");if(m){const x=De(m.split(" ")[1]);D.defaults.headers.common.Authorization=`${m}`,o(m.split(" ")[1]),n(x.scopes),l(x.sub),c(x.name)}},[]);const h=r.useCallback(m=>{localStorage.setItem("@UnBForum:token",`Bearer ${m}`);const x=De(m);D.defaults.headers.common.Authorization=`Bearer ${m}`,o(m),n(x.scopes),l(x.sub),c(x.name)},[]),d=r.useCallback(m=>a.some(x=>x===m),[a]),f=r.useCallback(()=>{o(""),n([]),l(""),c(""),D.defaults.headers.common.Authorization=null,localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(Re.Provider,{value:{token:s,name:g,email:u,scopes:a,changeToken:h,checkScopePermissions:d,logoutUser:f,setName:c},children:t})};function _(){const t=r.useContext(Re);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}const N=({id:t,status:s,variant:o="left-accent",title:a,description:n,isClosable:u=!1,...l})=>{const g=Y();return e.jsx(Se,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:s||"error",variant:o,...l,children:e.jsxs($e,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(Qe,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(Qe,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(Se.Icon,{}),e.jsx(Te,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:o==="solid"?"lightText":o!=="outline"?"darkText":null,children:a})]}),u?e.jsx(_e,{variant:"unstyled",icon:e.jsx(de,{size:"3"}),_icon:{color:o==="solid"?"lightText":"darkText"},onPress:()=>g.close(t)}):null]}),e.jsx(Te,{px:"6",color:o==="solid"?"lightText":o!=="outline"?"darkText":null,children:n})]})})},rs=async(t,s)=>await D.post(`topics/${s}/comments/`,{content:t}),as=async t=>await D.get(`topics/${t}/comments/`),ls=async(t,s)=>await D.post(`topics/${s}/comments/${t}/upvote`),cs=async(t,s)=>await D.post(`topics/${s}/comments/${t}/downvote`),ds=t=>`https://unbforum-backend-4b05406a8bbf.herokuapp.com/files/download/${t.upload_path}`;function ye(t){const s=t.split(" ");if(s.length>=2){const o=s[0],a=s[s.length-1],n=o[0],u=a[0];return n.toUpperCase()+u.toUpperCase()}else return s[0][0].toUpperCase()}const us=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function me({question:t,handleAccept:s,handleClose:o,cancelText:a="Cancelar",acceptText:n,isOpen:u,isLoadingAcceptButton:l=!1,loadingAcceptButtonText:g=""}){const c=ge({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:u&&e.jsx(us,{children:e.jsxs(ps,{children:[e.jsx(hs,{onClick:o,children:e.jsx(de,{size:"21",color:i.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(S,{size:c,variant:"outline",onPress:o,children:a}),e.jsx(S,{size:c,onPress:s,bgColor:i.colors.danger[500],isLoading:l,isLoadingText:g,children:n})]})]})})})}const ms=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Ns=async t=>{const s=new FormData;return s.append("files",t),await D.post("files/upload/",s,{headers:{"Content-Type":t.type}})};function ks({handleAddFile:t,handleDeleteFile:s,files:o,fileInputRef:a,filesUploadLimit:n=2,setIsAddFileLoading:u}){const l=Y(),g=async d=>{const f=d.target.files&&d.target.files[0];f&&o.length+1<=n?(u(!0),Ns(f).then(m=>{t(m.data[0])}).catch(m=>{l.show({placement:"top",render:()=>e.jsx(N,{id:"files-upload-error",status:"error",title:"Opa!",description:"Erro ao fazer upload do arquivo."})})}).finally(()=>{u(!1)})):l.show({placement:"top",render:()=>e.jsx(N,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},c=()=>{const d=[];return o.forEach((f,m)=>{d.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>s(f.name),children:e.jsx(xe,{size:"1.7rem",color:i.colors.primary[50]})}),e.jsx(tt,{size:"38",color:i.colors.gray[500]}),f.name]},m))}),d},h=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(js,{children:[e.jsx(bs,{fontSize:"1.2rem",children:`Arquivos (${o.length}/${n} arquivos adicionados)`}),e.jsx("input",{ref:a,id:"file-upload",type:"file",style:{display:"none"},onChange:g}),e.jsx(vs,{children:o.length>0?c():h()})]})})}const Le=t=>{let s=!0;const o=[],{title:a,content:n}=t;return(!a||a==="")&&(s=!1,o.push("Título")),(!n||n==="")&&(s=!1,o.push("Conteúdo")),{isValid:s,fieldErrors:o}},Ie=t=>{const{title:s,content:o,files:a,categories:n}=t;return{title:s,content:o,categories:n,files:a.map(u=>u.id)}};function je({isModalOpen:t,setIsModalOpen:s,isEditing:o=!1,topic:a=null,id:n=null}){const u=Y(),l=K("(max-width: 768px)"),g=r.useRef(null),[c,h]=r.useState(!1),[d,f]=r.useState(a||{title:"",content:"",files:[],categories:[]}),[m,x]=r.useState(!1),[j,A]=r.useState(!1),[T,k]=r.useState([]),E={control:C=>({...C,backgroundColor:i.colors.white}),option:(C,{data:v,isMulti:L,isDisabled:b,isFocused:y,isSelected:z})=>{const J=oe(v.color);return{...C,backgroundColor:b?void 0:z?L?v.color:J.alpha(.2).css():y?J.alpha(.1).css():void 0,color:b?"#ccc":z&&L?oe.contrast(J,"white")>2?"white":"black":v.color,cursor:b?"not-allowed":"default",":active":{...C[":active"],backgroundColor:b?void 0:z?v.color:J.alpha(.3).css()}}},multiValue:(C,{data:v})=>{const L=oe(v.color);return{...C,backgroundColor:L.alpha(.1).css()}},multiValueLabel:(C,{data:v})=>({...C,color:v.color}),multiValueRemove:(C,{data:v})=>({...C,color:v.color,":hover":{backgroundColor:v.color,color:"white"}}),input:C=>({...C,"input:focus":{boxShadow:"none"}})};r.useEffect(()=>{t&&we().then(C=>{k(C.data)})},[t]),r.useEffect(()=>{h(t),f(a||{title:"",content:"",files:[],categories:[]})},[t,a]);const I=r.useCallback((C,v)=>{Array.isArray(v)?f({...d,[C]:v.map(L=>Number(L.value))}):f({...d,[C]:v})},[d]),U=r.useCallback(C=>{A(C)},[]),P=C=>{C.preventDefault();const{isValid:v,fieldErrors:L}=Le(d);if(!v){u.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${L.reduce((b,y,z)=>z===0?`'${y}'`:z===L.length-1?`${b} e '${y}'`:`${b}, '${y}'`,"")}`,status:""})});return}x(!0),Kt(Ie(d)).then(b=>{u.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),F(),f({title:"",content:"",files:[],categories:[]})}).catch(b=>{u.show({placement:"top-right",render:()=>{let y="";return typeof b.response.data.detail=="object"?y=b.response.data.detail[0].msg.split(", ")[1]:y=b.response.data.detail,e.jsx(N,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${y}`,status:""})}})}).finally(()=>{x(!1)})},O=C=>{C.preventDefault();const{isValid:v,fieldErrors:L}=Le(d);if(!v||n===null){u.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${L.reduce((b,y,z)=>z===0?`'${y}'`:z===L.length-1?`${b} e '${y}'`:`${b}, '${y}'`,"")}`,status:""})});return}x(!0),Yt(Ie(d),n).then(b=>{u.show({placement:"top-right",render:()=>e.jsx(N,{id:"edit-topic-success",title:"Tópico Editado com Sucesso",description:"Agora todos podem ver seu tópico com as edições!",status:"success"})}),F(),f({title:"",content:"",files:[],categories:[]})}).catch(b=>{u.show({placement:"top-right",render:()=>{let y="";return typeof b.response.data.detail=="object"?y=b.response.data.detail[0].msg.split(", ")[1]:y=b.response.data.detail,e.jsx(N,{id:"edit-topic-error",title:"Campos Inválidos",description:`Erro: ${y}`,status:""})}})}).finally(()=>{x(!1)})},F=()=>{h(!1),setTimeout(()=>{s(!1)},300)},X=r.useCallback(C=>{f({...d,files:[...d.files,C]})},[d]),H=r.useCallback(C=>{const v=d.files.filter(L=>L.name!==C);f({...d,files:v})},[d]),w=()=>{g&&g.current&&g.current.click()},B=()=>{const C=b=>T.filter(y=>y.id===b)[0];let v=[];const L=d.categories.map(b=>C(b));return L.filter(b=>b!==void 0).length>0&&(v=L.map(b=>({value:b.id.toString(),label:b.name,color:b.color}))),v};return e.jsx(e.Fragment,{children:c&&e.jsx(ms,{isOpen:c,onClick:F,children:e.jsxs(gs,{isOpen:c,onClick:C=>C.stopPropagation(),children:[e.jsx(Cs,{onClick:F,children:e.jsx(de,{size:"2rem",color:i.colors.white})}),e.jsx("h1",{children:o?"Editar Tópico":"Novo Tópico"}),e.jsx(Z,{name:"title",onChange:I,value:d.title||void 0,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(Ve,{name:"content",onChange:I,value:d.content||void 0,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(fs,{children:e.jsx(pe,{isMulti:!0,closeMenuOnSelect:!1,value:B(),options:T.map(C=>({value:C.id.toString(),label:C.name,color:C.color})),styles:E,onChange:C=>I("categories",C),placeholder:"Adicionar categorias"})}),e.jsx(ks,{filesUploadLimit:2,fileInputRef:g,handleAddFile:X,handleDeleteFile:H,files:d.files,setIsAddFileLoading:U}),e.jsxs(xs,{children:[e.jsx(S,{onPress:()=>w(),size:l?"xs":"md",isLoading:j,isLoadingText:"Adicionando arquivo...",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(fe,{}),children:"Adicionar arquivos"}),e.jsx(S,{id:"create-topic-button",onPress:o?C=>O(C):C=>P(C),bgColor:i.colors.success[600],size:l?"xs":"md",isDisabled:j,borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:o?"Editando...":"Criando...",isLoading:m,rightIcon:e.jsx(Me,{}),children:o?"Editar":"Criar"})]})]})})})}const Ds=p.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;function W({accessibilityLabel:t,isInsideButton:s=!1}){return e.jsxs(Ds,{children:[e.jsx(st,{size:s?"sm":"lg",color:i.colors.primary[700],accessibilityLabel:t}),!s&&e.jsx(ot,{color:"primary.700",fontSize:"md",children:"Carregando..."})]})}function re({id:t,isInsideTopic:s=!1,isComment:o=!1,title:a="",author:n,content:u,topicId:l=null,currentRating:g=0,rating:c=0,files:h=[],categories:d=[],commentsCount:f=0,isSave:m=!1,isMyTopicScreen:x=!1,deleteTopicCallback:j=k=>new Promise(()=>null),fixedTopicCallback:A=()=>new Promise(()=>null),isFixed:T=!1}){const{token:k,checkScopePermissions:E}=_(),I=Y(),U=$(),P=K("(max-width: 768px)"),[O,F]=r.useState(c),[X,H]=r.useState(m),[w,B]=r.useState(T),[C,v]=r.useState(g),[L,b]=r.useState(!1),[y,z]=r.useState(!1),[J,R]=r.useState(!1),[M,V]=r.useState(!1);r.useEffect(()=>{v(g),F(c),H(m),B(T)},[g,c,m,T]);function ae(){U(`/topic/${t}`)}const le=()=>{I.show({placement:"top-right",render:()=>e.jsx(N,{id:"user-unlogged-error",title:"Opa!",description:"Para interagir com um tópico ou comentário, você precisa fazer login!",status:""})})};async function be(Q,G){if(Q.preventDefault(),!k){le();return}if(G>0){const ue=await(o?ls(t,l):Wt(t));F(ue.data.rating),v(C>0?0:1)}else{const ue=await(o?cs(t,l):$t(t));F(ue.data.rating),v(C<0?0:-1)}}function Oe(Q){if(Q.preventDefault(),!k){le();return}X?es(t).then(G=>{H(!1)}).catch(G=>{}):_t(t).then(G=>{H(!0)}).catch(G=>{})}function Ze(){if(!k){le();return}z(!0),os(t).then(Q=>{b(!1),j(t).then(),I.show({placement:"top-right",render:()=>e.jsx(N,{id:"delete-topic-success",title:"Tópico removido!",description:"Tópico removido com sucesso!",status:"success"})})}).catch(Q=>{}).finally(()=>{z(!1)})}function Xe(){const Q=w;if(!k){le();return}R(!0),is(t).then(G=>{A().then(),B(G.data.is_fixed),I.show({placement:"top-right",render:()=>e.jsx(N,{id:"fixed-topic-success",title:Q?"Tópico Desafixado":"Tópico fixado!",description:Q?"Tópico desafixado com sucesso!":"Tópico fixado com sucesso!",status:"success"})})}).catch(G=>{}).finally(()=>{R(!1)})}const ve=r.useCallback(Q=>{V(Q),Q||j(t).then()},[j,t]);function He(){switch(X){case!0:return e.jsx(dt,{size:"30",color:i.colors.darkBlue[400]});case!1:return e.jsx(ct,{size:"30",color:i.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(Rt,{children:[e.jsxs(Vt,{isInsideTopic:s,isComment:o,children:[e.jsxs("div",{id:"common-reactions",children:[e.jsx("button",{id:"reactionButton",onClick:Q=>be(Q,1),children:e.jsx(it,{color:C>0?i.colors.tertiary[500]:i.colors.muted[500],size:"18"})}),e.jsx("p",{children:O}),e.jsx("button",{id:"reactionButton",onClick:Q=>be(Q,-1),children:e.jsx(nt,{color:C<0?i.colors.tertiary[500]:i.colors.muted[500],size:"18"})}),!o&&e.jsx("button",{id:"markButton",onClick:Q=>Oe(Q),children:He()})]}),(E(ne)||E(ie))&&!o&&e.jsx("button",{id:"pinnedButton",onClick:()=>Xe(),style:{border:w?"none":`1px solid ${i.colors.yellow[500]}`,backgroundColor:w?`${i.colors.yellow[500]}`:`${i.colors.white}`},children:J?e.jsx(W,{isInsideButton:!0,accessibilityLabel:"Fixando tópico..."}):e.jsx(rt,{color:w?i.colors.white:i.colors.yellow[500],size:P?"22":"30"})}),(k&&x||E(ne)||E(ie))&&!o&&e.jsxs("div",{id:"user-buttons",style:{display:"flex",flexDirection:"column",gap:".2rem"},children:[e.jsx("button",{id:"deleteButton",onClick:()=>b(!0),children:e.jsx(xe,{color:i.colors.white,size:P?"22":"30"})}),e.jsx("button",{id:"editButton",onClick:()=>ve(!0),children:e.jsx(at,{color:i.colors.white,size:P?"22":"30"})})]})]}),e.jsx(Ot,{children:e.jsxs(Zt,{isInsideTopic:s,isComment:o,children:[s&&e.jsx("h1",{id:"post-title",children:a}),e.jsxs(Xt,{isInsideTopic:s,children:[e.jsx(Ce,{bg:o?"lime.600":"emerald.600",marginRight:"0.8rem",size:o?"xs":"sm",children:ye(n)}),e.jsxs("p",{children:[n,!s&&!o&&` - ${a}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:u.replace(/\n/g,"<br>")}}),h.length>0&&e.jsx(he,{width:"80%"}),h.map((Q,G)=>e.jsxs("span",{children:["Para acessar o arquivo ",`${G+1}: `,e.jsx("a",{href:ds(Q),target:"_blank",rel:"noreferrer",children:"clique aqui"})]},Q.id)),!o&&e.jsx(Ht,{children:d.map(Q=>e.jsx(qe,{variant:"solid",bg:Q.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:Q.name})},Q.id))}),!s&&!o&&e.jsx(Jt,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:P?"0.8rem":"1rem"},isInsideTopic:s,onPress:s?()=>{}:()=>ae(),rightIcon:e.jsx(lt,{size:P?"18":"20",color:i.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${f})`})]})})]}),e.jsx(he,{alignSelf:"flex-end",width:o?"95%":"100%",marginTop:s?"0rem":"0.5rem",height:o||!s?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}}),e.jsx(me,{isOpen:L,handleAccept:Ze,handleClose:()=>b(!1),question:"Tem certeza que deseja remover seu tópico?",acceptText:"Remover",isLoadingAcceptButton:y,loadingAcceptButtonText:"Removendo..."}),e.jsx(je,{isModalOpen:M,setIsModalOpen:ve,isEditing:!0,topic:{title:a,categories:d.map(Q=>Q.id),files:h,content:u},id:t})]})}const Ss=p.button`
  width: 90%;
  display: flex;
  flex-direction: column;
  text-align: left;
...
`;function As({favoriteTopic:t}){const s=$();return e.jsxs(Ss,{onClick:()=>s(`/topic/${t.id}`),children:[e.jsxs(Qs,{children:[e.jsx(Ce,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:ye(t.author.name)}),e.jsx("p",{children:`${t.author.name} - ${t.title}`})]}),e.jsxs(Ts,{children:[e.jsx("p",{dangerouslySetInnerHTML:{__html:t.content.replace(/\n/g,"<br>")}}),e.jsx(zs,{children:t.categories.map(o=>e.jsx(qe,{variant:"solid",bg:o.color,alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:o.name})},o.id))})]})]})}function Es(){const{token:t}=_(),s=K("(max-width: 768px)"),[o,a]=r.useState(!1),[n,u]=r.useState([]),[l,g]=r.useState([]),[c,h]=r.useState(!1),[d,f]=r.useState([]),[m,x]=r.useState("-created_at"),[j,A]=r.useState(""),[T,k]=r.useState(""),[E,I]=r.useState(!1);r.useEffect(()=>window.scrollTo(0,0),[]),r.useEffect(()=>{o||(I(!0),h(!0),Promise.all([ce({search:T,order_by:m,category__id__in:d}).then(w=>{u(w.data)}).finally(()=>I(!1)),ce({is_fixed:!0}).then(w=>{g(w.data)}).finally(()=>h(!1))]).then())},[o,T,m,d]);const U=r.useCallback(async()=>{I(!0),h(!0),Promise.all([ce({search:T,order_by:m,category__id__in:d}).then(w=>{u(w.data)}).finally(()=>I(!1)),ce({is_fixed:!0}).then(w=>{g(w.data)}).finally(()=>h(!1))]).then()},[T,d,m]),P=r.useCallback(w=>{a(w)},[]),O=r.useCallback(w=>{f(w.map(B=>B.value))},[]),F=r.useCallback(w=>{x(w.value)},[]),X=r.useCallback((w,B)=>{A(B)},[]),H=r.useCallback(()=>{k(j)},[j]);return e.jsxs(e.Fragment,{children:[e.jsxs(Nt,{children:[e.jsxs(kt,{children:[e.jsx(ut,{isDisabled:t,label:t?null:"Para criar um tópico é necessário estar logado",children:e.jsx(S,{isDisabled:!t,bgColor:i.colors.success[600],size:s?"xs":"lg",borderRadius:"4px",rightIcon:e.jsx(fe,{}),onPress:()=>P(!0),children:e.jsx("p",{children:"Criar Tópico"})})}),e.jsx(qt,{onChangeCategoriesFilter:O,onChangeOrderBy:F,onChangeSearchInput:X,handleSearch:H}),E?e.jsx(W,{accessibilityLabel:"Carregando os tópicos..."}):e.jsx(e.Fragment,{children:e.jsx(Dt,{children:n.map(w=>e.jsx(re,{id:w.id,title:w.title,rating:w.rating,files:w.files,currentRating:w.current_user_rating,content:w.content,author:w.author.name,commentsCount:w.comments_count,categories:w.categories,isSave:w.current_user_has_saved,isFixed:w.is_fixed,fixedTopicCallback:U},w.id))})})]}),e.jsx(St,{children:e.jsxs(Qt,{children:[e.jsxs("div",{id:"favorite-title-container",children:[e.jsx("h1",{id:"title-favorites",children:"Tópicos Fixados"}),e.jsx(pt,{color:i.colors.rose[600],size:"22"})]}),c?e.jsx(W,{accessibilityLabel:"Carregando tópicos favoritos..."}):l.map((w,B)=>e.jsx(As,{favoriteTopic:w},B))]})})]}),e.jsx(je,{isModalOpen:o,setIsModalOpen:P})]})}const Ls="/assets/InlineLogo-bd32ea4c.png",Is=p.header`
  width: 100%;
  height: 6rem;
  display: flex;
  align-items: center;
...
`,Bs=t=>{let s=!0;const o=[],{email:a,password:n}=t;return(!a||a==="")&&(s=!1,o.push("Email Institucional")),(!n||n==="")&&(s=!1,o.push("Senha")),{isValid:s,fieldErrors:o}},Rs=async t=>{const{username:s,password:o}=t,a=new FormData;return a.append("username",s),a.append("password",o),await D.post("auth/login",a)},Vs=t=>{const{email:s,password:o}=t;return{username:s,password:o}};function Os(){const t=$(),s=Y(),{changeToken:o}=_(),[a,n]=r.useState({email:"",password:""}),[u,l]=r.useState(!1),g=r.useCallback((h,d)=>{n({...a,[h]:d})},[a]);function c(h){h.preventDefault();const{isValid:d,fieldErrors:f}=Bs(a);if(!d){s.show({placement:"top-right",render:()=>e.jsx(N,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${f.reduce((m,x,j)=>j===0?`'${x}'`:j===f.length-1?`${m} e '${x}'`:`${m}, '${x}'`,"")}`,status:""})});return}l(!0),Rs(Vs(a)).then(m=>{s.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário logado com sucesso!
Agora você pode criar tópicos e interagir com eles!`,status:"success"})}),o(m.data.access_token),t("/")}).catch(m=>{s.show({placement:"top-right",render:()=>{let x="";return typeof m.response.data.detail=="object"?x=m.response.data.detail[0].msg.split(", ")[1]:x=m.response.data.detail,e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${x}`,status:""})}})}).finally(()=>{l(!1)})}return e.jsxs(Fs,{children:[e.jsx(te,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(Z,{name:"email",onChange:g,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(Z,{name:"password",onChange:g,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(S,{onPress:h=>c(h),variant:"solid",size:"lg",isLoading:u,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(S,{onPress:h=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const Zs=p.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`;function $s({label:t,placeholder:s,options:o=[],onChange:a,isRequired:n=!0,fontSize:u="0.9rem",isEditing:l=!0,name:g}){return e.jsxs(Ws,{fontSize:u,children:[e.jsxs("label",{className:"create-account-label",children:[t,n&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(Ae,{variant:"outline",height:9,size:"md",isDisabled:!l,onValueChange:c=>a(g,c),placeholder:s,accessibilityLabel:"Selecione a opção",children:o.map(c=>e.jsx(Ae.Item,{label:c.label,value:c.value},c.label))})]})}const _s=async t=>await D.post("users",t),Ue=async()=>await D.get("users/me"),eo=async t=>await D.patch("users/me",t),to=async t=>await D.post("users/me/change_password",t),so=async()=>await D.delete("users/me"),oo=t=>{let s=!0;const o=[],{name:a,email:n,profile:u,course:l,password:g,passwordConfirm:c}=t;return(!a||a==="")&&(s=!1,o.push("Nome Completo")),(!n||n==="")&&(s=!1,o.push("Email Institucional")),(!u||u==="")&&(s=!1,o.push("Papel na Instituição")),(!l||l==="")&&(s=!1,o.push("Curso")),(!g||g==="")&&(s=!1,o.push("Senha")),(!c||c===""||c!==g)&&(s=!1,o.push("Confirme a senha")),{isValid:s,fieldErrors:o}},io=t=>{const{name:s,email:o,profile:a,course:n,password:u}=t;return{name:s,email:o,password:u,tags:[a,n]}};function no(){const t=$(),s=Y(),o=ge({lg:"lg",base:"md"}),[a,n]=r.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[u,l]=r.useState(!1),g=r.useCallback((d,f)=>{n({...a,[d]:f})},[a]),c=async d=>{d.preventDefault();const{isValid:f,fieldErrors:m}=oo(a);if(!f){s.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${m.reduce((x,j,A)=>A===0?`'${j}'`:A===m.length-1?`${x} e '${j}'`:`${x}, '${j}'`,"")}`,status:""})});return}l(!0),_s(io(a)).then(x=>{s.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(x=>{s.show({placement:"top-right",render:()=>{let j="";return typeof x.response.data.detail=="object"?j=x.response.data.detail[0].msg.split(", ")[1]:j=x.response.data.detail,e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${j}`,status:""})}})}).finally(()=>{l(!1)})};function h(d){switch(d.input){case"select":return e.jsx($s,{label:d.label,placeholder:d.placeholder,options:d.options,name:d.name,onChange:g,accessibilityLabel:d.accessibilityLabel},d.label);default:return e.jsx(Z,{label:d.label,placeholder:d.placeholder,inputType:d.type,name:d.name,onChange:g,accessibilityLabel:d.accessibilityLabel},d.label)}}return e.jsxs(Js,{children:[e.jsx(te,{}),e.jsxs("div",{className:"inputs-container",children:[Ys.map(d=>h(d)),e.jsx(S,{onPress:d=>c(d),variant:"solid",size:o,isLoading:u,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(S,{onPress:d=>t(-1),variant:"outline",size:o,children:"Voltar"})]})]})}const ro=p.section`
  width: 80%;
...
`,ao=t=>{let s=!0;const o=[];return(!t||t==="")&&(s=!1,o.push("Nome Completo")),{isValid:s,fieldErrors:o}},lo=(t,s)=>{let o=!0;const a=[];let n="";return(!t||t==="")&&(o=!1,a.push("Senha Atual")),(!s||s==="")&&(o=!1,a.push("Nova Senha")),!s&&s===t&&(o=!1,n="Nova senha não pode ser a mesma que a atual"),{isValid:o,fieldErrors:a,specialError:n}};function co(){const t=$(),s=Y(),{name:o,email:a,setName:n,logoutUser:u}=_(),l=ge({lg:"lg",base:"md"}),[g,c]=r.useState(!1),[h,d]=r.useState(!1),[f,m]=r.useState(!1),[x,j]=r.useState(!1),[A,T]=r.useState({email:a,id:0,name:o,role:"",tags:[]}),[k,E]=r.useState(!1),[I,U]=r.useState(!1),[P,O]=r.useState(!1),[F,X]=r.useState(""),[H,w]=r.useState("");r.useEffect(()=>{Ue().then(y=>{T(y.data),n(y.data.name)})},[n]);const B=r.useCallback((y,z)=>{T({...A,[y]:z})},[A]),C=r.useCallback(()=>{U(!0),so().then(()=>{}).finally(()=>{s.show({placement:"top-right",render:()=>e.jsx(N,{id:"delete-user-success",title:"Usuário excluído!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),u(),U(!1),d(!1),t("/")})},[t,u,s]),v=y=>{y.preventDefault();const{fieldErrors:z,isValid:J}=ao(A.name);if(!J){s.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${z.reduce((R,M,V)=>V===0?`'${M}'`:V===z.length-1?`${R} e '${M}'`:`${R}, '${M}'`,"")}`,status:""})});return}E(!0),eo({name:A.name}).then(R=>{s.show({placement:"top-right",render:()=>e.jsx(N,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),n(A.name)}).catch(R=>{s.show({placement:"top-right",render:()=>{let M="";return typeof R.response.data.detail=="object"?M=R.response.data.detail[0].msg.split(", ")[1]:M=R.response.data.detail,e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${M}`,status:""})}})}).finally(()=>{E(!1),m(!1)})},L=y=>{y.preventDefault();const{fieldErrors:z,isValid:J,specialError:R}=lo(F,H);if(!J){s.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:z.length>0?`Os sequintes campos estão incorretos: ${z.reduce((M,V,ae)=>ae===0?`'${V}'`:ae===z.length-1?`${M} e '${V}'`:`${M}, '${V}'`,"")}`:R,status:""})});return}O(!0),to({current_password:F,new_password:H}).then(M=>{s.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(M=>{s.show({placement:"top-right",render:()=>{let V="";return typeof M.response.data.detail=="object"?V=M.response.data.detail[0].msg.split(", ")[1]:V=M.response.data.detail,e.jsx(N,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${V}`,status:""})}})}).finally(()=>{O(!1),j(!1),X(""),w("")})},b=()=>f?e.jsxs(e.Fragment,{children:[e.jsx(S,{variant:"solid",size:l,onPress:()=>{m(!1),Ue().then(y=>{T(y.data)})},children:"Cancelar"}),e.jsx(S,{variant:"outline",size:l,isLoading:k,isLoadingText:"Atualizando Usuário...",onPress:y=>v(y),children:"Atualizar Usuário"})]}):x?e.jsxs(e.Fragment,{children:[e.jsx(S,{variant:"solid",size:l,onPress:()=>{j(!1),X(""),w("")},children:"Cancelar"}),e.jsx(S,{variant:"outline",size:l,isLoading:P,isLoadingText:"Atualizando Senha...",onPress:y=>L(y),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(S,{variant:"solid",size:l,onPress:()=>m(!0),children:"Editar Perfil"}),e.jsx(S,{variant:"outline",size:l,onPress:()=>j(!0),children:"Alterar Senha"})]});return e.jsxs(ro,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(te,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(Z,{name:"name",onChange:B,isEditing:f,value:A.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(Z,{name:"email",onChange:()=>{},isEditing:!1,value:A.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(Z,{name:"password",onChange:(y,z)=>X(z),isEditing:x,value:x?F:"valordeteste",label:x?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),x&&e.jsx(Z,{name:"passwordConfirm",onChange:(y,z)=>w(z),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),b(),!f&&!x&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(S,{variant:"subtle",size:"md",onPress:()=>c(!0),children:"Sair"}),e.jsx(S,{variant:"subtle",size:"md",onPress:()=>d(!0),children:"Remover a Conta"})]})]}),e.jsx(me,{isOpen:g,handleAccept:()=>{c(!1),u(),t("/")},handleClose:()=>c(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(me,{isOpen:h,handleAccept:()=>{C()},handleClose:()=>d(!1),question:"Tem certeza que deseja remover sua conta?",acceptText:"Remover",isLoadingAcceptButton:I,loadingAcceptButtonText:"Deletando..."})]})}const uo=p.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,To=t=>{let s=!0;const o=[],{name:a,color:n}=t;return(!a||a==="")&&(s=!1,o.push("Nome da Categoria")),(!n||n==="")&&(s=!1,o.push("Cor da Categoria")),{isValid:s,fieldErrors:o}};function zo({isModalOpen:t,setIsModalOpen:s,title:o=null,selectedCategory:a=null,isEditing:n=!1}){const u=Y(),l=K("(max-width: 768px)"),[g,c]=r.useState(!1),[h,d]=r.useState(a||{id:0,color:"#10B981",name:""}),[f,m]=r.useState(!1);r.useEffect(()=>{c(t),d(a||{id:0,color:"#10B981",name:""})},[t,a]);const x=r.useCallback((T,k)=>{d({...h,[T]:k})},[h]),j=T=>{T.preventDefault();const{isValid:k,fieldErrors:E}=To(h);k||u.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${E.reduce((U,P,O)=>O===0?`'${P}'`:O===E.length-1?`${U} e '${P}'`:`${U}, '${P}'`,"")}`,status:""})}),m(!0),(n?Ut:Lt)(h).then(U=>{u.show({placement:"top-right",render:()=>e.jsx(N,{id:"create-category-success",title:"Categoria Criada com Sucesso",description:"Agora todos podem utilizar a nova categoria!",status:"success"})}),A(),d({id:0,color:"#10B981",name:""})}).catch(U=>{u.show({placement:"top-right",render:()=>{let P="";return typeof U.response.data.detail=="object"?P=U.response.data.detail[0].msg.split(", ")[1]:P=U.response.data.detail,e.jsx(N,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${P}`,status:""})}})}).finally(()=>{m(!1)})},A=()=>{c(!1),setTimeout(()=>{s(!1)},300)};return e.jsx(e.Fragment,{children:g&&e.jsx(No,{isOpen:g,onClick:A,children:e.jsxs(ko,{isOpen:g,onClick:T=>T.stopPropagation(),children:[e.jsx(So,{onClick:A,children:e.jsx(de,{size:"2rem",color:i.colors.primary[50]})}),e.jsx("h1",{children:o||"Nova categoria"}),e.jsx(Z,{name:"name",onChange:x,fontSize:"1.2rem",value:h.name||void 0,size:"lg",inputType:"text",accessibilityLabel:"Nome da Categoria",label:"Nome da Categoria",placeholder:"Digite o nome da categoria..."}),e.jsx(Z,{name:"color",onChange:x,fontSize:"1.2rem",value:h.color,size:"lg",inputType:"text",accessibilityLabel:"Cor da Categoria (com #)",label:"Cor da Categoria (com #)",placeholder:"Escolha a cor da categoria #000000..."}),e.jsx(Qo,{color:h.color}),e.jsx(Do,{children:e.jsx(S,{id:"create-topic-button",onPress:T=>j(T),bgColor:i.colors.success[600],size:l?"xs":"md",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:f,rightIcon:e.jsx(Me,{}),children:"Criar"})})]})})})}const Pe="Nova Categoria";function Ao(){const t=Y(),{checkScopePermissions:s}=_(),o=K("(max-width: 768px)"),[a,n]=r.useState([]),[u,l]=r.useState(null),[g,c]=r.useState(!1),[h,d]=r.useState(Pe),[f,m]=r.useState(!1);r.useEffect(()=>{g||x().then()},[g]);const x=async()=>{m(!0),we().then(k=>{n(k.data)}).finally(()=>{m(!1)})},j=r.useCallback(k=>{c(k),l(null),d(Pe)},[]),A=(k,E)=>{k.preventDefault(),m(!0),It(E).then(I=>{t.show({placement:"top-right",render:()=>e.jsx(N,{id:"delete-category-success",title:"Categoria Apagada com Sucesso",description:"",status:"success"})}),x().then()}).catch(I=>{t.show({placement:"top-right",render:()=>{let U="";return typeof I.response.data.detail=="object"?U=I.response.data.detail[0].msg.split(", ")[1]:U=I.response.data.detail,e.jsx(N,{id:"create-category-error",title:"Erro ao apagar categoria",description:`Erro: ${U}`,status:""})}})}).finally(()=>{m(!1)})},T=(k,E)=>{k.preventDefault(),l(E),d("Editar Categoria"),c(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs(Co,{children:[e.jsx("div",{className:"logo-categories-container",children:e.jsx(te,{})}),e.jsxs("section",{className:"categories-list",children:[e.jsxs("div",{id:"create-category",children:[e.jsx("h1",{className:"categories-page-title",children:"Lista de Categorias"}),(s(ne)||s(ie))&&e.jsx(S,{size:o?"sm":"lg",rightIcon:e.jsx(fe,{}),onPress:()=>j(!0),children:"Criar categoria"})]}),e.jsx(wo,{children:f?e.jsx(W,{accessibilityLabel:"Carregando os tópicos..."}):e.jsx(e.Fragment,{children:a.map(k=>e.jsxs("div",{id:"category-card",children:[(s(ne)||s(ie))&&e.jsxs(jo,{children:[e.jsx(bo,{onClick:E=>T(E,k),children:e.jsx(xt,{color:i.colors.primary[50]})}),e.jsx(vo,{onClick:E=>A(E,k.id),children:e.jsx(xe,{color:i.colors.primary[50]})})]}),e.jsx("p",{id:"category-name",children:k.name}),e.jsx(yo,{colorIndicator:k.color})]},k.id))})})]})]}),(s(ne)||s(ie))&&e.jsx(zo,{isModalOpen:g,setIsModalOpen:j,selectedCategory:u,isEditing:u!==null,title:h})]})}function Eo(){const t=$();return e.jsx(e.Fragment,{children:e.jsx(je,{isModalOpen:!0,setIsModalOpen:()=>t("/")})})}const Lo=p.section`
  position: relative;
  width: 80%;
  height: calc(100vh - 6rem);
  display: flex;
