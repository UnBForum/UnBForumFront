...
`;function c3(){const t=Q();function n(r){r.preventDefault(),t("/")}return e.jsxs(A3,{children:[e.jsx(j,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(b,{name:"email",onChange:()=>{},accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(b,{name:"password",onChange:()=>{},accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(h,{onPress:r=>n(r),variant:"solid",size:"lg",children:"Entrar"}),e.jsx(h,{onPress:r=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const d3=s.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
