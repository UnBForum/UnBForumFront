import{s as p,t as r,a as Qe,j as e,I as De,u as O,r as a,F as ke,S as $,P as Se,b as ie,B as j,c as M,n as ae,q as ze,d as le,e as I,A as ce,V as Ue,H as de,T as Ae,f as Te,C as se,g as F,h as Le,i as qe,k as oe,D as _,l as fe,m as Pe,o as Ee,p as Ve,v as Xe,w as Re,x as Ze,y as xe,z as He,E as Je,G as We,J as Ie,K as Be,M as G,L as Fe,N as Me,O as Oe,Q as ge,R as ue,U as ne,W as Ge,X as Ke,Y as Ye,Z as J,_ as $e,$ as _e,a0 as e1,a1 as t1,a2 as s1,a3 as o1}from"./vendor-313f1ac2.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const c of n)if(c.type==="childList")for(const d of c.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function o(n){const c={};return n.integrity&&(c.integrity=n.integrity),n.referrerPolicy&&(c.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?c.credentials="include":n.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(n){if(n.ep)return;n.ep=!0;const c=o(n);fetch(n.href,c)}})();window.global||(window.global=window);const n1=p.main`
  width: 70%;
  display: flex;
...
`,pe=[{label:"Mais recentes",value:"-created_at",color:"#000"},{label:"Mais populares",value:"-rating",color:"#000"},{label:"Mais comentários",value:"-comments_count",color:"#000"}],w=Qe.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),ve=async()=>await w.get("categories/"),p1=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function W({label:t="",inputType:s="text",placeholder:o,accessibilityLabel:i,size:n="md",fontSize:c="0.9rem",name:d,isRequired:u=!0,isEditing:l=!0,value:h=void 0,backgroundColor:A=null,height:m=null,onChange:C,...x}){return e.jsxs(p1,{children:[t&&e.jsxs(h1,{fontSize:c,children:[t,u&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(De,{height:m||null,type:s,variant:l?"outline":"filled",size:n,backgroundColor:A||null,isRequired:u,value:h,placeholder:o,editable:l,accessibilityLabel:i,onChangeText:N=>C(d,N),...x})]})}function m1({onChangeCategoriesFilter:t,onChangeOrderBy:s,onChangeSearchInput:o,handleSearch:i}){const n=O("(max-width: 768px)"),[c,d]=a.useState([]),u={control:l=>({...l,backgroundColor:r.colors.white}),option:(l,{data:h,isMulti:A,isDisabled:m,isFocused:C,isSelected:x})=>{const N=M(h.color);return{...l,backgroundColor:m?void 0:x?A?h.color:N.alpha(.2).css():C?N.alpha(.1).css():void 0,color:m?"#ccc":x&&A?M.contrast(N,"white")>2?"white":"black":h.color,cursor:m?"not-allowed":"default",":active":{...l[":active"],backgroundColor:m?void 0:x?h.color:N.alpha(.3).css()}}},multiValue:(l,{data:h})=>{const A=M(h.color);return{...l,backgroundColor:A.alpha(.1).css()}},multiValueLabel:(l,{data:h})=>({...l,color:h.color}),multiValueRemove:(l,{data:h})=>({...l,color:h.color,":hover":{backgroundColor:h.color,color:"white"}}),input:l=>({...l,"input:focus":{boxShadow:"none"}})};return a.useEffect(()=>{ve().then(l=>{d(l.data)})},[]),e.jsxs(c1,{children:[e.jsxs(d1,{children:[e.jsx(ke,{size:20,color:r.colors.tertiary[300]}),e.jsx($,{isMulti:!0,closeMenuOnSelect:!1,options:c.map(l=>({value:l.id.toString(),label:l.name,color:l.color})),styles:u,onChange:t,placeholder:"Filtrar por categorias"})]}),e.jsxs(u1,{children:[e.jsx(Se,{size:22,color:r.colors.tertiary[300]}),e.jsx($,{isMulti:!1,defaultValue:pe[0],options:pe,placeholder:"Ordenar Tópicos",styles:u,onChange:s})]}),e.jsxs(A1,{children:[e.jsx(ie,{color:r.colors.tertiary[300],size:"22"}),e.jsx(W,{name:"topic-search",height:"2.4rem",size:n?"md":"lg",backgroundColor:r.colors.white,accessibilityLabel:"Buscar tópicos",placeholder:"Buscar tópicos...",inputType:"text",onChange:o,InputRightElement:e.jsx(j,{rounded:"none",w:"1/12",h:"full",onPress:i,children:e.jsx(ie,{color:r.colors.white,size:"22"})})})]})]})}const C1=(t,s)=>t?"0.9rem":s?"1rem":"0.9rem",f1=(t,s)=>t?"0.7rem":s?"0.8rem":"0.7rem",x1=p.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`;const w1=async t=>await w.get(`topics/?${ze.stringify(t,{arrayFormat:"comma"})}`),Q1=async t=>await w.get(`topics/${t}`),D1=async t=>await w.post("topics",t),k1=async t=>await w.post(`topics/${t}/upvote`),S1=async t=>await w.post(`topics/${t}/downvote`),Ne=a.createContext(null),z1=({children:t})=>{const[s,o]=a.useState(""),[i,n]=a.useState([]),[c,d]=a.useState(""),[u,l]=a.useState("");a.useEffect(()=>{const m=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",m),m){const C=le(m.split(" ")[1]);w.defaults.headers.common.Authorization=`${m}`,o(m.split(" ")[1]),n(C.scopes),d(C.sub),l(C.name)}},[]);const h=a.useCallback(m=>{localStorage.setItem("@UnBForum:token",`Bearer ${m}`);const C=le(m);w.defaults.headers.common.Authorization=`Bearer ${m}`,o(m),n(C.scopes),d(C.sub),l(C.name)},[]),A=a.useCallback(()=>{o(""),n([]),d(""),l(""),w.defaults.headers.common.Authorization=null,localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(Ne.Provider,{value:{token:s,name:u,email:c,scopes:i,changeToken:h,logoutUser:A,setName:l},children:t})};function B(){const t=a.useContext(Ne);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}const y=({id:t,status:s,variant:o="left-accent",title:i,description:n,isClosable:c=!1,...d})=>{const u=I();return e.jsx(ce,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:s||"error",variant:o,...d,children:e.jsxs(Ue,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(de,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(de,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(ce.Icon,{}),e.jsx(Ae,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:o==="solid"?"lightText":o!=="outline"?"darkText":null,children:i})]}),c?e.jsx(Te,{variant:"unstyled",icon:e.jsx(se,{size:"3"}),_icon:{color:o==="solid"?"lightText":"darkText"},onPress:()=>u.close(t)}):null]}),e.jsx(Ae,{px:"6",color:o==="solid"?"lightText":o!=="outline"?"darkText":null,children:n})]})})},U1=async(t,s)=>await w.post(`topics/${s}/comments/`,{content:t}),T1=async t=>await w.get(`topics/${t}/comments/`),L1=async(t,s)=>await w.post(`topics/${s}/comments/${t}/upvote`),q1=async(t,s)=>await w.post(`topics/${s}/comments/${t}/downvote`),P1=t=>`https://unbforum-backend-4b05406a8bbf.herokuapp.com/files/download/${t.upload_path}`;function be(t){const s=t.split(" ");if(s.length>=2){const o=s[0],i=s[s.length-1],n=o[0],c=i[0];return n.toUpperCase()+c.toUpperCase()}else return s[0][0].toUpperCase()}function ee({id:t,isInsideTopic:s=!1,isComment:o=!1,title:i="",author:n,content:c,topicId:d=null,currentRating:u=0,rating:l=0,files:h=[],categories:A=[],commentsCount:m=0}){const{token:C}=B(),x=I(),N=F(),Q=O("(max-width: 768px)"),[U,X]=a.useState(l),[R,Z]=a.useState(!1),[P,g]=a.useState(u);a.useEffect(()=>{g(u),X(l)},[u,l]);function T(){N(`/topic/${t}`)}const f=()=>{x.show({placement:"top-right",render:()=>e.jsx(y,{id:"user-unlogged-error",title:"Opa!",description:"Para interagir com um tópico ou comentário, você precisa fazer login!",status:""})})};async function b(v,L){if(v.preventDefault(),!C){f();return}if(L>0){const E=await(o?L1(t,d):k1(t));X(E.data.rating),g(P>0?0:1)}else{const E=await(o?q1(t,d):S1(t));X(E.data.rating),g(P<0?0:-1)}}function k(v){v.preventDefault(),Z(!R)}function D(){switch(R){case!0:return e.jsx(Ve,{size:"30",color:r.colors.darkBlue[400]});case!1:return e.jsx(Ee,{size:"30",color:r.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(x1,{children:[e.jsxs(g1,{isInsideTopic:s,isComment:o,children:[e.jsx("button",{id:"reactionButton",onClick:v=>b(v,1),children:e.jsx(Le,{color:P>0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),e.jsx("p",{children:U}),e.jsx("button",{id:"reactionButton",onClick:v=>b(v,-1),children:e.jsx(qe,{color:P<0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),!o&&e.jsx("button",{id:"markButton",onClick:v=>k(v),children:D()})]}),e.jsx(v1,{children:e.jsxs(N1,{isInsideTopic:s,isComment:o,children:[s&&e.jsx("h1",{id:"post-title",children:i}),e.jsxs(b1,{isInsideTopic:s,children:[e.jsx(oe,{bg:o?"lime.600":"emerald.600",marginRight:"0.8rem",size:o?"xs":"sm",children:be(n)}),e.jsxs("p",{children:[n,!s&&!o&&` - ${i}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:c.replace(/\n/g,"<br>")}}),h.length>0&&e.jsx(_,{width:"80%"}),h.map((v,L)=>e.jsxs("span",{children:["Para acessar o arquivo ",`${L+1}: `,e.jsx("a",{href:P1(v),target:"_blank",rel:"noreferrer",children:"clique aqui"})]},v.id)),!o&&e.jsx(j1,{children:A.map(v=>e.jsx(fe,{variant:"solid",bg:v.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:v.name})},v.id))}),!s&&!o&&e.jsx(y1,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:Q?"0.8rem":"1rem"},isInsideTopic:s,onPress:s?()=>{}:()=>T(),rightIcon:e.jsx(Pe,{size:Q?"18":"20",color:r.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${m})`})]})})]}),e.jsx(_,{alignSelf:"flex-end",width:o?"95%":"100%",marginTop:s?"0rem":"0.5rem",height:o||!s?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const E1=p.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function je({label:t="",inputType:s="text",placeholder:o,accessibilityLabel:i,size:n="md",fontSize:c="0.9rem",isRequired:d=!0,isEditing:u=!0,name:l,isComment:h=!1,value:A=void 0,onChange:m,...C}){return e.jsxs(F1,{isComment:h,children:[t&&e.jsxs(M1,{fontSize:c,children:[t,d&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(Xe,{type:s,variant:u?"outline":"filled",size:n,placeholder:o,accessibilityLabel:i,editable:u,onChangeText:x=>m(l,x),autoCompleteType:null,value:A,totalLines:5,maxLength:700,...C})]})}const O1=p.div`
  position: relative;
...
`,Y1=async t=>{const s=new FormData;return s.append("files",t),console.log(s),await w.post("files/upload/",s,{headers:{"Content-Type":t.type}})};function $1({handleAddFile:t,handleDeleteFile:s,files:o,fileInputRef:i,filesUploadLimit:n=2,setIsAddFileLoading:c}){const d=I(),u=async A=>{const m=A.target.files&&A.target.files[0];m&&o.length+1<=n?(console.log("tentando subir arquivo1"),c(!0),console.log("tentando subir arquivo2"),Y1(m).then(C=>{console.log(C.data[0]),t(C.data[0])}).catch(C=>{d.show({placement:"top",render:()=>e.jsx(y,{id:"files-upload-error",status:"error",title:"Opa!",description:"Erro ao fazer upload do arquivo."})})}).finally(()=>{c(!1)})):d.show({placement:"top",render:()=>e.jsx(y,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},l=()=>{const A=[];return o.forEach((m,C)=>{A.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>s(m.name),children:e.jsx(Re,{size:"1.7rem",color:r.colors.primary[50]})}),e.jsx(Ze,{size:"38",color:r.colors.gray[500]}),m.name]},C))}),A},h=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(O1,{children:[e.jsx(G1,{fontSize:"1.2rem",children:`Arquivos (${o.length}/${n} arquivos adicionados)`}),e.jsx("input",{ref:i,id:"file-upload",type:"file",style:{display:"none"},onChange:u}),e.jsx(K1,{children:o.length>0?l():h()})]})})}const _1=t=>{let s=!0;const o=[],{title:i,content:n}=t;return(!i||i==="")&&(s=!1,o.push("Título")),(!n||n==="")&&(s=!1,o.push("Conteúdo")),{isValid:s,fieldErrors:o}},e3=t=>{const{title:s,content:o,files:i,categories:n}=t;return{title:s,content:o,categories:n,files:i.map(c=>c.id)}};function t3({isModalOpen:t,setIsModalOpen:s}){const o=I(),i=O("(max-width: 768px)"),n=a.useRef(null),[c,d]=a.useState(!1),[u,l]=a.useState({title:"",content:"",files:[],categories:[]}),[h,A]=a.useState(!1),[m,C]=a.useState(!1),[x,N]=a.useState([]),Q={control:f=>({...f,backgroundColor:r.colors.white}),option:(f,{data:b,isMulti:k,isDisabled:D,isFocused:v,isSelected:L})=>{const E=M(b.color);return{...f,backgroundColor:D?void 0:L?k?b.color:E.alpha(.2).css():v?E.alpha(.1).css():void 0,color:D?"#ccc":L&&k?M.contrast(E,"white")>2?"white":"black":b.color,cursor:D?"not-allowed":"default",":active":{...f[":active"],backgroundColor:D?void 0:L?b.color:E.alpha(.3).css()}}},multiValue:(f,{data:b})=>{const k=M(b.color);return{...f,backgroundColor:k.alpha(.1).css()}},multiValueLabel:(f,{data:b})=>({...f,color:b.color}),multiValueRemove:(f,{data:b})=>({...f,color:b.color,":hover":{backgroundColor:b.color,color:"white"}}),input:f=>({...f,"input:focus":{boxShadow:"none"}})};a.useEffect(()=>console.log(u),[u]),a.useEffect(()=>{ve().then(f=>{N(f.data)})},[]),a.useEffect(()=>{d(t),l({title:"",content:"",files:[],categories:[]})},[t]);const U=a.useCallback((f,b)=>{Array.isArray(b)?l({...u,[f]:b.map(k=>Number(k.value))}):l({...u,[f]:b})},[u]),X=a.useCallback(f=>{C(f)},[]),R=f=>{f.preventDefault();const{isValid:b,fieldErrors:k}=_1(u);if(!b){o.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${k.reduce((D,v,L)=>L===0?`'${v}'`:L===k.length-1?`${D} e '${v}'`:`${D}, '${v}'`,"")}`,status:""})});return}A(!0),D1(e3(u)).then(D=>{o.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),Z(),l({title:"",content:"",files:[],categories:[]})}).catch(D=>{o.show({placement:"top-right",render:()=>{let v="";return typeof D.response.data.detail=="object"?v=D.response.data.detail[0].msg.split(", ")[1]:v=D.response.data.detail,e.jsx(y,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${v}`,status:""})}})}).finally(()=>{A(!1)})},Z=()=>{d(!1),setTimeout(()=>{s(!1)},300)},P=a.useCallback(f=>{l({...u,files:[...u.files,f]})},[u]),g=a.useCallback(f=>{const b=u.files.filter(k=>k.name!==f);l({...u,files:b})},[u]),T=()=>{n&&n.current&&n.current.click()};return e.jsx(e.Fragment,{children:c&&e.jsx(H1,{isOpen:c,onClick:Z,children:e.jsxs(J1,{isOpen:c,onClick:f=>f.stopPropagation(),children:[e.jsx(B1,{onClick:Z,children:e.jsx(se,{size:"2rem",color:r.colors.primary[50]})}),e.jsx("h1",{children:"Novo Tópico"}),e.jsx(W,{name:"title",onChange:U,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(je,{name:"content",onChange:U,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(I1,{children:e.jsx($,{isMulti:!0,closeMenuOnSelect:!1,options:x.map(f=>({value:f.id.toString(),label:f.name,color:f.color})),styles:Q,onChange:f=>U("categories",f),placeholder:"Adicionar categorias"})}),e.jsx($1,{filesUploadLimit:2,fileInputRef:n,handleAddFile:P,handleDeleteFile:g,files:u.files,setIsAddFileLoading:X}),e.jsxs(W1,{children:[e.jsx(j,{onPress:()=>T(),size:i?"xs":"md",isLoading:m,isLoadingText:"Adicionando arquivo...",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(xe,{}),children:"Adicionar arquivos"}),e.jsx(j,{id:"create-topic-button",onPress:f=>R(f),bgColor:r.colors.success[600],size:i?"xs":"md",isDisabled:m,borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:h,rightIcon:e.jsx(He,{}),children:"Criar"})]})]})})})}const s3=p.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;function i3(){const t=F(),{token:s}=B();return e.jsxs(G,{w:"190",placement:"bottom right",trigger:o=>e.jsx(j,{variant:"solid",_hover:{shadow:"8"},rightIcon:e.jsx(Fe,{size:30,color:r.colors.white}),onPress:()=>{},...o}),children:[e.jsx(G.Item,{onPress:()=>t("/"),children:"Feed"}),s&&e.jsx(G.Item,{onPress:()=>t("/profile"),children:"Perfil"}),!s&&e.jsx(G.Item,{onPress:()=>t("/login/logon"),children:"Entrar"})]})}function a3(){const{name:t,token:s}=B(),o=F(),i=O("(max-width: 768px)");function n(d){d.preventDefault(),o("/profile")}function c(d){d.preventDefault(),o("/login/logon")}return e.jsx(r3,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(n3,{}),e.jsxs("div",{className:"user-container",children:[s&&!i&&e.jsx(e.Fragment,{children:e.jsx(j,{onPress:d=>n(d),rightIcon:e.jsx(Me,{size:"30",color:r.colors.tertiary[300]}),children:i?"":t})}),!s&&!i&&e.jsx(e.Fragment,{children:e.jsx(j,{variant:"solid",bgColor:r.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(Oe,{size:30,color:r.colors.white}),onPress:d=>c(d),children:i?"":"Entrar"})}),e.jsx(i3,{})]})]})})}const l3=p.div`
...
`;function he(){return e.jsxs(l3,{children:[e.jsx(a3,{}),e.jsx("div",{className:"content",children:e.jsx(ge,{})})]})}const c3=p.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,u3=t=>{let s=!0;const o=[],{email:i,password:n}=t;return(!i||i==="")&&(s=!1,o.push("Email Institucional")),(!n||n==="")&&(s=!1,o.push("Senha")),{isValid:s,fieldErrors:o}},p3=async t=>{const{username:s,password:o}=t,i=new FormData;return i.append("username",s),i.append("password",o),await w.post("auth/login",i)},h3=t=>{const{email:s,password:o}=t;return{username:s,password:o}};function m3(){const t=F(),s=I(),{changeToken:o}=B(),[i,n]=a.useState({email:"",password:""}),[c,d]=a.useState(!1),u=a.useCallback((h,A)=>{n({...i,[h]:A})},[i]);function l(h){h.preventDefault();const{isValid:A,fieldErrors:m}=u3(i);if(!A){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${m.reduce((C,x,N)=>N===0?`'${x}'`:N===m.length-1?`${C} e '${x}'`:`${C}, '${x}'`,"")}`,status:""})});return}d(!0),p3(h3(i)).then(C=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário logado com sucesso!
Agora você pode criar tópicos e interagir com eles!`,status:"success"})}),o(C.data.access_token),t("/")}).catch(C=>{s.show({placement:"top-right",render:()=>{let x="";return typeof C.response.data.detail=="object"?x=C.response.data.detail[0].msg.split(", ")[1]:x=C.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${x}`,status:""})}})}).finally(()=>{d(!1)})}return e.jsxs(A3,{children:[e.jsx(K,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(W,{name:"email",onChange:u,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(W,{name:"password",onChange:u,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(j,{onPress:h=>l(h),variant:"solid",size:"lg",isLoading:c,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(j,{onPress:h=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const C3=p.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,f3="/assets/create-account-24b27e13.png";function x3(){return e.jsxs(C3,{children:[e.jsx("img",{className:"create-account-image",src:f3,alt:""}),e.jsx("div",{className:"content",children:e.jsx(ge,{})})]})}const g3=p.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,v3=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],N3=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],b3=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:v3},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:N3},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],j3=p.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function y3({label:t,placeholder:s,options:o=[],onChange:i,isRequired:n=!0,fontSize:c="0.9rem",isEditing:d=!0,name:u}){return e.jsxs(j3,{fontSize:c,children:[e.jsxs("label",{className:"create-account-label",children:[t,n&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(ue,{variant:"outline",height:9,size:"md",isDisabled:!d,onValueChange:l=>i(u,l),placeholder:s,accessibilityLabel:"Selecione a opção",children:o.map(l=>e.jsx(ue.Item,{label:l.label,value:l.value},l.label))})]})}const w3=async t=>await w.post("users",t),me=async()=>await w.get("users/me"),Q3=async t=>await w.patch("users/me",t),D3=async t=>await w.post("users/me/change_password",t),k3=async()=>await w.delete("users/me"),S3=t=>{let s=!0;const o=[],{name:i,email:n,profile:c,course:d,password:u,passwordConfirm:l}=t;return(!i||i==="")&&(s=!1,o.push("Nome Completo")),(!n||n==="")&&(s=!1,o.push("Email Institucional")),(!c||c==="")&&(s=!1,o.push("Papel na Instituição")),(!d||d==="")&&(s=!1,o.push("Curso")),(!u||u==="")&&(s=!1,o.push("Senha")),(!l||l===""||l!==u)&&(s=!1,o.push("Confirme a senha")),{isValid:s,fieldErrors:o}},z3=t=>{const{name:s,email:o,profile:i,course:n,password:c}=t;return{name:s,email:o,password:c,tags:[i,n]}};function U3(){const t=F(),s=I(),o=ne({lg:"lg",base:"md"}),[i,n]=a.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[c,d]=a.useState(!1),u=a.useCallback((A,m)=>{n({...i,[A]:m})},[i]),l=async A=>{A.preventDefault();const{isValid:m,fieldErrors:C}=S3(i);if(console.log(i),!m){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${C.reduce((x,N,Q)=>Q===0?`'${N}'`:Q===C.length-1?`${x} e '${N}'`:`${x}, '${N}'`,"")}`,status:""})});return}d(!0),w3(z3(i)).then(x=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(x=>{s.show({placement:"top-right",render:()=>{let N="";return typeof x.response.data.detail=="object"?N=x.response.data.detail[0].msg.split(", ")[1]:N=x.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${N}`,status:""})}})}).finally(()=>{d(!1)})};function h(A){switch(A.input){case"select":return e.jsx(y3,{label:A.label,placeholder:A.placeholder,options:A.options,name:A.name,onChange:u,accessibilityLabel:A.accessibilityLabel},A.label);default:return e.jsx(W,{label:A.label,placeholder:A.placeholder,inputType:A.type,name:A.name,onChange:u,accessibilityLabel:A.accessibilityLabel},A.label)}}return e.jsxs(g3,{children:[e.jsx(K,{}),e.jsxs("div",{className:"inputs-container",children:[b3.map(A=>h(A)),e.jsx(j,{onPress:A=>l(A),variant:"solid",size:o,isLoading:c,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(j,{onPress:A=>t(-1),variant:"outline",size:o,children:"Voltar"})]})]})}const T3=p.section`
  width: 80%;
...
`,L3=t=>{let s=!0;const o=[];return(!t||t==="")&&(s=!1,o.push("Nome Completo")),{isValid:s,fieldErrors:o}},q3=(t,s)=>{let o=!0;const i=[];let n="";return(!t||t==="")&&(o=!1,i.push("Senha Atual")),(!s||s==="")&&(o=!1,i.push("Nova Senha")),!s&&s===t&&(o=!1,n="Nova senha não pode ser a mesma que a atual"),{isValid:o,fieldErrors:i,specialError:n}},P3=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function Ce({question:t,handleAccept:s,handleClose:o,cancelText:i="Cancelar",acceptText:n,isOpen:c,isLoadingAcceptButton:d=!1,loadingAcceptButtonText:u=""}){const l=ne({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:c&&e.jsx(P3,{children:e.jsxs(E3,{children:[e.jsx(V3,{onClick:o,children:e.jsx(se,{size:"21",color:r.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(j,{size:l,variant:"outline",onPress:o,children:i}),e.jsx(j,{size:l,onPress:s,bgColor:r.colors.danger[500],isLoading:d,isLoadingText:u,children:n})]})]})})})}function X3(){const t=F(),s=I(),{name:o,email:i,setName:n,logoutUser:c}=B(),d=ne({lg:"lg",base:"md"}),[u,l]=a.useState(!1),[h,A]=a.useState(!1),[m,C]=a.useState(!1),[x,N]=a.useState(!1),[Q,U]=a.useState({email:i,id:0,name:o,role:"",tags:[]}),[X,R]=a.useState(!1),[Z,P]=a.useState(!1),[g,T]=a.useState(!1),[f,b]=a.useState(""),[k,D]=a.useState("");a.useEffect(()=>{me().then(S=>{U(S.data),n(S.data.name)})},[n]);const v=a.useCallback((S,q)=>{U({...Q,[S]:q})},[Q]),L=a.useCallback(()=>{P(!0),k3().then(()=>{}).finally(()=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"delete-user-success",title:"Usuário deletado!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),c(),P(!1),A(!1),t("/")})},[t,c,s]),E=S=>{S.preventDefault();const{fieldErrors:q,isValid:Y}=L3(Q.name);if(!Y){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${q.reduce((H,z,V)=>V===0?`'${z}'`:V===q.length-1?`${H} e '${z}'`:`${H}, '${z}'`,"")}`,status:""})});return}R(!0),Q3({name:Q.name}).then(H=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),n(Q.name)}).catch(H=>{s.show({placement:"top-right",render:()=>{let z="";return typeof H.response.data.detail=="object"?z=H.response.data.detail[0].msg.split(", ")[1]:z=H.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${z}`,status:""})}})}).finally(()=>{R(!1),C(!1)})},ye=S=>{S.preventDefault();const{fieldErrors:q,isValid:Y,specialError:H}=q3(f,k);if(!Y){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:q.length>0?`Os sequintes campos estão incorretos: ${q.reduce((z,V,re)=>re===0?`'${V}'`:re===q.length-1?`${z} e '${V}'`:`${z}, '${V}'`,"")}`:H,status:""})});return}T(!0),D3({current_password:f,new_password:k}).then(z=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(z=>{s.show({placement:"top-right",render:()=>{let V="";return typeof z.response.data.detail=="object"?V=z.response.data.detail[0].msg.split(", ")[1]:V=z.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${V}`,status:""})}})}).finally(()=>{T(!1),N(!1),b(""),D("")})},we=()=>m?e.jsxs(e.Fragment,{children:[e.jsx(j,{variant:"solid",size:d,onPress:()=>{C(!1),me().then(S=>{U(S.data)})},children:"Cancelar"}),e.jsx(j,{variant:"outline",size:d,isLoading:X,isLoadingText:"Atualizando Usuário...",onPress:S=>E(S),children:"Atualizar Usuário"})]}):x?e.jsxs(e.Fragment,{children:[e.jsx(j,{variant:"solid",size:d,onPress:()=>{N(!1),b(""),D("")},children:"Cancelar"}),e.jsx(j,{variant:"outline",size:d,isLoading:g,isLoadingText:"Atualizando Senha...",onPress:S=>ye(S),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(j,{variant:"solid",size:d,onPress:()=>C(!0),children:"Editar Perfil"}),e.jsx(j,{variant:"outline",size:d,onPress:()=>N(!0),children:"Alterar Senha"})]});return e.jsxs(T3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(K,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(W,{name:"name",onChange:v,isEditing:m,value:Q.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(W,{name:"email",onChange:()=>{},isEditing:!1,value:Q.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(W,{name:"password",onChange:(S,q)=>b(q),isEditing:x,value:x?f:"valordeteste",label:x?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),x&&e.jsx(W,{name:"passwordConfirm",onChange:(S,q)=>D(q),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),we(),!m&&!x&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(j,{variant:"subtle",size:"md",onPress:()=>l(!0),children:"Sair"}),e.jsx(j,{variant:"subtle",size:"md",onPress:()=>A(!0),children:"Deletar a Conta"})]})]}),e.jsx(Ce,{isOpen:u,handleAccept:()=>{l(!1),c(),t("/")},handleClose:()=>l(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(Ce,{isOpen:h,handleAccept:()=>{L()},handleClose:()=>A(!1),question:"Tem certeza que deseja deletar sua conta?",acceptText:"Deletar",isLoadingAcceptButton:Z,loadingAcceptButtonText:"Deletando..."})]})}const R3=p.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,J3=p.div`
  ...
  align-items: flex-start;
  justify-content: flex-start;
`,W3=t=>{let s=!0;const o=[];return(!t||t==="")&&(s=!1,o.push("Comentário")),{isValid:s,fieldErrors:o}},I3=({topicId:t,onCommentCreated:s})=>{const{name:o}=B(),i=I(),n=O("(max-width: 768px)"),[c,d]=a.useState(""),[u,l]=a.useState(!1);a.useEffect(()=>console.log({comment:c}),[c]);const h=(m,C)=>{d(C)},A=m=>{m.preventDefault();const{isValid:C}=W3(c);if(!C){i.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-comment-error",title:"Campos Inválidos",description:"O comentário não pode ser feito sem conteúdo!",status:""})});return}l(!0),U1(c.trim(),t).then(x=>{d(""),s()}).catch(x=>{i.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-topic-error",title:"Opa",description:"Erro ao criar comentário",status:""})})}).finally(()=>{l(!1)})};return e.jsxs(H3,{children:[e.jsxs(J3,{children:[e.jsx(oe,{bg:"lime.600",marginRight:"0.8rem",size:n?"xs":"sm",children:be(o)}),e.jsx(je,{name:"content",onChange:h,fontSize:"1.2rem",size:"lg",value:c,isComment:!0,inputType:"text",accessibilityLabel:"Comentário",label:"",placeholder:"Digite o comentário aqui..."})]}),e.jsx(j,{alignSelf:"flex-end",size:n?"sm":"md",rightIcon:e.jsx(Ge,{size:20,color:r.colors.white}),onPress:m=>A(m),isLoading:u,isLoadingText:"Comentando...",children:"Comentar"}),e.jsx(_,{})]})};function B3(){const{id:t}=Ke(),{token:s}=B(),[o,i]=a.useState(null),[n,c]=a.useState(!1),[d,u]=a.useState(!1);a.useEffect(()=>window.scrollTo(0,0),[]),a.useEffect(()=>{t&&(c(!0),Q1(Number(t)).then(h=>{i(h.data)}).finally(()=>c(!1)))},[t]);const l=a.useCallback(()=>{o&&(u(!0),T1(o.id).then(h=>{i({...o,comments:h.data})}).finally(()=>{u(!1)}))},[o]);return e.jsx(R3,{children:o?e.jsxs(e.Fragment,{children:[e.jsx(ee,{id:Number(o.id),author:o.author.name,title:o.title,categories:o.categories,content:o.content,rating:o.rating,files:o.files,currentRating:o.current_user_rating,isInsideTopic:!0}),e.jsxs(Z3,{children:[s&&e.jsx(I3,{topicId:o.id,onCommentCreated:l}),d?e.jsx(te,{accessibilityLabel:"Carregando os comentários do tópico..."}):e.jsx(e.Fragment,{children:o.comments.map(h=>e.jsx(ee,{id:h.id,isComment:!0,topicId:o.id,author:h.author.name,rating:h.rating,currentRating:h.current_user_rating,content:h.content},h.id))})]})]}):e.jsx(te,{accessibilityLabel:"Carregando dados do tópico..."})})}function F3(){return e.jsxs(Ye,{children:[e.jsxs(J,{path:"/",element:e.jsx(he,{}),children:[e.jsx(J,{path:"/",element:e.jsx(o3,{})}),e.jsx(J,{path:"/topic/:id",element:e.jsx(B3,{})})]}),e.jsx(J,{path:"/profile",element:e.jsx(he,{}),children:e.jsx(J,{path:"/profile",element:e.jsx(X3,{})})}),e.jsxs(J,{path:"/login",element:e.jsx(x3,{}),children:[e.jsx(J,{path:"/login",element:e.jsx(m3,{})}),e.jsx(J,{path:"/login/logon",element:e.jsx(d3,{})}),e.jsx(J,{path:"/login/create-account",element:e.jsx(U3,{})})]})]})}const M3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},O3=$e`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function G3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(s){return console.log(s),"light"}},set:async s=>{try{localStorage.setItem("@UnBForum:theme",s)}catch(o){console.log(o)}}};return e.jsx(_e,{colorModeManager:t,children:e.jsx(e1,{theme:M3,children:e.jsxs(z1,{children:[e.jsx(t1,{children:e.jsx(F3,{})}),e.jsx(O3,{})]})})})}s1.createRoot(document.getElementById("root")).render(e.jsx(o1.StrictMode,{children:e.jsx(G3,{})}));
