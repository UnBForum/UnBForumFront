import{s,t as i,j as e,I as J,F as W,S as b,P as B,n as S,B as p,u as Q,r as u,A as M,a as I,b as P,c as V,d as F,D as G,e as K,f as O,T as Y,g as $,h as _,C as E,i as X,k as e1,l as t1,m as i1,o as n1,O as R,p as r1,q as Z,v as q,V as o1,H as T,w as L,x as s1,y as a1,R as l1,z as N,E as A1,N as c1,X as d1,G as C1,J as u1,K as h1}from"./vendor-9271bbb1.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&l(d)}).observe(document,{childList:!0,subtree:!0});function r(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(o){if(o.ep)return;o.ep=!0;const a=r(o);fetch(o.href,a)}})();const p1=s.div`
  width: 100%;
  display: flex;
...
`;function k({id:t,isInsideTopic:n=!1,isComment:r=!1}){const l=Q(),o="Sandalo Henrique",a="Horários de Atendimento coordenação de Eng. de Software",[d,c]=u.useState(105),[C,A]=u.useState(!1);function g(){l(`/topic/${t}`)}function f(h,y){h.preventDefault(),c(d+y)}function x(h){h.preventDefault(),A(!C)}function m(){switch(C){case!0:return e.jsx(O,{size:"30",color:i.colors.darkBlue[400]});case!1:return e.jsx(K,{size:"30",color:i.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(q1,{children:[e.jsxs(T1,{isInsideTopic:n,isComment:r,children:[e.jsx("button",{id:"reactionButton",onClick:h=>f(h,1),children:e.jsx(M,{color:i.colors.muted[500],size:"18"})}),e.jsx("p",{children:d}),e.jsx("button",{id:"reactionButton",onClick:h=>f(h,-1),children:e.jsx(I,{color:i.colors.muted[500],size:"18"})}),!r&&e.jsx("button",{id:"markButton",onClick:h=>x(h),children:m()})]}),e.jsx(L1,{children:e.jsxs(U1,{isInsideTopic:n,isComment:r,children:[n&&e.jsx("h1",{id:"post-title",children:a}),e.jsxs(P1,{isInsideTopic:n,children:[e.jsx(P,{bg:r?"lime.600":"emerald.600",marginRight:"0.8rem",size:r?"xs":"sm",children:"SH"}),e.jsxs("p",{children:[o,!n&&!r&&` - ${a}`]})]}),e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** AA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),!r&&e.jsx(V1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((h,y)=>e.jsx(V,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:h})},y))}),!n&&!r&&e.jsx(E1,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:"1rem"},isInsideTopic:n,onPress:n?()=>{}:()=>g(),rightIcon:e.jsx(F,{size:"22",color:i.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:"Ver comentários (15)"})]})})]}),e.jsx(G,{alignSelf:"flex-end",width:r?"95%":"100%",marginTop:n?"0rem":"0.5rem",height:r||!n?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const X1=s.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`,C3="/UnBForumFront/assets/create-account-24b27e13.png";function u3(){return e.jsxs(d3,{children:[e.jsx("img",{className:"create-account-image",src:C3,alt:""}),e.jsx("div",{className:"content",children:e.jsx(R,{})})]})}const h3=s.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
