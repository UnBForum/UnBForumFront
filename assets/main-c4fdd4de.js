import{s as h,t as r,a as Qe,j as e,I as De,u as O,r as a,F as ke,S as _,P as Se,b as ie,B as j,c as M,n as ae,q as ze,d as le,e as B,A as ce,V as Ue,H as de,T as Ae,f as Te,C as Ce,g as I,h as Le,i as qe,k as oe,D as ee,l as fe,m as Pe,o as Ee,p as Ve,v as Xe,w as Re,x as Ze,y as xe,z as He,M as G,E as Je,G as Ie,J as We,O as ge,K as ue,L as ne,N as Be,Q as Fe,R as Me,U as Oe,W as Ge,X as Ke,Y as Ye,Z as $e,_ as P,$ as _e,a0 as e1,a1 as t1,a2 as s1,a3 as o1,a4 as n1}from"./vendor-cbb4aebe.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const c of n)if(c.type==="childList")for(const d of c.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function o(n){const c={};return n.integrity&&(c.integrity=n.integrity),n.referrerPolicy&&(c.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?c.credentials="include":n.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(n){if(n.ep)return;n.ep=!0;const c=o(n);fetch(n.href,c)}})();window.global||(window.global=window);const r1=h.main`
  width: 70%;
  display: flex;
...
`,pe=[{label:"Mais recentes",value:"-created_at",color:"#000"},{label:"Mais populares",value:"-rating",color:"#000"},{label:"Mais comentários",value:"-comments_count",color:"#000"}],w=Qe.create({baseURL:"https://unbforum-backend-4b05406a8bbf.herokuapp.com/"}),ve=async()=>await w.get("categories/"),h1=h.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function J({label:t="",inputType:s="text",placeholder:o,accessibilityLabel:i,size:n="md",fontSize:c="0.9rem",name:d,isRequired:A=!0,isEditing:l=!0,value:p=void 0,backgroundColor:u=null,height:m=null,onChange:f,...x}){return e.jsxs(h1,{children:[t&&e.jsxs(m1,{fontSize:c,children:[t,A&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(De,{height:m||null,type:s,variant:l?"outline":"filled",size:n,backgroundColor:u||null,isRequired:A,value:p,placeholder:o,editable:l,accessibilityLabel:i,onChangeText:v=>f(d,v),...x})]})}function C1({onChangeCategoriesFilter:t,onChangeOrderBy:s,onChangeSearchInput:o,handleSearch:i}){const n=O("(max-width: 768px)"),[c,d]=a.useState([]),A={control:l=>({...l,backgroundColor:r.colors.white}),option:(l,{data:p,isMulti:u,isDisabled:m,isFocused:f,isSelected:x})=>{const v=M(p.color);return{...l,backgroundColor:m?void 0:x?u?p.color:v.alpha(.2).css():f?v.alpha(.1).css():void 0,color:m?"#ccc":x&&u?M.contrast(v,"white")>2?"white":"black":p.color,cursor:m?"not-allowed":"default",":active":{...l[":active"],backgroundColor:m?void 0:x?p.color:v.alpha(.3).css()}}},multiValue:(l,{data:p})=>{const u=M(p.color);return{...l,backgroundColor:u.alpha(.1).css()}},multiValueLabel:(l,{data:p})=>({...l,color:p.color}),multiValueRemove:(l,{data:p})=>({...l,color:p.color,":hover":{backgroundColor:p.color,color:"white"}}),input:l=>({...l,"input:focus":{boxShadow:"none"}})};return a.useEffect(()=>{ve().then(l=>{d(l.data)})},[]),e.jsxs(d1,{children:[e.jsxs(A1,{children:[e.jsx(ke,{size:20,color:r.colors.tertiary[300]}),e.jsx(_,{isMulti:!0,closeMenuOnSelect:!1,options:c.map(l=>({value:l.id.toString(),label:l.name,color:l.color})),styles:A,onChange:t,placeholder:"Filtrar por categorias"})]}),e.jsxs(p1,{children:[e.jsx(Se,{size:22,color:r.colors.tertiary[300]}),e.jsx(_,{isMulti:!1,defaultValue:pe[0],options:pe,placeholder:"Ordenar Tópicos",styles:A,onChange:s})]}),e.jsxs(u1,{children:[e.jsx(ie,{color:r.colors.tertiary[300],size:"22"}),e.jsx(J,{name:"topic-search",height:"2.4rem",size:n?"md":"lg",backgroundColor:r.colors.white,accessibilityLabel:"Buscar tópicos",placeholder:"Buscar tópicos...",inputType:"text",onChange:o,InputRightElement:e.jsx(j,{rounded:"none",w:"1/12",h:"full",onPress:i,children:e.jsx(ie,{color:r.colors.white,size:"22"})})})]})]})}const f1=(t,s)=>t?"0.9rem":s?"1rem":"0.9rem",x1=(t,s)=>t?"0.7rem":s?"0.8rem":"0.7rem",g1=h.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,b1=h.div`
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:s})=>x1(t,s)};
      line-height: 1.7;
    }
...
`;const Q1=async t=>await w.get(`topics/?${ze.stringify(t,{arrayFormat:"comma"})}`),D1=async t=>await w.get(`topics/${t}`),k1=async t=>await w.post("topics",t),S1=async t=>await w.post(`topics/${t}/upvote`),z1=async t=>await w.post(`topics/${t}/downvote`),Ne=a.createContext(null),U1=({children:t})=>{const[s,o]=a.useState(""),[i,n]=a.useState([]),[c,d]=a.useState(""),[A,l]=a.useState("");a.useEffect(()=>{const m=localStorage.getItem("@UnBForum:token");if(console.log("Checando token...",m),m){const f=le(m.split(" ")[1]);w.defaults.headers.common.Authorization=`${m}`,o(m.split(" ")[1]),n(f.scopes),d(f.sub),l(f.name)}},[]);const p=a.useCallback(m=>{localStorage.setItem("@UnBForum:token",`Bearer ${m}`);const f=le(m);w.defaults.headers.common.Authorization=`Bearer ${m}`,o(m),n(f.scopes),d(f.sub),l(f.name)},[]),u=a.useCallback(()=>{o(""),n([]),d(""),l(""),w.defaults.headers.common.Authorization=null,localStorage.removeItem("@UnBForum:token")},[]);return e.jsx(Ne.Provider,{value:{token:s,name:A,email:c,scopes:i,changeToken:p,logoutUser:u,setName:l},children:t})};function F(){const t=a.useContext(Ne);if(!t)throw new Error("useUser must be used within an UserThemeProvider");return t}const y=({id:t,status:s,variant:o="left-accent",title:i,description:n,isClosable:c=!1,...d})=>{const A=B();return e.jsx(ce,{maxWidth:"100%",alignSelf:"center",flexDirection:"row",status:s||"error",variant:o,...d,children:e.jsxs(Ue,{space:1,flexShrink:1,w:"100%",children:[e.jsxs(de,{flexShrink:1,alignItems:"center",justifyContent:"space-between",children:[e.jsxs(de,{space:2,flexShrink:1,alignItems:"center",children:[e.jsx(ce.Icon,{}),e.jsx(Ae,{fontSize:"md",fontWeight:"medium",flexShrink:1,color:o==="solid"?"lightText":o!=="outline"?"darkText":null,children:i})]}),c?e.jsx(Te,{variant:"unstyled",icon:e.jsx(Ce,{size:"3"}),_icon:{color:o==="solid"?"lightText":"darkText"},onPress:()=>A.close(t)}):null]}),e.jsx(Ae,{px:"6",color:o==="solid"?"lightText":o!=="outline"?"darkText":null,children:n})]})})},T1=async(t,s)=>await w.post(`topics/${s}/comments/`,{content:t}),L1=async t=>await w.get(`topics/${t}/comments/`),q1=async(t,s)=>await w.post(`topics/${s}/comments/${t}/upvote`),P1=async(t,s)=>await w.post(`topics/${s}/comments/${t}/downvote`),E1=t=>`https://unbforum-backend-4b05406a8bbf.herokuapp.com/files/download/${t.upload_path}`;function be(t){const s=t.split(" ");if(s.length>=2){const o=s[0],i=s[s.length-1],n=o[0],c=i[0];return n.toUpperCase()+c.toUpperCase()}else return s[0][0].toUpperCase()}function te({id:t,isInsideTopic:s=!1,isComment:o=!1,title:i="",author:n,content:c,topicId:d=null,currentRating:A=0,rating:l=0,files:p=[],categories:u=[],commentsCount:m=0}){const{token:f}=F(),x=B(),v=I(),D=O("(max-width: 768px)"),[U,X]=a.useState(l),[R,W]=a.useState(!1),[q,Z]=a.useState(A);a.useEffect(()=>{Z(A),X(l)},[A,l]);function b(){v(`/topic/${t}`)}const C=()=>{x.show({placement:"top-right",render:()=>e.jsx(y,{id:"user-unlogged-error",title:"Opa!",description:"Para interagir com um tópico ou comentário, você precisa fazer login!",status:""})})};async function N(g,T){if(g.preventDefault(),!f){C();return}if(T>0){const E=await(o?q1(t,d):S1(t));X(E.data.rating),Z(q>0?0:1)}else{const E=await(o?P1(t,d):z1(t));X(E.data.rating),Z(q<0?0:-1)}}function k(g){g.preventDefault(),W(!R)}function Q(){switch(R){case!0:return e.jsx(Ve,{size:"30",color:r.colors.darkBlue[400]});case!1:return e.jsx(Ee,{size:"30",color:r.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(g1,{children:[e.jsxs(v1,{isInsideTopic:s,isComment:o,children:[e.jsx("button",{id:"reactionButton",onClick:g=>N(g,1),children:e.jsx(Le,{color:q>0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),e.jsx("p",{children:U}),e.jsx("button",{id:"reactionButton",onClick:g=>N(g,-1),children:e.jsx(qe,{color:q<0?r.colors.tertiary[500]:r.colors.muted[500],size:"18"})}),!o&&e.jsx("button",{id:"markButton",onClick:g=>k(g),children:Q()})]}),e.jsx(N1,{children:e.jsxs(b1,{isInsideTopic:s,isComment:o,children:[s&&e.jsx("h1",{id:"post-title",children:i}),e.jsxs(j1,{isInsideTopic:s,children:[e.jsx(oe,{bg:o?"lime.600":"emerald.600",marginRight:"0.8rem",size:o?"xs":"sm",children:be(n)}),e.jsxs("p",{children:[n,!s&&!o&&` - ${i}`]})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:c.replace(/\n/g,"<br>")}}),p.length>0&&e.jsx(ee,{width:"80%"}),p.map((g,T)=>e.jsxs("span",{children:["Para acessar o arquivo ",`${T+1}: `,e.jsx("a",{href:E1(g),target:"_blank",rel:"noreferrer",children:"clique aqui"})]},g.id)),!o&&e.jsx(y1,{children:u.map(g=>e.jsx(fe,{variant:"solid",bg:g.color,alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:g.name})},g.id))}),!s&&!o&&e.jsx(w1,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:D?"0.8rem":"1rem"},isInsideTopic:s,onPress:s?()=>{}:()=>b(),rightIcon:e.jsx(Pe,{size:D?"18":"20",color:r.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:`Ver comentários (${m})`})]})})]}),e.jsx(ee,{alignSelf:"flex-end",width:o?"95%":"100%",marginTop:s?"0rem":"0.5rem",height:o||!s?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const V1=h.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function H1(){return e.jsxs(V1,{children:[e.jsxs(X1,{children:[e.jsx(oe,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(R1,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(Z1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,s)=>e.jsx(fe,{variant:"solid",bg:r.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},s))})]})]})}const J1=h.div`
  display: flex;
  width: 100%;
  align-items: center;
  justify-content: center;
...
`;function F1(){const t=I(),{token:s}=F();return e.jsxs(G,{w:"190",placement:"bottom right",trigger:o=>e.jsx(j,{variant:"solid",_hover:{shadow:"8"},rightIcon:e.jsx(Je,{size:30,color:r.colors.white}),onPress:()=>{},...o}),children:[e.jsx(G.Item,{onPress:()=>t("/"),children:"Feed"}),s&&e.jsx(G.Item,{onPress:()=>t("/profile"),children:"Perfil"}),!s&&e.jsx(G.Item,{onPress:()=>t("/login/logon"),children:"Entrar"})]})}function M1(){const{name:t,token:s}=F(),o=I(),i=O("(max-width: 768px)");function n(d){d.preventDefault(),o("/profile")}function c(d){d.preventDefault(),o("/login/logon")}return e.jsx(B1,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(W1,{}),e.jsxs("div",{className:"user-container",children:[s&&!i&&e.jsx(e.Fragment,{children:e.jsx(j,{onPress:d=>n(d),rightIcon:e.jsx(Ie,{size:"30",color:r.colors.tertiary[300]}),children:i?"":t})}),!s&&!i&&e.jsx(e.Fragment,{children:e.jsx(j,{variant:"solid",bgColor:r.colors.tertiary[500],_hover:{shadow:"8"},rightIcon:e.jsx(We,{size:30,color:r.colors.white}),onPress:d=>c(d),children:i?"":"Entrar"})}),e.jsx(F1,{})]})]})})}const O1=h.div`
...
`;function $(){return e.jsxs(O1,{children:[e.jsx(M1,{}),e.jsx("div",{className:"content",children:e.jsx(ge,{})})]})}const G1=h.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,$1=t=>{let s=!0;const o=[],{email:i,password:n}=t;return(!i||i==="")&&(s=!1,o.push("Email Institucional")),(!n||n==="")&&(s=!1,o.push("Senha")),{isValid:s,fieldErrors:o}},_1=async t=>{const{username:s,password:o}=t,i=new FormData;return i.append("username",s),i.append("password",o),await w.post("auth/login",i)},e3=t=>{const{email:s,password:o}=t;return{username:s,password:o}};function t3(){const t=I(),s=B(),{changeToken:o}=F(),[i,n]=a.useState({email:"",password:""}),[c,d]=a.useState(!1),A=a.useCallback((p,u)=>{n({...i,[p]:u})},[i]);function l(p){p.preventDefault();const{isValid:u,fieldErrors:m}=$1(i);if(!u){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"login-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${m.reduce((f,x,v)=>v===0?`'${x}'`:v===m.length-1?`${f} e '${x}'`:`${f}, '${x}'`,"")}`,status:""})});return}d(!0),_1(e3(i)).then(f=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-success",title:"Bem-vindo ao UnBFórum",description:`Usuário logado com sucesso!
Agora você pode criar tópicos e interagir com eles!`,status:"success"})}),o(f.data.access_token),t("/")}).catch(f=>{s.show({placement:"top-right",render:()=>{let x="";return typeof f.response.data.detail=="object"?x=f.response.data.detail[0].msg.split(", ")[1]:x=f.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${x}`,status:""})}})}).finally(()=>{d(!1)})}return e.jsxs(Y1,{children:[e.jsx(K,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(J,{name:"email",onChange:A,accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(J,{name:"password",onChange:A,accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(j,{onPress:p=>l(p),variant:"solid",size:"lg",isLoading:c,isLoadingText:"Entrando...",children:"Entrar"}),e.jsx(j,{onPress:p=>t(-1),variant:"outline",size:"lg",children:"Voltar"})]})]})}const s3=h.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,o3="/assets/create-account-24b27e13.png";function n3(){return e.jsxs(s3,{children:[e.jsx("img",{className:"create-account-image",src:o3,alt:""}),e.jsx("div",{className:"content",children:e.jsx(ge,{})})]})}const r3=h.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`,i3=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],a3=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],l3=[{input:"normal",type:"text",name:"name",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",name:"email",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",name:"profile",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:i3},{input:"select",type:"text",name:"course",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:a3},{input:"normal",type:"password",name:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",name:"passwordConfirm",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],c3=h.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  /* gap: 0.3rem; */
...
`;function d3({label:t,placeholder:s,options:o=[],onChange:i,isRequired:n=!0,fontSize:c="0.9rem",isEditing:d=!0,name:A}){return e.jsxs(c3,{fontSize:c,children:[e.jsxs("label",{className:"create-account-label",children:[t,n&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(ue,{variant:"outline",height:9,size:"md",isDisabled:!d,onValueChange:l=>i(A,l),placeholder:s,accessibilityLabel:"Selecione a opção",children:o.map(l=>e.jsx(ue.Item,{label:l.label,value:l.value},l.label))})]})}const A3=async t=>await w.post("users",t),he=async()=>await w.get("users/me"),u3=async t=>await w.patch("users/me",t),p3=async t=>await w.post("users/me/change_password",t),h3=async()=>await w.delete("users/me"),m3=t=>{let s=!0;const o=[],{name:i,email:n,profile:c,course:d,password:A,passwordConfirm:l}=t;return(!i||i==="")&&(s=!1,o.push("Nome Completo")),(!n||n==="")&&(s=!1,o.push("Email Institucional")),(!c||c==="")&&(s=!1,o.push("Papel na Instituição")),(!d||d==="")&&(s=!1,o.push("Curso")),(!A||A==="")&&(s=!1,o.push("Senha")),(!l||l===""||l!==A)&&(s=!1,o.push("Confirme a senha")),{isValid:s,fieldErrors:o}},C3=t=>{const{name:s,email:o,profile:i,course:n,password:c}=t;return{name:s,email:o,password:c,tags:[i,n]}};function f3(){const t=I(),s=B(),o=ne({lg:"lg",base:"md"}),[i,n]=a.useState({name:"",email:"",profile:"",course:"",password:"",passwordConfirm:""}),[c,d]=a.useState(!1),A=a.useCallback((u,m)=>{n({...i,[u]:m})},[i]),l=async u=>{u.preventDefault();const{isValid:m,fieldErrors:f}=m3(i);if(console.log(i),!m){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${f.reduce((x,v,D)=>D===0?`'${v}'`:D===f.length-1?`${x} e '${v}'`:`${x}, '${v}'`,"")}`,status:""})});return}d(!0),A3(C3(i)).then(x=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-success",title:"Estamos quase lá!",description:`Conta criada com sucesso!
Clique em 'Entrar' e faça o seu login na aplicação!`,status:"success"})}),t("/login/logon")}).catch(x=>{s.show({placement:"top-right",render:()=>{let v="";return typeof x.response.data.detail=="object"?v=x.response.data.detail[0].msg.split(", ")[1]:v=x.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${v}`,status:""})}})}).finally(()=>{d(!1)})};function p(u){switch(u.input){case"select":return e.jsx(d3,{label:u.label,placeholder:u.placeholder,options:u.options,name:u.name,onChange:A,accessibilityLabel:u.accessibilityLabel},u.label);default:return e.jsx(J,{label:u.label,placeholder:u.placeholder,inputType:u.type,name:u.name,onChange:A,accessibilityLabel:u.accessibilityLabel},u.label)}}return e.jsxs(r3,{children:[e.jsx(K,{}),e.jsxs("div",{className:"inputs-container",children:[l3.map(u=>p(u)),e.jsx(j,{onPress:u=>l(u),variant:"solid",size:o,isLoading:c,isLoadingText:"Criando usuário...",children:"Criar Conta"}),e.jsx(j,{onPress:u=>t(-1),variant:"outline",size:o,children:"Voltar"})]})]})}const x3=h.section`
  width: 80%;
...
`,g3=t=>{let s=!0;const o=[];return(!t||t==="")&&(s=!1,o.push("Nome Completo")),{isValid:s,fieldErrors:o}},v3=(t,s)=>{let o=!0;const i=[];let n="";return(!t||t==="")&&(o=!1,i.push("Senha Atual")),(!s||s==="")&&(o=!1,i.push("Nova Senha")),!s&&s===t&&(o=!1,n="Nova senha não pode ser a mesma que a atual"),{isValid:o,fieldErrors:i,specialError:n}},N3=h.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function me({question:t,handleAccept:s,handleClose:o,cancelText:i="Cancelar",acceptText:n,isOpen:c,isLoadingAcceptButton:d=!1,loadingAcceptButtonText:A=""}){const l=ne({lg:"md",base:"sm"});return e.jsx(e.Fragment,{children:c&&e.jsx(N3,{children:e.jsxs(b3,{children:[e.jsx(j3,{onClick:o,children:e.jsx(Ce,{size:"21",color:r.colors.primary[50]})}),e.jsx("p",{children:t}),e.jsxs("div",{id:"buttons-dialog-container",children:[e.jsx(j,{size:l,variant:"outline",onPress:o,children:i}),e.jsx(j,{size:l,onPress:s,bgColor:r.colors.danger[500],isLoading:d,isLoadingText:A,children:n})]})]})})})}function y3(){const t=I(),s=B(),{name:o,email:i,setName:n,logoutUser:c}=F(),d=ne({lg:"lg",base:"md"}),[A,l]=a.useState(!1),[p,u]=a.useState(!1),[m,f]=a.useState(!1),[x,v]=a.useState(!1),[D,U]=a.useState({email:i,id:0,name:o,role:"",tags:[]}),[X,R]=a.useState(!1),[W,q]=a.useState(!1),[Z,b]=a.useState(!1),[C,N]=a.useState(""),[k,Q]=a.useState("");a.useEffect(()=>{he().then(S=>{U(S.data),n(S.data.name)})},[n]);const g=a.useCallback((S,L)=>{U({...D,[S]:L})},[D]),T=a.useCallback(()=>{q(!0),h3().then(()=>{}).finally(()=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"delete-user-success",title:"Usuário deletado!",description:"A qualquer momento você poderá criar uma nova conta",status:"success"})}),c(),q(!1),u(!1),t("/")})},[t,c,s]),E=S=>{S.preventDefault();const{fieldErrors:L,isValid:Y}=g3(D.name);if(!Y){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${L.reduce((H,z,V)=>V===0?`'${z}'`:V===L.length-1?`${H} e '${z}'`:`${H}, '${z}'`,"")}`,status:""})});return}R(!0),u3({name:D.name}).then(H=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"update-user-success",title:"Usuário atualizado!",description:"",status:"success"})}),n(D.name)}).catch(H=>{s.show({placement:"top-right",render:()=>{let z="";return typeof H.response.data.detail=="object"?z=H.response.data.detail[0].msg.split(", ")[1]:z=H.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${z}`,status:""})}})}).finally(()=>{R(!1),f(!1)})},ye=S=>{S.preventDefault();const{fieldErrors:L,isValid:Y,specialError:H}=v3(C,k);if(!Y){s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:L.length>0?`Os sequintes campos estão incorretos: ${L.reduce((z,V,re)=>re===0?`'${V}'`:re===L.length-1?`${z} e '${V}'`:`${z}, '${V}'`,"")}`:H,status:""})});return}b(!0),p3({current_password:C,new_password:k}).then(z=>{s.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-user-success",title:"Senha atualizada com sucesso!",description:"",status:"success"})})}).catch(z=>{s.show({placement:"top-right",render:()=>{let V="";return typeof z.response.data.detail=="object"?V=z.response.data.detail[0].msg.split(", ")[1]:V=z.response.data.detail,e.jsx(y,{id:"create-user-error",title:"Campos Inválidos",description:`Erro: ${V}`,status:""})}})}).finally(()=>{b(!1),v(!1),N(""),Q("")})},we=()=>m?e.jsxs(e.Fragment,{children:[e.jsx(j,{variant:"solid",size:d,onPress:()=>{f(!1),he().then(S=>{U(S.data)})},children:"Cancelar"}),e.jsx(j,{variant:"outline",size:d,isLoading:X,isLoadingText:"Atualizando Usuário...",onPress:S=>E(S),children:"Atualizar Usuário"})]}):x?e.jsxs(e.Fragment,{children:[e.jsx(j,{variant:"solid",size:d,onPress:()=>{v(!1),N(""),Q("")},children:"Cancelar"}),e.jsx(j,{variant:"outline",size:d,isLoading:Z,isLoadingText:"Atualizando Senha...",onPress:S=>ye(S),children:"Alterar Senha"})]}):e.jsxs(e.Fragment,{children:[e.jsx(j,{variant:"solid",size:d,onPress:()=>f(!0),children:"Editar Perfil"}),e.jsx(j,{variant:"outline",size:d,onPress:()=>v(!0),children:"Alterar Senha"})]});return e.jsxs(x3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(K,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(J,{name:"name",onChange:g,isEditing:m,value:D.name,label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(J,{name:"email",onChange:()=>{},isEditing:!1,value:D.email,label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(J,{name:"password",onChange:(S,L)=>N(L),isEditing:x,value:x?C:"valordeteste",label:x?"Senha Atual":"Senha",placeholder:"Digite sua senha atual...",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),x&&e.jsx(J,{name:"passwordConfirm",onChange:(S,L)=>Q(L),label:"Nova Senha",placeholder:"Digite a sua nova senha...",inputType:"password",accessibilityLabel:"Digite a sua nova senha..."}),we(),!m&&!x&&e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(j,{variant:"subtle",size:"md",onPress:()=>l(!0),children:"Sair"}),e.jsx(j,{variant:"subtle",size:"md",onPress:()=>u(!0),children:"Deletar a Conta"})]})]}),e.jsx(me,{isOpen:A,handleAccept:()=>{l(!1),c(),t("/")},handleClose:()=>l(!1),question:"Tem certeza que deseja sair da aplicação?",acceptText:"Sair do UnBFórum"}),e.jsx(me,{isOpen:p,handleAccept:()=>{T()},handleClose:()=>u(!1),question:"Tem certeza que deseja deletar sua conta?",acceptText:"Deletar",isLoadingAcceptButton:W,loadingAcceptButtonText:"Deletando..."})]})}const w3=h.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`;function je({label:t="",inputType:s="text",placeholder:o,accessibilityLabel:i,size:n="md",fontSize:c="0.9rem",isRequired:d=!0,isEditing:A=!0,name:l,isComment:p=!1,value:u=void 0,onChange:m,...f}){return e.jsxs(S3,{isComment:p,children:[t&&e.jsxs(z3,{fontSize:c,children:[t,d&&e.jsx("p",{id:"required",children:"*"})]}),e.jsx(Be,{type:s,variant:A?"outline":"filled",size:n,placeholder:o,accessibilityLabel:i,editable:A,onChangeText:x=>m(l,x),autoCompleteType:null,value:u,totalLines:5,maxLength:700,...f})]})}const U3=t=>{let s=!0;const o=[];return(!t||t==="")&&(s=!1,o.push("Comentário")),{isValid:s,fieldErrors:o}},T3=({topicId:t,onCommentCreated:s})=>{const{name:o}=F(),i=B(),n=O("(max-width: 768px)"),[c,d]=a.useState(""),[A,l]=a.useState(!1);a.useEffect(()=>console.log({comment:c}),[c]);const p=(m,f)=>{d(f)},u=m=>{m.preventDefault();const{isValid:f}=U3(c);if(!f){i.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-comment-error",title:"Campos Inválidos",description:"O comentário não pode ser feito sem conteúdo!",status:""})});return}l(!0),T1(c.trim(),t).then(x=>{d(""),s()}).catch(x=>{i.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-topic-error",title:"Opa",description:"Erro ao criar comentário",status:""})})}).finally(()=>{l(!1)})};return e.jsxs(D3,{children:[e.jsxs(k3,{children:[e.jsx(oe,{bg:"lime.600",marginRight:"0.8rem",size:n?"xs":"sm",children:be(o)}),e.jsx(je,{name:"content",onChange:p,fontSize:"1.2rem",size:"lg",value:c,isComment:!0,inputType:"text",accessibilityLabel:"Comentário",label:"",placeholder:"Digite o comentário aqui..."})]}),e.jsx(j,{alignSelf:"flex-end",size:n?"sm":"md",rightIcon:e.jsx(Fe,{size:20,color:r.colors.white}),onPress:m=>u(m),isLoading:A,isLoadingText:"Comentando...",children:"Comentar"}),e.jsx(ee,{})]})};function L3(){const{id:t}=Me(),{token:s}=F(),[o,i]=a.useState(null),[n,c]=a.useState(!1),[d,A]=a.useState(!1);a.useEffect(()=>window.scrollTo(0,0),[]),a.useEffect(()=>{t&&(c(!0),D1(Number(t)).then(p=>{i(p.data)}).finally(()=>c(!1)))},[t]);const l=a.useCallback(()=>{o&&(A(!0),L1(o.id).then(p=>{i({...o,comments:p.data})}).finally(()=>{A(!1)}))},[o]);return e.jsx(w3,{children:o?e.jsxs(e.Fragment,{children:[e.jsx(te,{id:Number(o.id),author:o.author.name,title:o.title,categories:o.categories,content:o.content,rating:o.rating,files:o.files,currentRating:o.current_user_rating,isInsideTopic:!0}),e.jsxs(Q3,{children:[s&&e.jsx(T3,{topicId:o.id,onCommentCreated:l}),d?e.jsx(se,{accessibilityLabel:"Carregando os comentários do tópico..."}):e.jsx(e.Fragment,{children:o.comments.map(p=>e.jsx(te,{id:p.id,isComment:!0,topicId:o.id,author:p.author.name,rating:p.rating,currentRating:p.current_user_rating,content:p.content},p.id))})]})]}):e.jsx(se,{accessibilityLabel:"Carregando dados do tópico..."})})}const q3=h.div`
  /* position: fixed;
  top: 0;
  left: 0; */
  width: 100%;
...
`,J3=async t=>{const s=new FormData;return s.append("files",t),console.log(s),await w.post("files/upload/",s,{headers:{"Content-Type":t.type}})};function I3({handleAddFile:t,handleDeleteFile:s,files:o,fileInputRef:i,filesUploadLimit:n=2,setIsAddFileLoading:c}){const d=B(),A=async u=>{const m=u.target.files&&u.target.files[0];m&&o.length+1<=n?(console.log("tentando subir arquivo1"),c(!0),console.log("tentando subir arquivo2"),J3(m).then(f=>{console.log(f.data[0]),t(f.data[0])}).catch(f=>{d.show({placement:"top",render:()=>e.jsx(y,{id:"files-upload-error",status:"error",title:"Opa!",description:"Erro ao fazer upload do arquivo."})})}).finally(()=>{c(!1)})):d.show({placement:"top",render:()=>e.jsx(y,{id:"files-error",status:"error",title:"Opa!",description:"Número de arquivos atingido ou arquivo é inválido."})})},l=()=>{const u=[];return o.forEach((m,f)=>{u.push(e.jsxs("p",{id:"file",children:[e.jsx("button",{id:"delete-file-button",onClick:()=>s(m.name),children:e.jsx(Oe,{size:"1.7rem",color:r.colors.primary[50]})}),e.jsx(Ge,{size:"38",color:r.colors.gray[500]}),m.name]},f))}),u},p=()=>e.jsx("p",{id:"no-files",children:"Sem arquivos adicionados"});return e.jsx(e.Fragment,{children:e.jsxs(R3,{children:[e.jsx(Z3,{fontSize:"1.2rem",children:`Arquivos (${o.length}/${n} arquivos adicionados)`}),e.jsx("input",{ref:i,id:"file-upload",type:"file",style:{display:"none"},onChange:A}),e.jsx(H3,{children:o.length>0?l():p()})]})})}const W3=t=>{let s=!0;const o=[],{title:i,content:n}=t;return(!i||i==="")&&(s=!1,o.push("Título")),(!n||n==="")&&(s=!1,o.push("Conteúdo")),{isValid:s,fieldErrors:o}},B3=t=>{const{title:s,content:o,files:i,categories:n}=t;return{title:s,content:o,categories:n,files:i.map(c=>c.id)}};function F3({isModalOpen:t,setIsModalOpen:s}){const o=B(),i=O("(max-width: 768px)"),n=a.useRef(null),[c,d]=a.useState(!1),[A,l]=a.useState({title:"",content:"",files:[],categories:[]}),[p,u]=a.useState(!1),[m,f]=a.useState(!1),[x,v]=a.useState([]),D={control:C=>({...C,backgroundColor:r.colors.white}),option:(C,{data:N,isMulti:k,isDisabled:Q,isFocused:g,isSelected:T})=>{const E=M(N.color);return{...C,backgroundColor:Q?void 0:T?k?N.color:E.alpha(.2).css():g?E.alpha(.1).css():void 0,color:Q?"#ccc":T&&k?M.contrast(E,"white")>2?"white":"black":N.color,cursor:Q?"not-allowed":"default",":active":{...C[":active"],backgroundColor:Q?void 0:T?N.color:E.alpha(.3).css()}}},multiValue:(C,{data:N})=>{const k=M(N.color);return{...C,backgroundColor:k.alpha(.1).css()}},multiValueLabel:(C,{data:N})=>({...C,color:N.color}),multiValueRemove:(C,{data:N})=>({...C,color:N.color,":hover":{backgroundColor:N.color,color:"white"}}),input:C=>({...C,"input:focus":{boxShadow:"none"}})};a.useEffect(()=>console.log(A),[A]),a.useEffect(()=>{ve().then(C=>{v(C.data)})},[]),a.useEffect(()=>{d(t),l({title:"",content:"",files:[],categories:[]})},[t]);const U=a.useCallback((C,N)=>{Array.isArray(N)?l({...A,[C]:N.map(k=>Number(k.value))}):l({...A,[C]:N})},[A]),X=a.useCallback(C=>{f(C)},[]),R=C=>{C.preventDefault();const{isValid:N,fieldErrors:k}=W3(A);if(!N){o.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-topic-error",title:"Campos Inválidos",description:`Os sequintes campos estão incorretos: ${k.reduce((Q,g,T)=>T===0?`'${g}'`:T===k.length-1?`${Q} e '${g}'`:`${Q}, '${g}'`,"")}`,status:""})});return}u(!0),k1(B3(A)).then(Q=>{o.show({placement:"top-right",render:()=>e.jsx(y,{id:"create-topic-success",title:"Tópico Criado com Sucesso",description:"Agora todos podem ver seu novo tópico!",status:"success"})}),W(),l({title:"",content:"",files:[],categories:[]})}).catch(Q=>{o.show({placement:"top-right",render:()=>{let g="";return typeof Q.response.data.detail=="object"?g=Q.response.data.detail[0].msg.split(", ")[1]:g=Q.response.data.detail,e.jsx(y,{id:"create-topic-error",title:"Campos Inválidos",description:`Erro: ${g}`,status:""})}})}).finally(()=>{u(!1)})},W=()=>{d(!1),setTimeout(()=>{s(!1)},300)},q=a.useCallback(C=>{l({...A,files:[...A.files,C]})},[A]),Z=a.useCallback(C=>{const N=A.files.filter(k=>k.name!==C);l({...A,files:N})},[A]),b=()=>{n&&n.current&&n.current.click()};return e.jsx(e.Fragment,{children:e.jsx(q3,{isOpen:c,children:e.jsxs(P3,{isOpen:c,onClick:C=>C.stopPropagation(),children:[e.jsx(X3,{onClick:W,children:e.jsx(Ke,{size:"2rem",color:r.colors.tertiary[400]})}),e.jsx("h1",{children:"Novo Tópico"}),e.jsx(J,{name:"title",onChange:U,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Título",label:"Título",placeholder:"Digite o título do tópico..."}),e.jsx(je,{name:"content",onChange:U,fontSize:"1.2rem",size:"lg",inputType:"text",accessibilityLabel:"Conteúdo",label:"Conteúdo",placeholder:"Digite o conteúdo do tópico aqui..."}),e.jsx(V3,{children:e.jsx(_,{isMulti:!0,closeMenuOnSelect:!1,options:x.map(C=>({value:C.id.toString(),label:C.name,color:C.color})),styles:D,onChange:C=>U("categories",C),placeholder:"Adicionar categorias"})}),e.jsx(I3,{filesUploadLimit:2,fileInputRef:n,handleAddFile:q,handleDeleteFile:Z,files:A.files,setIsAddFileLoading:X}),e.jsxs(E3,{children:[e.jsx(j,{onPress:()=>b(),size:i?"xs":"md",isLoading:m,isLoadingText:"Adicionando arquivo...",borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"400"},rightIcon:e.jsx(xe,{}),children:"Adicionar arquivos"}),e.jsx(j,{id:"create-topic-button",onPress:C=>R(C),bgColor:r.colors.success[600],size:i?"xs":"md",isDisabled:m,borderRadius:"4px",_text:{fontSize:"1rem",fontWeight:"700"},isLoadingText:"Criando...",isLoading:p,rightIcon:e.jsx(Ye,{}),children:"Criar"})]})]})})})}function M3(){const t=I();return e.jsx(e.Fragment,{children:e.jsx(F3,{isModalOpen:!0,setIsModalOpen:()=>t("/")})})}function O3(){return e.jsxs($e,{children:[e.jsxs(P,{path:"/",element:e.jsx($,{}),children:[e.jsx(P,{path:"/",element:e.jsx(I1,{})}),e.jsx(P,{path:"/topic/:id",element:e.jsx(L3,{})})]}),e.jsx(P,{path:"/profile",element:e.jsx($,{}),children:e.jsx(P,{path:"/profile",element:e.jsx(y3,{})})}),e.jsx(P,{path:"/create-topic",element:e.jsx($,{}),children:e.jsx(P,{path:"/create-topic",element:e.jsx(M3,{})})}),e.jsxs(P,{path:"/login",element:e.jsx(n3,{}),children:[e.jsx(P,{path:"/login",element:e.jsx(t3,{})}),e.jsx(P,{path:"/login/logon",element:e.jsx(K1,{})}),e.jsx(P,{path:"/login/create-account",element:e.jsx(f3,{})})]})]})}const G3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},K3=_e`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function Y3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(s){return console.log(s),"light"}},set:async s=>{try{localStorage.setItem("@UnBForum:theme",s)}catch(o){console.log(o)}}};return e.jsx(e1,{colorModeManager:t,children:e.jsx(t1,{theme:G3,children:e.jsxs(U1,{children:[e.jsx(s1,{children:e.jsx(O3,{})}),e.jsx(K3,{})]})})})}o1.createRoot(document.getElementById("root")).render(e.jsx(n1.StrictMode,{children:e.jsx(Y3,{})}));
