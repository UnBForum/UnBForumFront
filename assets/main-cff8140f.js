import{s,t as i,j as e,I as V,F as E,S as m,P as X,n as z,B as c,u as g,r as d,A as R,a as Z,b as q,c as L,d as H,D as J,e as W,f as B,T as M,g as F,h as G,C as K,i as T,k as I,l as O,m as Y,o as $,O as U,p as _,R as e1,q as h,v as t1,N as i1,X as n1,w as r1,x as o1,y as s1}from"./vendor-cc00f5b2.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const A of l.addedNodes)A.tagName==="LINK"&&A.rel==="modulepreload"&&r(A)}).observe(document,{childList:!0,subtree:!0});function o(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(a){if(a.ep)return;a.ep=!0;const l=o(a);fetch(a.href,l)}})();const a1=s.div`
  width: 100%;
  display: flex;
...
`;function f({label:t="",inputType:n="text",placeholder:o,accessibilityLabel:r,size:a="md",fontSize:l="0.9rem",...A}){return e.jsxs(a1,{children:[t&&e.jsx(l1,{fontSize:l,children:t}),e.jsx(V,{type:n,variant:"outline",size:a,placeholder:o,accessibilityLabel:r,...A})]})}const A1=s.main`
  width: 70%;
  display: flex;
...
`,P=[{label:"Aluno",value:"Aluno"},{label:"Coordenador",value:"Coordenador"},{label:"Professor",value:"Professor"},{label:"Secretaria",value:"Secretaria"},{label:"Técnico",value:"Técnico"}],w=[{label:"Engenharia Aeroespacial",value:"Engenharia Aeroespacial"},{label:"Engenharia Automotiva",value:"Engenharia Automotiva"},{label:"Engenharia de Energia",value:"Engenharia de Energia"},{label:"Engenharia de Software",value:"Engenharia de Software"},{label:"Engenharia Eletrônica",value:"Engenharia Eletrônica"},{label:"Engenharias",value:"Engenharias"}],m1=[{input:"normal",type:"text",label:"Nome Completo",placeholder:"Digite o nome completo...",accessibilityLabel:"Digite o nome completo",options:[]},{input:"normal",type:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br...",accessibilityLabel:"Digite o email",options:[]},{input:"select",type:"text",label:"Papel na Instituição",placeholder:"Selecione o seu papel...",accessibilityLabel:"Selecione o seu papel na instituição",options:P},{input:"select",type:"text",label:"Curso",placeholder:"Selecione o seu curso...",accessibilityLabel:"Selecione o seu curso",options:w},{input:"normal",type:"password",label:"Senha",placeholder:"Digite a sua senha...",accessibilityLabel:"Digite a sua senha",options:[]},{input:"normal",type:"password",label:"Confirme a senha",placeholder:"Digite a sua senha novamente...",accessibilityLabel:"Digite a sua senha novamente",options:[]}],N1=[{label:"Mais salvos",value:"Mais salvos"},{label:"Menos salvos",value:"Menos salvos"},{label:"Mais comentários",value:"Mais comentários"},{label:"Menos comentários",value:"Menos comentários"},{label:"Mais recentes",value:"Mais recentes"},{label:"Mais antigos",value:"Mais antigos"}];function g1(){return e.jsxs(h1,{children:[e.jsxs(x1,{children:[e.jsx(E,{}),e.jsx(m,{backgroundColor:i.colors.white,color:i.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione os filtros...",accessibilityLabel:"Selecione a opção",children:w.map(t=>e.jsx(m.Item,{label:t.label,value:t.value},t.label))})]}),e.jsxs(f1,{children:[e.jsx(X,{}),e.jsx(m,{backgroundColor:i.colors.white,color:i.colors.black,variant:"outline",height:9,size:"lg",placeholder:"Selecione a ordenação...",accessibilityLabel:"Selecione a opção",children:N1.map(t=>e.jsx(m.Item,{label:t.label,value:t.value},t.label))})]})]})}const v1=(t,n)=>t?"0.9rem":n?"1rem":"0.9rem",b1=(t,n)=>t?"0.7rem":n?"0.8rem":"0.7rem",Q1=s.div`
  width: 100%;
  display: flex;
  /* padding: 0.5rem; */
  gap: 0.5rem;
...
`,D1=s.div`
  ...
  & > p {
    ...
    font-size: ${({isComment:t,isInsideTopic:n})=>v1(t,n)};
    color: ${i.colors.black};
  ...
  @media (max-width: 768px) {
    ...
    & > p {
      width: 100%;
      font-size: ${({isComment:t,isInsideTopic:n})=>b1(t,n)};
      line-height: 1.7;
    }
...
`;function D({id:t,isInsideTopic:n=!1,isComment:o=!1}){const r=g(),a="Sandalo Henrique",l="Horários de Atendimento coordenação de Eng. de Software",[A,p]=d.useState(105),[C,N]=d.useState(!1);function b(){r(`/topic/${t}`)}function x(u,y){u.preventDefault(),p(A+y)}function Q(u){u.preventDefault(),N(!C)}function j(){switch(C){case!0:return e.jsx(B,{size:"30",color:i.colors.darkBlue[400]});case!1:return e.jsx(W,{size:"30",color:i.colors.darkBlue[400]})}}return e.jsxs(e.Fragment,{children:[e.jsxs(Q1,{children:[e.jsxs(j1,{isInsideTopic:n,isComment:o,children:[e.jsx("button",{id:"reactionButton",onClick:u=>x(u,1),children:e.jsx(R,{color:i.colors.muted[500],size:"18"})}),e.jsx("p",{children:A}),e.jsx("button",{id:"reactionButton",onClick:u=>x(u,-1),children:e.jsx(Z,{color:i.colors.muted[500],size:"18"})}),!o&&e.jsx("button",{id:"markButton",onClick:u=>Q(u),children:j()})]}),e.jsx(y1,{children:e.jsxs(D1,{isInsideTopic:n,isComment:o,children:[n&&e.jsx("h1",{id:"post-title",children:l}),e.jsxs(k1,{isInsideTopic:n,children:[e.jsx(q,{bg:o?"lime.600":"emerald.600",marginRight:"0.8rem",size:o?"xs":"sm",children:"SH"}),e.jsxs("p",{children:[a,!n&&!o&&` - ${l}`]})]}),e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** AA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),!o&&e.jsx(w1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((u,y)=>e.jsx(L,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"md",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:u})},y))}),!n&&!o&&e.jsx(z1,{variant:"outline",width:"95%",size:"xs",_text:{fontSize:"1rem"},isInsideTopic:n,onPress:n?()=>{}:()=>b(),rightIcon:e.jsx(H,{size:"22",color:i.colors.primary[700]}),_icon:{marginLeft:"1rem"},children:"Ver comentários (15)"})]})})]}),e.jsx(J,{alignSelf:"flex-end",width:o?"95%":"100%",marginTop:n?"0rem":"0.5rem",height:o||!n?"0.05rem":".1rem",_light:{bg:"muted.800"},_dark:{bg:"muted.50"}})]})}const S1=s.div`
  width: 90%;
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function U1(){return e.jsxs(S1,{children:[e.jsxs(q1,{children:[e.jsx(q,{bg:"emerald.800",marginRight:"0.8rem",size:"xs",children:"SH"}),e.jsx("p",{children:"Sandalo Henrique - Horários de Atendimento coordenação de Eng. de Software"})]}),e.jsxs(L1,{children:[e.jsxs("p",{children:["Prezad@s discentes,",e.jsx("br",{}),e.jsx("br",{}),"Prezad@s discentes, Bom dia! Espero que estejam bem. Deixo aqui informações sobre a dinâmica de atendimento da Coordenação de Eng. de Software durante o período da matrícula: - atendimento presencial nas 2a-feiras de 0830h às 0930h; - atendimento presencial nas 4a-feiras de 0830h às 1100h. Além do atendimento presencial, vocês têm acesso ao sistema Sigaa que disponibiliza canal de contato com o Coordenador para envio de mensagens.",e.jsx("br",{}),e.jsx("br",{}),"***Não haverá atendimento via Chat Teams durante esse período.",e.jsx("br",{}),"*** Att, TA",e.jsx("br",{}),e.jsx("br",{}),"Para visualizar acesse"," ",e.jsx("a",{href:"https://teste.com.br/teste",children:"https://teste.com.br/teste"}),e.jsx("br",{})]}),e.jsx(T1,{children:["TCC","Eng. Software","Eng. Eletrônica","27/07"].map((t,n)=>e.jsx(L,{variant:"solid",bg:i.colors.tertiary[500],alignSelf:"center",size:"sm",textDecoration:"solid .8rem bold",children:e.jsx("p",{id:"post-badge-text",children:t})},n))})]})]})}const P1=s.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function H1({label:t="",inputType:n="text",placeholder:o,accessibilityLabel:r,size:a="md",fontSize:l="0.9rem",...A}){return e.jsxs(R1,{children:[t&&e.jsx(Z1,{fontSize:l,children:t}),e.jsx(M,{type:n,variant:"outline",size:a,placeholder:o,accessibilityLabel:r,autoCompleteType:null,totalLines:5,maxLength:500,...A})]})}const J1=s.div`
  position: relative;
...
`;function Y1(){const t=g();function n(o){o.preventDefault(),t("/login/logon")}return e.jsx(I1,{children:e.jsxs("section",{className:"header-container",children:[e.jsx(K1,{}),e.jsxs("div",{className:"user-container",children:[e.jsx("h3",{className:"user-name",children:"Lucas"}),e.jsx(O1,{onClick:o=>n(o),children:e.jsx($,{size:"2.5rem",color:i.colors.tertiary[300]})})]})]})})}const $1=s.div`
...
`;function S(){return e.jsxs($1,{children:[e.jsx(Y1,{}),e.jsx("div",{className:"content",children:e.jsx(U,{})})]})}const _1=s.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function i3(){const t=g();function n(o){o.preventDefault(),t("/")}return e.jsxs(t3,{children:[e.jsx(v,{}),e.jsxs("div",{className:"buttons-container",children:[e.jsx(f,{accessibilityLabel:"Digite o seu email Institucional",inputType:"text",label:"Email Institucional",placeholder:"Digite o email 240014099@unb.br..."}),e.jsx(f,{accessibilityLabel:"Senha",inputType:"password",label:"Digite a sua senha",placeholder:"Digite a sua senha"}),e.jsx(c,{onPress:o=>n(o),variant:"solid",size:"lg",children:"Entrar"})]})]})}const n3=s.div`
  width: 100%;
  height: 100vh;
  display: flex;
  /* align-items: center; */
...
`,r3="/UnBForumFront/assets/create-account-24b27e13.png";function o3(){return e.jsxs(n3,{children:[e.jsx("img",{className:"create-account-image",src:r3,alt:""}),e.jsx("div",{className:"content",children:e.jsx(U,{})})]})}const s3=s.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
...
`;function k({label:t,placeholder:n,options:o=[]}){return e.jsxs(a3,{children:[e.jsx("label",{className:"create-account-label",children:t}),e.jsx(m,{variant:"outline",height:9,size:"md",placeholder:n,accessibilityLabel:"Selecione a opção",children:o.map(r=>e.jsx(m.Item,{label:r.label,value:r.value},r.label))})]})}function l3(){const t=g();function n(r){r.preventDefault(),t("/login/logon")}function o(r){switch(r.input){case"select":return e.jsx(k,{label:r.label,placeholder:r.placeholder,options:r.options,accessibilityLabel:r.accessibilityLabel},r.label);default:return e.jsx(f,{label:r.label,placeholder:r.placeholder,inputType:r.type,accessibilityLabel:r.accessibilityLabel},r.label)}}return e.jsxs(s3,{children:[e.jsx(v,{}),e.jsxs("div",{className:"inputs-container",children:[m1.map(r=>o(r)),e.jsx(c,{onPress:r=>n(r),variant:"solid",size:"lg",children:"Criar Conta"})]})]})}const A3=s.section`
  width: 80%;
...
`;function d3(){return e.jsxs(A3,{children:[e.jsx("div",{className:"logo-profile-container",children:e.jsx(v,{})}),e.jsxs("section",{className:"inputs-profile-container",children:[e.jsx("h1",{className:"profile-page-title",children:"Perfil de Usuário"}),e.jsx(f,{label:"Nome Completo",placeholder:"Digite seu nome completo...",inputType:"text",accessibilityLabel:"Digite o seu nome completo..."}),e.jsx(f,{label:"Email Institucional",placeholder:"Digite seu nome email...",inputType:"text",accessibilityLabel:"Digite o seu email..."}),e.jsx(k,{label:"Papel na Instituição",placeholder:"Selecione o seu papel na instituição...",options:P,accessibilityLabel:"Selecione o seu papel na instituição..."}),e.jsx(k,{label:"Curso",placeholder:"Selecione seu curso...",options:w,accessibilityLabel:"Selecione seu curso..."}),e.jsx(f,{label:"Senha",placeholder:"Digite sua senha",inputType:"password",accessibilityLabel:"Digite a sua senha..."}),e.jsx(c,{variant:"solid",size:"lg",children:"Editar Perfil"}),e.jsxs("div",{className:"sub-buttons-container",children:[e.jsx(c,{variant:"subtle",size:"md",children:"Sair"}),e.jsx(c,{variant:"subtle",size:"md",children:"Deletar a Conta"})]})]})]})}const c3=s.main`
  width: 70%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`;function u3(){const{id:t}=_();return d.useEffect(()=>window.scrollTo(0,0),[]),e.jsxs(c3,{children:[e.jsx(D,{id:Number(t),isInsideTopic:!0}),e.jsx(C3,{children:Array.from({length:10},(n,o)=>o).map(n=>e.jsx(D,{id:n,isComment:!0},n))})]})}function p3(){return e.jsxs(e1,{children:[e.jsxs(h,{path:"/",element:e.jsx(S,{}),children:[e.jsx(h,{path:"/",element:e.jsx(G1,{})}),e.jsx(h,{path:"/topic/:id",element:e.jsx(u3,{})})]}),e.jsx(h,{path:"/profile",element:e.jsx(S,{}),children:e.jsx(h,{path:"/profile",element:e.jsx(d3,{})})}),e.jsxs(h,{path:"/login",element:e.jsx(o3,{}),children:[e.jsx(h,{path:"/login",element:e.jsx(i3,{})}),e.jsx(h,{path:"/login/logon",element:e.jsx(e3,{})}),e.jsx(h,{path:"/login/create-account",element:e.jsx(l3,{})})]})]})}const h3={white:"#FFF","gray-100":"#E1E1E6","gray-300":"#C4C4CC","gray-400":"#8D8D99","gray-500":"#7C7C8A","gray-600":"#323238","gray-700":"#29292E","gray-800":"#202024","gray-900":"#121214","green-300":"#00B37E","green-500":"#00875F","green-700":"#015F43","red-500":"#AB222E","red-700":"#7A1921","yellow-500":"#FBA94C"},x3=t1`
  * {
    margin: 0;
    padding: 0;
    outline: 0;
...
`;function f3(){const t={get:async()=>{try{return localStorage.getItem("@UnBForum:theme")==="dark"?"dark":"light"}catch(n){return console.log(n),"light"}},set:async n=>{try{localStorage.setItem("@UnBForum:theme",n)}catch(o){console.log(o)}}};return e.jsx(i1,{colorModeManager:t,children:e.jsxs(n1,{theme:h3,children:[e.jsx(r1,{children:e.jsx(p3,{})}),e.jsx(x3,{})]})})}o1.createRoot(document.getElementById("root")).render(e.jsx(s1.StrictMode,{children:e.jsx(f3,{})}));
