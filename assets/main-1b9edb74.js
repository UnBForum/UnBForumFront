import{s as r,t,j as e,I as T,F as L,S as x,P as U,r as u,A as P,a as V,b as j,B as D,c as X,D as E,d as R,e as Z,T as H,f as J,g as W,C as B,h as C,i as y,k as M,l as I,m as G,u as m,n as K,O as k,R as F,o as p,p as O,N as Y,X as $,q as _,v as e1,w as t1}from"./vendor-17bcde33.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function o(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(s){if(s.ep)return;s.ep=!0;const l=o(s);fetch(s.href,l)}})();const i1=r.div`
  width: 100%;
  display: flex;
...
`;function Q(){return e.jsxs(I1,{children:[e.jsx(M1,{}),e.jsx("div",{className:"content",children:e.jsx(k,{})})]})}const G1=r.div`
  max-width: 65%;
  width: 65%;
  display: flex;
  flex-direction: column;
